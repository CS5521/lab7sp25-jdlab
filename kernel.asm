...
8010003a:	c7 44 24 04 30 84 10 	movl   $0x80108430,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 40 c6 10 80 	movl   $0x8010c640,(%esp)
80100049:	e8 3e 4f 00 00       	call   80104f8c <initlock>
...
80100087:	c7 44 24 04 37 84 10 	movl   $0x80108437,0x4(%esp)
8010008e:	80 
8010008f:	89 04 24             	mov    %eax,(%esp)
80100092:	e8 92 4d 00 00       	call   80104e29 <initsleeplock>
...
801000c9:	e8 df 4e 00 00       	call   80104fad <acquire>
...
80100104:	e8 0c 4f 00 00       	call   80105015 <release>
      acquiresleep(&b->lock);
80100109:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010010c:	83 c0 0c             	add    $0xc,%eax
8010010f:	89 04 24             	mov    %eax,(%esp)
80100112:	e8 4c 4d 00 00       	call   80104e63 <acquiresleep>
      return b;
...
8010017d:	e8 93 4e 00 00       	call   80105015 <release>
      acquiresleep(&b->lock);
80100182:	8b 45 f4             	mov    -0xc(%ebp),%eax
80100185:	83 c0 0c             	add    $0xc,%eax
80100188:	89 04 24             	mov    %eax,(%esp)
8010018b:	e8 d3 4c 00 00       	call   80104e63 <acquiresleep>
      return b;
...
801001a7:	c7 04 24 3e 84 10 80 	movl   $0x8010843e,(%esp)
...
801001fb:	e8 00 4d 00 00       	call   80104f00 <holdingsleep>
80100200:	85 c0                	test   %eax,%eax
80100202:	75 0c                	jne    80100210 <bwrite+0x24>
    panic("bwrite");
80100204:	c7 04 24 4f 84 10 80 	movl   $0x8010844f,(%esp)
...
8010023b:	e8 c0 4c 00 00       	call   80104f00 <holdingsleep>
80100240:	85 c0                	test   %eax,%eax
80100242:	75 0c                	jne    80100250 <brelse+0x24>
    panic("brelse");
80100244:	c7 04 24 56 84 10 80 	movl   $0x80108456,(%esp)
...
80100259:	e8 60 4c 00 00       	call   80104ebe <releasesleep>

  acquire(&bcache.lock);
8010025e:	c7 04 24 40 c6 10 80 	movl   $0x8010c640,(%esp)
80100265:	e8 43 4d 00 00       	call   80104fad <acquire>
  b->refcnt--;
...
801002d1:	e8 3f 4d 00 00       	call   80105015 <release>
}
801002d6:	c9                   	leave  
801002d7:	c3                   	ret    
...
801003e3:	e8 c5 4b 00 00       	call   80104fad <acquire>
...
801003ed:	75 0c                	jne    801003fb <cprintf+0x33>
    panic("null fmt");
801003ef:	c7 04 24 5d 84 10 80 	movl   $0x8010845d,(%esp)
...
801004d6:	75 09                	jne    801004e1 <cprintf+0x119>
        s = "(null)";
801004d8:	c7 45 ec 66 84 10 80 	movl   $0x80108466,-0x14(%ebp)
      for(; *s; s++)
...
8010055b:	e8 b5 4a 00 00       	call   80105015 <release>
}
80100560:	c9                   	leave  
80100561:	c3                   	ret    
...
80100580:	c7 04 24 6d 84 10 80 	movl   $0x8010846d,(%esp)
...
80100592:	e8 31 fe ff ff       	call   801003c8 <cprintf>
  cprintf("\n");
80100597:	c7 04 24 81 84 10 80 	movl   $0x80108481,(%esp)
...
801005b0:	e8 ab 4a 00 00       	call   80105060 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005c9:	c7 04 24 83 84 10 80 	movl   $0x80108483,(%esp)
...
801006ba:	c7 04 24 87 84 10 80 	movl   $0x80108487,(%esp)
...
801006ee:	e8 fb 4b 00 00       	call   801052ee <memmove>
    pos -= 80;
...
8010071d:	e8 fd 4a 00 00       	call   8010521f <memset>
  }
...
801007fd:	e8 ab 47 00 00       	call   80104fad <acquire>
  while((c = getc()) >= 0){
...
80100959:	e8 b7 46 00 00       	call   80105015 <release>
  if(doprocdump) {
...
80100989:	e8 1f 46 00 00       	call   80104fad <acquire>
  while(n > 0){
...
801009a8:	e8 68 46 00 00       	call   80105015 <release>
        ilock(ip);
...
80100a4d:	e8 c3 45 00 00       	call   80105015 <release>
  ilock(ip);
...
80100a81:	e8 27 45 00 00       	call   80104fad <acquire>
  for(i = 0; i < n; i++)
...
80100abb:	e8 55 45 00 00       	call   80105015 <release>
  ilock(ip);
...
80100ad6:	c7 44 24 04 9a 84 10 	movl   $0x8010849a,0x4(%esp)
80100add:	80 
80100ade:	c7 04 24 a0 b5 10 80 	movl   $0x8010b5a0,(%esp)
80100ae5:	e8 a2 44 00 00       	call   80104f8c <initlock>
...
80100b48:	e8 be 29 00 00       	call   8010350b <end_op>
    cprintf("exec: fail\n");
80100b4d:	c7 04 24 a2 84 10 80 	movl   $0x801084a2,(%esp)
...
80100bb1:	e9 85 03 00 00       	jmp    80100f3b <exec+0x41d>
  ...
  if((pgdir = setupkvm()) == 0)
80100bb6:	e8 c0 6f 00 00       	call   80107b7b <setupkvm>
...
80100c74:	e8 d8 72 00 00       	call   80107f51 <allocuvm>
...
80100cc6:	e8 a3 71 00 00       	call   80107e6e <loaduvm>
...
80100d34:	e8 18 72 00 00       	call   80107f51 <allocuvm>
...
80100d59:	e8 66 74 00 00       	call   801081c4 <clearpteu>
  sp = sz;
...
80100d8f:	e8 f5 46 00 00       	call   80105489 <strlen>
...
80100db8:	e8 cc 46 00 00       	call   80105489 <strlen>
...
80100de8:	e8 9a 75 00 00       	call   80108387 <copyout>
...
80100e8f:	e8 f3 74 00 00       	call   80108387 <copyout>
...
80100ee4:	e8 56 45 00 00       	call   8010543f <safestrcpy>
...
80100f24:	e8 2c 6d 00 00       	call   80107c55 <switchuvm>
  freevm(oldpgdir);
80100f29:	8b 45 cc             	mov    -0x34(%ebp),%eax
80100f2c:	89 04 24             	mov    %eax,(%esp)
80100f2f:	e8 f9 71 00 00       	call   8010812d <freevm>
  return 0;
...
80100f47:	e8 e1 71 00 00       	call   8010812d <freevm>
  if(ip){
...
80100f6f:	c7 44 24 04 ae 84 10 	movl   $0x801084ae,0x4(%esp)
80100f76:	80 
80100f77:	c7 04 24 40 10 11 80 	movl   $0x80111040,(%esp)
80100f7e:	e8 09 40 00 00       	call   80104f8c <initlock>
}
80100f83:	c9                   	leave  
80100f84:	c3                   	ret    
...
80100f92:	e8 16 40 00 00       	call   80104fad <acquire>
...
80100fbb:	e8 55 40 00 00       	call   80105015 <release>
      return f;
...
80100fd9:	e8 37 40 00 00       	call   80105015 <release>
  return 0;
...
80100ff2:	e8 b6 3f 00 00       	call   80104fad <acquire>
  if(f->ref < 1)
...
80100fff:	7f 0c                	jg     8010100d <filedup+0x28>
    panic("filedup");
80101001:	c7 04 24 b5 84 10 80 	movl   $0x801084b5,(%esp)
...
80101023:	e8 ed 3f 00 00       	call   80105015 <release>
  return f;
...
8010103a:	e8 6e 3f 00 00       	call   80104fad <acquire>
  if(f->ref < 1)
...
80101047:	7f 0c                	jg     80101055 <fileclose+0x28>
    panic("fileclose");
80101049:	c7 04 24 bd 84 10 80 	movl   $0x801084bd,(%esp)
...
80101075:	e8 9b 3f 00 00       	call   80105015 <release>
...
801010bf:	e8 51 3f 00 00       	call   80105015 <release>
...
801011fe:	eb 0c                	jmp    8010120c <fileread+0xba>
  ...
  panic("fileread");
80101200:	c7 04 24 c7 84 10 80 	movl   $0x801084c7,(%esp)
...
8010130c:	c7 04 24 d0 84 10 80 	movl   $0x801084d0,(%esp)
...
8010133c:	eb 0c                	jmp    8010134a <filewrite+0x13c>
  ...
  panic("filewrite");
8010133e:	c7 04 24 e0 84 10 80 	movl   $0x801084e0,(%esp)
...
80101384:	e8 65 3f 00 00       	call   801052ee <memmove>
  brelse(bp);
...
801013ca:	e8 50 3e 00 00       	call   8010521f <memset>
  log_write(bp);
...
80101517:	c7 04 24 ec 84 10 80 	movl   $0x801084ec,(%esp)
...
801015a6:	c7 04 24 02 85 10 80 	movl   $0x80108502,(%esp)
...
80101600:	c7 44 24 04 15 85 10 	movl   $0x80108515,0x4(%esp)
80101607:	80 
80101608:	c7 04 24 60 1a 11 80 	movl   $0x80111a60,(%esp)
8010160f:	e8 78 39 00 00       	call   80104f8c <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101635:	c7 44 24 04 1c 85 10 	movl   $0x8010851c,0x4(%esp)
8010163c:	80 
8010163d:	89 04 24             	mov    %eax,(%esp)
80101640:	e8 e4 37 00 00       	call   80104e29 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801016af:	c7 04 24 24 85 10 80 	movl   $0x80108524,(%esp)
...
80101732:	e8 e8 3a 00 00       	call   8010521f <memset>
      dip->type = type;
...
8010178a:	c7 04 24 77 85 10 80 	movl   $0x80108577,(%esp)
...
80101839:	e8 b0 3a 00 00       	call   801052ee <memmove>
  log_write(bp);
...
80101863:	e8 45 37 00 00       	call   80104fad <acquire>
...
801018ad:	e8 63 37 00 00       	call   80105015 <release>
      return ip;
...
801018e3:	c7 04 24 89 85 10 80 	movl   $0x80108589,(%esp)
...
80101921:	e8 ef 36 00 00       	call   80105015 <release>
...
80101938:	e8 70 36 00 00       	call   80104fad <acquire>
  ip->ref++;
...
80101953:	e8 bd 36 00 00       	call   80105015 <release>
  return ip;
...
80101971:	7f 0c                	jg     8010197f <ilock+0x22>
    panic("ilock");
80101973:	c7 04 24 99 85 10 80 	movl   $0x80108599,(%esp)
...
80101988:	e8 d6 34 00 00       	call   80104e63 <acquiresleep>
...
80101a36:	e8 b3 38 00 00       	call   801052ee <memmove>
    brelse(bp);
...
80101a5a:	75 0c                	jne    80101a68 <ilock+0x10b>
      panic("ilock: no type");
80101a5c:	c7 04 24 9f 85 10 80 	movl   $0x8010859f,(%esp)
...
80101a7f:	e8 7c 34 00 00       	call   80104f00 <holdingsleep>
...
80101a90:	7f 0c                	jg     80101a9e <iunlock+0x34>
    panic("iunlock");
80101a92:	c7 04 24 ae 85 10 80 	movl   $0x801085ae,(%esp)
...
80101aa7:	e8 12 34 00 00       	call   80104ebe <releasesleep>
}
80101aac:	c9                   	leave  
80101aad:	c3                   	ret    
...
80101abd:	e8 a1 33 00 00       	call   80104e63 <acquiresleep>
...
80101adf:	e8 c9 34 00 00       	call   80104fad <acquire>
    int r = ip->ref;
...
80101af4:	e8 1c 35 00 00       	call   80105015 <release>
    if(r == 1){
...
80101b31:	e8 88 33 00 00       	call   80104ebe <releasesleep>

  acquire(&icache.lock);
80101b36:	c7 04 24 60 1a 11 80 	movl   $0x80111a60,(%esp)
80101b3d:	e8 6b 34 00 00       	call   80104fad <acquire>
  ip->ref--;
...
80101b58:	e8 b8 34 00 00       	call   80105015 <release>
}
80101b5d:	c9                   	leave  
80101b5e:	c3                   	ret    
...
80101c7e:	c7 04 24 b6 85 10 80 	movl   $0x801085b6,(%esp)
...
80101f2b:	e8 be 33 00 00       	call   801052ee <memmove>
    brelse(bp);
...
8010208a:	e8 5f 32 00 00       	call   801052ee <memmove>
    log_write(bp);
...
80102108:	e8 84 32 00 00       	call   80105391 <strncmp>
}
8010210d:	c9                   	leave  
8010210e:	c3                   	ret    
...
80102122:	c7 04 24 c9 85 10 80 	movl   $0x801085c9,(%esp)
...
80102160:	c7 04 24 db 85 10 80 	movl   $0x801085db,(%esp)
...
80102243:	74 0c                	je     80102251 <dirlink+0x79>
      panic("dirlink read");
80102245:	c7 04 24 ea 85 10 80 	movl   $0x801085ea,(%esp)
...
8010228a:	e8 58 31 00 00       	call   801053e7 <strncpy>
  de.inum = inum;
...
801022ba:	74 0c                	je     801022c8 <dirlink+0xf0>
    panic("dirlink");
801022bc:	c7 04 24 f7 85 10 80 	movl   $0x801085f7,(%esp)
...
80102341:	e8 a8 2f 00 00       	call   801052ee <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
8010235c:	e8 8d 2f 00 00       	call   801052ee <memmove>
    name[len] = 0;
...
801025aa:	c7 44 24 04 ff 85 10 	movl   $0x801085ff,0x4(%esp)
801025b1:	80 
801025b2:	c7 04 24 e0 b5 10 80 	movl   $0x8010b5e0,(%esp)
801025b9:	e8 ce 29 00 00       	call   80104f8c <initlock>
...
80102648:	75 0c                	jne    80102656 <idestart+0x18>
    panic("idestart");
8010264a:	c7 04 24 03 86 10 80 	movl   $0x80108603,(%esp)
...
80102663:	c7 04 24 0c 86 10 80 	movl   $0x8010860c,(%esp)
...
801026b5:	c7 04 24 03 86 10 80 	movl   $0x80108603,(%esp)
...
801027d5:	e8 d3 27 00 00       	call   80104fad <acquire>
...
801027ef:	e8 21 28 00 00       	call   80105015 <release>
    return;
...
80102884:	e8 8c 27 00 00       	call   80105015 <release>
}
80102889:	c9                   	leave  
8010288a:	c3                   	ret    
...
8010289a:	e8 61 26 00 00       	call   80104f00 <holdingsleep>
8010289f:	85 c0                	test   %eax,%eax
801028a1:	75 0c                	jne    801028af <iderw+0x24>
    panic("iderw: buf not locked");
801028a3:	c7 04 24 1e 86 10 80 	movl   $0x8010861e,(%esp)
...
801028bc:	c7 04 24 34 86 10 80 	movl   $0x80108634,(%esp)
...
80102962:	e8 ae 26 00 00       	call   80105015 <release>
}
80102967:	c9                   	leave  
80102968:	c3                   	ret    
...
801029e2:	c7 04 24 68 86 10 80 	movl   $0x80108668,(%esp)
...
80102a84:	c7 44 24 04 9a 86 10 	movl   $0x8010869a,0x4(%esp)
80102a8b:	80 
80102a8c:	c7 04 24 c0 36 11 80 	movl   $0x801136c0,(%esp)
80102a93:	e8 f4 24 00 00       	call   80104f8c <initlock>
  kmem.use_lock = 0;
...
80102b3b:	76 0c                	jbe    80102b49 <kfree+0x36>
    panic("kfree");
80102b3d:	c7 04 24 9f 86 10 80 	movl   $0x8010869f,(%esp)
...
80102b5f:	e8 bb 26 00 00       	call   8010521f <memset>
...
80102b74:	e8 34 24 00 00       	call   80104fad <acquire>
  r = (struct run*)v;
...
80102ba2:	e8 6e 24 00 00       	call   80105015 <release>
}
80102ba7:	c9                   	leave  
80102ba8:	c3                   	ret    
...
80102bbf:	e8 e9 23 00 00       	call   80104fad <acquire>
  r = kmem.freelist;
...
80102bec:	e8 24 24 00 00       	call   80105015 <release>
  return (char*)r;
...
80103189:	e8 08 21 00 00       	call   80105296 <memcmp>
...
80103289:	c7 44 24 04 a5 86 10 	movl   $0x801086a5,0x4(%esp)
80103290:	80 
80103291:	c7 04 24 00 37 11 80 	movl   $0x80113700,(%esp)
80103298:	e8 ef 1c 00 00       	call   80104f8c <initlock>
  readsb(dev, &sb);
...
80103342:	e8 a7 1f 00 00       	call   801052ee <memmove>
...
80103494:	e8 14 1b 00 00       	call   80104fad <acquire>
  while(1){
    if(log.committing){
...
80103500:	e8 10 1b 00 00       	call   80105015 <release>
      break;
...
8010351f:	e8 89 1a 00 00       	call   80104fad <acquire>
  log.outstanding -= 1;
...
8010353a:	c7 04 24 a9 86 10 80 	movl   $0x801086a9,(%esp)
...
80103575:	e8 9b 1a 00 00       	call   80105015 <release>
...
8010358c:	e8 1c 1a 00 00       	call   80104fad <acquire>
    log.committing = 0;
...
801035ae:	e8 62 1a 00 00       	call   80105015 <release>
  }
}
801035b3:	c9                   	leave  
801035b4:	c3                   	ret    
...
80103629:	e8 c0 1c 00 00       	call   801052ee <memmove>
...
801036b4:	c7 04 24 b8 86 10 80 	movl   $0x801086b8,(%esp)
...
801036c9:	c7 04 24 ce 86 10 80 	movl   $0x801086ce,(%esp)
801036d0:	e8 8d ce ff ff       	call   80100562 <panic>

  acquire(&log.lock);
801036d5:	c7 04 24 00 37 11 80 	movl   $0x80113700,(%esp)
801036dc:	e8 cc 18 00 00       	call   80104fad <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80103753:	e8 bd 18 00 00       	call   80105015 <release>
}
80103758:	c9                   	leave  
80103759:	c3                   	ret    
...
801037b4:	e8 c1 32 00 00       	call   80106a7a <uartinit>
  pinit();         // process table
801037b9:	e8 f0 08 00 00       	call   801040ae <pinit>
  tvinit();        // trap vectors
801037be:	e8 80 2e 00 00       	call   80106643 <tvinit>
  binit();         // buffer cache
...
801037f8:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
801037fb:	e8 3b 44 00 00       	call   80107c3b <switchkvm>
  seginit();
80103800:	e8 eb 3e 00 00       	call   801076f0 <seginit>
  lapicinit();
...
8010382a:	c7 04 24 e9 86 10 80 	movl   $0x801086e9,(%esp)
80103831:	e8 92 cb ff ff       	call   801003c8 <cprintf>
  idtinit();       // load idt register
80103836:	e8 7c 2f 00 00       	call   801067b7 <idtinit>
...
8010387e:	e8 6b 1a 00 00       	call   801052ee <memmove>
...
801039bb:	00 
801039bc:	c7 44 24 04 00 87 10 	movl   $0x80108700,0x4(%esp)
801039c3:	80 
801039c4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801039c7:	89 04 24             	mov    %eax,(%esp)
801039ca:	e8 c7 18 00 00       	call   80105296 <memcmp>
...
80103af9:	00 
80103afa:	c7 44 24 04 05 87 10 	movl   $0x80108705,0x4(%esp)
80103b01:	80 
80103b02:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103b05:	89 04 24             	mov    %eax,(%esp)
80103b08:	e8 89 17 00 00       	call   80105296 <memcmp>
...
80103b80:	c7 04 24 0a 87 10 80 	movl   $0x8010870a,(%esp)
...
80103bc9:	8b 04 85 44 87 10 80 	mov    -0x7fef78bc(,%eax,4),%eax
...
80103c48:	c7 04 24 24 87 10 80 	movl   $0x80108724,(%esp)
...
80103d7d:	c7 44 24 04 58 87 10 	movl   $0x80108758,0x4(%esp)
80103d84:	80 
80103d85:	89 04 24             	mov    %eax,(%esp)
80103d88:	e8 ff 11 00 00       	call   80104f8c <initlock>
  (*f0)->type = FD_PIPE;
...
80103e34:	e8 74 11 00 00       	call   80104fad <acquire>
  if(writable){
...
80103e9b:	e8 75 11 00 00       	call   80105015 <release>
    kfree((char*)p);
...
80103eb3:	e8 5d 11 00 00       	call   80105015 <release>
}
80103eb8:	c9                   	leave  
80103eb9:	c3                   	ret    
...
80103ec6:	e8 e2 10 00 00       	call   80104fad <acquire>
  for(i = 0; i < n; i++){
...
80103ef8:	e8 18 11 00 00       	call   80105015 <release>
        return -1;
...
80103f9e:	e8 72 10 00 00       	call   80105015 <release>
  return n;
...
80103fb5:	e8 f3 0f 00 00       	call   80104fad <acquire>
...
80103fce:	e8 42 10 00 00       	call   80105015 <release>
      return -1;
...
8010408a:	e8 86 0f 00 00       	call   80105015 <release>
  return i;
...
801040b4:	c7 44 24 04 60 87 10 	movl   $0x80108760,0x4(%esp)
801040bb:	80 
801040bc:	c7 04 24 a0 3d 11 80 	movl   $0x80113da0,(%esp)
801040c3:	e8 c4 0e 00 00       	call   80104f8c <initlock>
}
801040c8:	c9                   	leave  
801040c9:	c3                   	ret    
...
801040ff:	c7 04 24 68 87 10 80 	movl   $0x80108768,(%esp)
...
80104153:	c7 04 24 8e 87 10 80 	movl   $0x8010878e,(%esp)
...
80104164:	83 ec 18             	sub    $0x18,%esp
  ...
  struct proc *p;
  pushcli();
80104167:	e8 ae 0f 00 00       	call   8010511a <pushcli>
  c = mycpu();
...
8010417d:	89 45 f0             	mov    %eax,-0x10(%ebp)
  popcli();
80104180:	e8 e1 0f 00 00       	call   80105166 <popcli>
  return p;
...
80104197:	e8 11 0e 00 00       	call   80104fad <acquire>
...
801041d5:	e8 3b 0e 00 00       	call   80105015 <release>
...
80104208:	e8 08 0e 00 00       	call   80105015 <release>
  return 0;
...
80104244:	ba fe 65 10 80       	mov    $0x801065fe,%edx
...
80104274:	e8 a6 0f 00 00       	call   8010521f <memset>
...
801042b9:	e8 bd 38 00 00       	call   80107b7b <setupkvm>
...
801042ce:	c7 04 24 9e 87 10 80 	movl   $0x8010879e,(%esp)
...
801042f4:	e8 ed 3a 00 00       	call   80107de6 <inituvm>
  p->sz = PGSIZE;
...
8010431b:	e8 ff 0e 00 00       	call   8010521f <memset>
...
80104394:	00 
80104395:	c7 44 24 04 b7 87 10 	movl   $0x801087b7,0x4(%esp)
8010439c:	80 
8010439d:	89 04 24             	mov    %eax,(%esp)
801043a0:	e8 9a 10 00 00       	call   8010543f <safestrcpy>
  p->cwd = namei("/");
801043a5:	c7 04 24 c0 87 10 80 	movl   $0x801087c0,(%esp)
...
801043be:	e8 ea 0b 00 00       	call   80104fad <acquire>
...
801043d4:	e8 3c 0c 00 00       	call   80105015 <release>
}
801043d9:	c9                   	leave  
801043da:	c3                   	ret    
...
80104413:	e8 39 3b 00 00       	call   80107f51 <allocuvm>
...
8010444a:	e8 18 3c 00 00       	call   80108067 <deallocuvm>
...
8010446d:	e8 e3 37 00 00       	call   80107c55 <switchuvm>
  return 0;
...
801044b4:	e8 51 3d 00 00       	call   8010820a <copyuvm>
...
801045de:	e8 5c 0e 00 00       	call   8010543f <safestrcpy>
...
801045f3:	e8 b5 09 00 00       	call   80104fad <acquire>
...
80104609:	e8 07 0a 00 00       	call   80105015 <release>
...
8010462f:	75 0c                	jne    8010463d <exit+0x24>
    panic("init exiting");
80104631:	c7 04 24 c2 87 10 80 	movl   $0x801087c2,(%esp)
...
801046b0:	e8 f8 08 00 00       	call   80104fad <acquire>
...
80104715:	e8 c9 01 00 00       	call   801048e3 <sched>
  panic("zombie exit");
8010471a:	c7 04 24 cf 87 10 80 	movl   $0x801087cf,(%esp)
...
8010473b:	e8 6d 08 00 00       	call   80104fad <acquire>
  for(;;){
...
8010479f:	e8 89 39 00 00       	call   8010812d <freevm>
        p->pid = 0;
...
801047da:	e8 36 08 00 00       	call   80105015 <release>
        return pid;
...
8010480f:	e8 01 08 00 00       	call   80105015 <release>
      return -1;
...
8010485c:	e8 4c 07 00 00       	call   80104fad <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104889:	e8 c7 33 00 00       	call   80107c55 <switchuvm>
      p->state = RUNNING;
...
801048ab:	e8 00 0c 00 00       	call   801054b0 <swtch>
      switchkvm();
801048b0:	e8 86 33 00 00       	call   80107c3b <switchkvm>
...
801048d9:	e8 37 07 00 00       	call   80105015 <release>
...
801048f8:	e8 dc 07 00 00       	call   801050d9 <holding>
801048fd:	85 c0                	test   %eax,%eax
801048ff:	75 0c                	jne    8010490d <sched+0x2a>
    panic("sched ptable.lock");
80104901:	c7 04 24 db 87 10 80 	movl   $0x801087db,(%esp)
...
8010491b:	74 0c                	je     80104929 <sched+0x46>
    panic("sched locks");
8010491d:	c7 04 24 ed 87 10 80 	movl   $0x801087ed,(%esp)
...
80104932:	75 0c                	jne    80104940 <sched+0x5d>
    panic("sched running");
80104934:	c7 04 24 f9 87 10 80 	movl   $0x801087f9,(%esp)
...
8010494e:	c7 04 24 07 88 10 80 	movl   $0x80108807,(%esp)
...
8010497d:	e8 2e 0b 00 00       	call   801054b0 <swtch>
  mycpu()->intena = intena;
...
8010499f:	e8 09 06 00 00       	call   80104fad <acquire>
...
801049bc:	e8 54 06 00 00       	call   80105015 <release>
}
801049c1:	c9                   	leave  
801049c2:	c3                   	ret    
...
801049d0:	e8 40 06 00 00       	call   80105015 <release>
...
80104a14:	75 0c                	jne    80104a22 <sleep+0x20>
    panic("sleep");
80104a16:	c7 04 24 1b 88 10 80 	movl   $0x8010881b,(%esp)
...
80104a28:	c7 04 24 21 88 10 80 	movl   $0x80108821,(%esp)
...
80104a44:	e8 64 05 00 00       	call   80104fad <acquire>
    release(lk);
80104a49:	8b 45 0c             	mov    0xc(%ebp),%eax
80104a4c:	89 04 24             	mov    %eax,(%esp)
80104a4f:	e8 c1 05 00 00       	call   80105015 <release>
  }
  // Go to sleep.
  p->chan = chan;
...
80104a86:	e8 8a 05 00 00       	call   80105015 <release>
    acquire(lk);
80104a8b:	8b 45 0c             	mov    0xc(%ebp),%eax
80104a8e:	89 04 24             	mov    %eax,(%esp)
80104a91:	e8 17 05 00 00       	call   80104fad <acquire>
  }
}
80104a96:	c9                   	leave  
80104a97:	c3                   	ret    
...
80104ae6:	e8 c2 04 00 00       	call   80104fad <acquire>
  wakeup1(chan);
...
80104afd:	e8 13 05 00 00       	call   80105015 <release>
}
80104b02:	c9                   	leave  
80104b03:	c3                   	ret    
...
80104b11:	e8 97 04 00 00       	call   80104fad <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104b50:	e8 c0 04 00 00       	call   80105015 <release>
      return 0;
...
80104b73:	e8 9d 04 00 00       	call   80105015 <release>
  return -1;
...
80104bcc:	eb 07                	jmp    80104bd5 <procdump+0x56>
      ...
      state = "???";
80104bce:	c7 45 ec 32 88 10 80 	movl   $0x80108832,-0x14(%ebp)
...
80104bf0:	c7 04 24 36 88 10 80 	movl   $0x80108836,(%esp)
...
80104c1d:	e8 3e 04 00 00       	call   80105060 <getcallerpcs>
...
80104c36:	c7 04 24 3f 88 10 80 	movl   $0x8010883f,(%esp)
...
80104c55:	75 d4                	jne    80104c2b <procdump+0xac>
    ...
    cprintf("\n");
80104c57:	c7 04 24 43 88 10 80 	movl   $0x80108843,(%esp)
...
80104c8e:	e8 1a 03 00 00       	call   80104fad <acquire>
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104d45:	e8 f5 06 00 00       	call   8010543f <safestrcpy>
...
80104d59:	8b 04 85 48 88 10 80 	mov    -0x7fef77b8(,%eax,4),%eax
...
80104e1e:	e8 f2 01 00 00       	call   80105015 <release>
}
...
80104e32:	83 c0 04             	add    $0x4,%eax
80104e35:	c7 44 24 04 8a 88 10 	movl   $0x8010888a,0x4(%esp)
80104e3c:	80 
80104e3d:	89 04 24             	mov    %eax,(%esp)
80104e40:	e8 47 01 00 00       	call   80104f8c <initlock>
  lk->name = name;
80104e45:	8b 45 08             	mov    0x8(%ebp),%eax
80104e48:	8b 55 0c             	mov    0xc(%ebp),%edx
80104e4b:	89 50 38             	mov    %edx,0x38(%eax)
  lk->locked = 0;
80104e4e:	8b 45 08             	mov    0x8(%ebp),%eax
80104e51:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->pid = 0;
80104e57:	8b 45 08             	mov    0x8(%ebp),%eax
80104e5a:	c7 40 3c 00 00 00 00 	movl   $0x0,0x3c(%eax)
}
80104e61:	c9                   	leave  
80104e62:	c3                   	ret    

80104e63 <acquiresleep>:
...
80104e66:	83 ec 18             	sub    $0x18,%esp
  acquire(&lk->lk);
80104e69:	8b 45 08             	mov    0x8(%ebp),%eax
80104e6c:	83 c0 04             	add    $0x4,%eax
80104e6f:	89 04 24             	mov    %eax,(%esp)
80104e72:	e8 36 01 00 00       	call   80104fad <acquire>
  while (lk->locked) {
80104e77:	eb 15                	jmp    80104e8e <acquiresleep+0x2b>
    sleep(lk, &lk->lk);
...
80104e89:	e8 74 fb ff ff       	call   80104a02 <sleep>
  while (lk->locked) {
80104e8e:	8b 45 08             	mov    0x8(%ebp),%eax
80104e91:	8b 00                	mov    (%eax),%eax
80104e93:	85 c0                	test   %eax,%eax
80104e95:	75 e2                	jne    80104e79 <acquiresleep+0x16>
  }
  lk->locked = 1;
80104e97:	8b 45 08             	mov    0x8(%ebp),%eax
80104e9a:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
  lk->pid = myproc()->pid;
80104ea0:	e8 bc f2 ff ff       	call   80104161 <myproc>
80104ea5:	8b 50 10             	mov    0x10(%eax),%edx
80104ea8:	8b 45 08             	mov    0x8(%ebp),%eax
80104eab:	89 50 3c             	mov    %edx,0x3c(%eax)
  release(&lk->lk);
80104eae:	8b 45 08             	mov    0x8(%ebp),%eax
80104eb1:	83 c0 04             	add    $0x4,%eax
80104eb4:	89 04 24             	mov    %eax,(%esp)
80104eb7:	e8 59 01 00 00       	call   80105015 <release>
}
80104ebc:	c9                   	leave  
80104ebd:	c3                   	ret    

80104ebe <releasesleep>:
...
80104f04:	83 ec 24             	sub    $0x24,%esp
  int r;
...
80104f10:	e8 98 00 00 00       	call   80104fad <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80104f15:	8b 45 08             	mov    0x8(%ebp),%eax
80104f18:	8b 00                	mov    (%eax),%eax
80104f1a:	85 c0                	test   %eax,%eax
80104f1c:	74 19                	je     80104f37 <holdingsleep+0x37>
80104f1e:	8b 45 08             	mov    0x8(%ebp),%eax
80104f21:	8b 58 3c             	mov    0x3c(%eax),%ebx
80104f24:	e8 38 f2 ff ff       	call   80104161 <myproc>
80104f29:	8b 40 10             	mov    0x10(%eax),%eax
80104f2c:	39 c3                	cmp    %eax,%ebx
80104f2e:	75 07                	jne    80104f37 <holdingsleep+0x37>
80104f30:	b8 01 00 00 00       	mov    $0x1,%eax
80104f35:	eb 05                	jmp    80104f3c <holdingsleep+0x3c>
80104f37:	b8 00 00 00 00       	mov    $0x0,%eax
80104f3c:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&lk->lk);
80104f3f:	8b 45 08             	mov    0x8(%ebp),%eax
80104f42:	83 c0 04             	add    $0x4,%eax
80104f45:	89 04 24             	mov    %eax,(%esp)
80104f48:	e8 c8 00 00 00       	call   80105015 <release>
  return r;
80104f4d:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
80104f50:	83 c4 24             	add    $0x24,%esp
80104f53:	5b                   	pop    %ebx
80104f54:	5d                   	pop    %ebp
80104f55:	c3                   	ret    
...
80104f7e:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104f81:	f0 87 02             	lock xchg %eax,(%edx)
...
80104f95:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
80104f98:	8b 45 08             	mov    0x8(%ebp),%eax
80104f9b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
80104fa1:	8b 45 08             	mov    0x8(%ebp),%eax
80104fa4:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
80104fab:	5d                   	pop    %ebp
80104fac:	c3                   	ret    
...
80104fb1:	83 ec 14             	sub    $0x14,%esp
  pushcli(); // disable interrupts to avoid deadlock.
80104fb4:	e8 61 01 00 00       	call   8010511a <pushcli>
  if(holding(lk))
80104fb9:	8b 45 08             	mov    0x8(%ebp),%eax
80104fbc:	89 04 24             	mov    %eax,(%esp)
80104fbf:	e8 15 01 00 00       	call   801050d9 <holding>
80104fc4:	85 c0                	test   %eax,%eax
80104fc6:	74 0c                	je     80104fd4 <acquire+0x27>
    panic("acquire");
80104fc8:	c7 04 24 95 88 10 80 	movl   $0x80108895,(%esp)
80104fcf:	e8 8e b5 ff ff       	call   80100562 <panic>

  // The xchg is atomic.
  while(xchg(&lk->locked, 1) != 0)
80104fd4:	90                   	nop
80104fd5:	8b 45 08             	mov    0x8(%ebp),%eax
80104fd8:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80104fdf:	00 
80104fe0:	89 04 24             	mov    %eax,(%esp)
80104fe3:	e8 8a ff ff ff       	call   80104f72 <xchg>
80104fe8:	85 c0                	test   %eax,%eax
80104fea:	75 e9                	jne    80104fd5 <acquire+0x28>
    ;
  ...
  __sync_synchronize();
80104fec:	0f ae f0             	mfence 

  // Record info about lock acquisition for debugging.
  lk->cpu = mycpu();
80104fef:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104ff2:	e8 f4 f0 ff ff       	call   801040eb <mycpu>
80104ff7:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
80104ffa:	8b 45 08             	mov    0x8(%ebp),%eax
80104ffd:	83 c0 0c             	add    $0xc,%eax
80105000:	89 44 24 04          	mov    %eax,0x4(%esp)
80105004:	8d 45 08             	lea    0x8(%ebp),%eax
80105007:	89 04 24             	mov    %eax,(%esp)
8010500a:	e8 51 00 00 00       	call   80105060 <getcallerpcs>
}
8010500f:	83 c4 14             	add    $0x14,%esp
80105012:	5b                   	pop    %ebx
80105013:	5d                   	pop    %ebp
80105014:	c3                   	ret    
...
80105021:	e8 b3 00 00 00       	call   801050d9 <holding>
80105026:	85 c0                	test   %eax,%eax
80105028:	75 0c                	jne    80105036 <release+0x21>
    panic("release");
8010502a:	c7 04 24 9d 88 10 80 	movl   $0x8010889d,(%esp)
80105031:	e8 2c b5 ff ff       	call   80100562 <panic>
...
80105043:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
  // Tell the C compiler and the processor to not move loads or stores
...
80105053:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  popcli();
80105059:	e8 08 01 00 00       	call   80105166 <popcli>
}
8010505e:	c9                   	leave  
8010505f:	c3                   	ret    
...
80105069:	83 e8 08             	sub    $0x8,%eax
8010506c:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
8010506f:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80105076:	eb 38                	jmp    801050b0 <getcallerpcs+0x50>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80105078:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
8010507c:	74 38                	je     801050b6 <getcallerpcs+0x56>
8010507e:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80105085:	76 2f                	jbe    801050b6 <getcallerpcs+0x56>
80105087:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
8010508b:	74 29                	je     801050b6 <getcallerpcs+0x56>
      break;
    pcs[i] = ebp[1];     // saved %eip
8010508d:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105090:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80105097:	8b 45 0c             	mov    0xc(%ebp),%eax
8010509a:	01 c2                	add    %eax,%edx
...
801050a9:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
801050ac:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
801050b0:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
801050b4:	7e c2                	jle    80105078 <getcallerpcs+0x18>
  }
  for(; i < 10; i++)
801050b6:	eb 19                	jmp    801050d1 <getcallerpcs+0x71>
    pcs[i] = 0;
801050b8:	8b 45 f8             	mov    -0x8(%ebp),%eax
801050bb:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
801050c2:	8b 45 0c             	mov    0xc(%ebp),%eax
801050c5:	01 d0                	add    %edx,%eax
801050c7:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
801050cd:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
801050d1:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
801050d5:	7e e1                	jle    801050b8 <getcallerpcs+0x58>
}
801050d7:	c9                   	leave  
801050d8:	c3                   	ret    
...
801050dd:	83 ec 14             	sub    $0x14,%esp
  int r;
  pushcli();
801050e0:	e8 35 00 00 00       	call   8010511a <pushcli>
  r = lock->locked && lock->cpu == mycpu();
801050e5:	8b 45 08             	mov    0x8(%ebp),%eax
801050e8:	8b 00                	mov    (%eax),%eax
801050ea:	85 c0                	test   %eax,%eax
801050ec:	74 16                	je     80105104 <holding+0x2b>
801050ee:	8b 45 08             	mov    0x8(%ebp),%eax
801050f1:	8b 58 08             	mov    0x8(%eax),%ebx
801050f4:	e8 f2 ef ff ff       	call   801040eb <mycpu>
801050f9:	39 c3                	cmp    %eax,%ebx
801050fb:	75 07                	jne    80105104 <holding+0x2b>
801050fd:	b8 01 00 00 00       	mov    $0x1,%eax
80105102:	eb 05                	jmp    80105109 <holding+0x30>
80105104:	b8 00 00 00 00       	mov    $0x0,%eax
80105109:	89 45 f4             	mov    %eax,-0xc(%ebp)
  popcli();
8010510c:	e8 55 00 00 00       	call   80105166 <popcli>
  return r;
80105111:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
80105114:	83 c4 14             	add    $0x14,%esp
80105117:	5b                   	pop    %ebx
80105118:	5d                   	pop    %ebp
80105119:	c3                   	ret    
...
8010511d:	83 ec 18             	sub    $0x18,%esp
  ...
  eflags = readeflags();
80105120:	e8 31 fe ff ff       	call   80104f56 <readeflags>
80105125:	89 45 f4             	mov    %eax,-0xc(%ebp)
  cli();
80105128:	e8 39 fe ff ff       	call   80104f66 <cli>
  if(mycpu()->ncli == 0)
8010512d:	e8 b9 ef ff ff       	call   801040eb <mycpu>
80105132:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
80105138:	85 c0                	test   %eax,%eax
8010513a:	75 14                	jne    80105150 <pushcli+0x36>
    mycpu()->intena = eflags & FL_IF;
8010513c:	e8 aa ef ff ff       	call   801040eb <mycpu>
80105141:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105144:	81 e2 00 02 00 00    	and    $0x200,%edx
8010514a:	89 90 a8 00 00 00    	mov    %edx,0xa8(%eax)
  mycpu()->ncli += 1;
80105150:	e8 96 ef ff ff       	call   801040eb <mycpu>
80105155:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
8010515b:	83 c2 01             	add    $0x1,%edx
8010515e:	89 90 a4 00 00 00    	mov    %edx,0xa4(%eax)
}
80105164:	c9                   	leave  
80105165:	c3                   	ret    
...
80105169:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
8010516c:	e8 e5 fd ff ff       	call   80104f56 <readeflags>
80105171:	25 00 02 00 00       	and    $0x200,%eax
80105176:	85 c0                	test   %eax,%eax
80105178:	74 0c                	je     80105186 <popcli+0x20>
    panic("popcli - interruptible");
8010517a:	c7 04 24 a5 88 10 80 	movl   $0x801088a5,(%esp)
80105181:	e8 dc b3 ff ff       	call   80100562 <panic>
  if(--mycpu()->ncli < 0)
80105186:	e8 60 ef ff ff       	call   801040eb <mycpu>
8010518b:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
80105191:	83 ea 01             	sub    $0x1,%edx
80105194:	89 90 a4 00 00 00    	mov    %edx,0xa4(%eax)
8010519a:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
801051a0:	85 c0                	test   %eax,%eax
801051a2:	79 0c                	jns    801051b0 <popcli+0x4a>
    panic("popcli");
801051a4:	c7 04 24 bc 88 10 80 	movl   $0x801088bc,(%esp)
801051ab:	e8 b2 b3 ff ff       	call   80100562 <panic>
  if(mycpu()->ncli == 0 && mycpu()->intena)
801051b0:	e8 36 ef ff ff       	call   801040eb <mycpu>
801051b5:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
801051bb:	85 c0                	test   %eax,%eax
801051bd:	75 14                	jne    801051d3 <popcli+0x6d>
801051bf:	e8 27 ef ff ff       	call   801040eb <mycpu>
801051c4:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
801051ca:	85 c0                	test   %eax,%eax
801051cc:	74 05                	je     801051d3 <popcli+0x6d>
    sti();
801051ce:	e8 99 fd ff ff       	call   80104f6c <sti>
}
801051d3:	c9                   	leave  
801051d4:	c3                   	ret    
...
801051e9:	fc                   	cld    
801051ea:	f3 aa                	rep stos %al,%es:(%edi)
...
8010520e:	fc                   	cld    
8010520f:	f3 ab                	rep stos %eax,%es:(%edi)
...
8010522d:	75 49                	jne    80105278 <memset+0x59>
8010522f:	8b 45 10             	mov    0x10(%ebp),%eax
80105232:	83 e0 03             	and    $0x3,%eax
80105235:	85 c0                	test   %eax,%eax
80105237:	75 3f                	jne    80105278 <memset+0x59>
    c &= 0xFF;
80105239:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80105240:	8b 45 10             	mov    0x10(%ebp),%eax
80105243:	c1 e8 02             	shr    $0x2,%eax
80105246:	89 c2                	mov    %eax,%edx
80105248:	8b 45 0c             	mov    0xc(%ebp),%eax
8010524b:	c1 e0 18             	shl    $0x18,%eax
8010524e:	89 c1                	mov    %eax,%ecx
80105250:	8b 45 0c             	mov    0xc(%ebp),%eax
80105253:	c1 e0 10             	shl    $0x10,%eax
80105256:	09 c1                	or     %eax,%ecx
80105258:	8b 45 0c             	mov    0xc(%ebp),%eax
8010525b:	c1 e0 08             	shl    $0x8,%eax
8010525e:	09 c8                	or     %ecx,%eax
80105260:	0b 45 0c             	or     0xc(%ebp),%eax
80105263:	89 54 24 08          	mov    %edx,0x8(%esp)
80105267:	89 44 24 04          	mov    %eax,0x4(%esp)
8010526b:	8b 45 08             	mov    0x8(%ebp),%eax
8010526e:	89 04 24             	mov    %eax,(%esp)
80105271:	e8 84 ff ff ff       	call   801051fa <stosl>
80105276:	eb 19                	jmp    80105291 <memset+0x72>
  } else
    stosb(dst, c, n);
...
8010528c:	e8 44 ff ff ff       	call   801051d5 <stosb>
  return dst;
...
801052a5:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
801052a8:	eb 30                	jmp    801052da <memcmp+0x44>
    if(*s1 != *s2)
801052aa:	8b 45 fc             	mov    -0x4(%ebp),%eax
801052ad:	0f b6 10             	movzbl (%eax),%edx
801052b0:	8b 45 f8             	mov    -0x8(%ebp),%eax
801052b3:	0f b6 00             	movzbl (%eax),%eax
801052b6:	38 c2                	cmp    %al,%dl
801052b8:	74 18                	je     801052d2 <memcmp+0x3c>
      return *s1 - *s2;
801052ba:	8b 45 fc             	mov    -0x4(%ebp),%eax
801052bd:	0f b6 00             	movzbl (%eax),%eax
801052c0:	0f b6 d0             	movzbl %al,%edx
801052c3:	8b 45 f8             	mov    -0x8(%ebp),%eax
801052c6:	0f b6 00             	movzbl (%eax),%eax
801052c9:	0f b6 c0             	movzbl %al,%eax
801052cc:	29 c2                	sub    %eax,%edx
801052ce:	89 d0                	mov    %edx,%eax
801052d0:	eb 1a                	jmp    801052ec <memcmp+0x56>
    s1++, s2++;
801052d2:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
...
801052e5:	75 c3                	jne    801052aa <memcmp+0x14>
  }
...
801052fd:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
80105300:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105303:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105306:	73 3d                	jae    80105345 <memmove+0x57>
80105308:	8b 45 10             	mov    0x10(%ebp),%eax
8010530b:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010530e:	01 d0                	add    %edx,%eax
80105310:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105313:	76 30                	jbe    80105345 <memmove+0x57>
    s += n;
80105315:	8b 45 10             	mov    0x10(%ebp),%eax
80105318:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
8010531b:	8b 45 10             	mov    0x10(%ebp),%eax
8010531e:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
80105321:	eb 13                	jmp    80105336 <memmove+0x48>
      *--d = *--s;
80105323:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
80105327:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
8010532b:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010532e:	0f b6 10             	movzbl (%eax),%edx
...
80105341:	75 e0                	jne    80105323 <memmove+0x35>
  if(s < d && s + n > d){
80105343:	eb 26                	jmp    8010536b <memmove+0x7d>
  } else
    while(n-- > 0)
80105345:	eb 17                	jmp    8010535e <memmove+0x70>
      *d++ = *s++;
80105347:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010534a:	8d 50 01             	lea    0x1(%eax),%edx
8010534d:	89 55 f8             	mov    %edx,-0x8(%ebp)
80105350:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105353:	8d 4a 01             	lea    0x1(%edx),%ecx
80105356:	89 4d fc             	mov    %ecx,-0x4(%ebp)
80105359:	0f b6 12             	movzbl (%edx),%edx
8010535c:	88 10                	mov    %dl,(%eax)
    while(n-- > 0)
8010535e:	8b 45 10             	mov    0x10(%ebp),%eax
80105361:	8d 50 ff             	lea    -0x1(%eax),%edx
80105364:	89 55 10             	mov    %edx,0x10(%ebp)
80105367:	85 c0                	test   %eax,%eax
80105369:	75 dc                	jne    80105347 <memmove+0x59>
...
80105379:	89 44 24 08          	mov    %eax,0x8(%esp)
...
8010538a:	e8 5f ff ff ff       	call   801052ee <memmove>
}
8010538f:	c9                   	leave  
80105390:	c3                   	ret    
...
80105392:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
80105394:	eb 0c                	jmp    801053a2 <strncmp+0x11>
    n--, p++, q++;
80105396:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010539a:	83 45 08 01          	addl   $0x1,0x8(%ebp)
8010539e:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
  while(n > 0 && *p && *p == *q)
801053a2:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801053a6:	74 1a                	je     801053c2 <strncmp+0x31>
801053a8:	8b 45 08             	mov    0x8(%ebp),%eax
801053ab:	0f b6 00             	movzbl (%eax),%eax
801053ae:	84 c0                	test   %al,%al
801053b0:	74 10                	je     801053c2 <strncmp+0x31>
...
801053be:	38 c2                	cmp    %al,%dl
801053c0:	74 d4                	je     80105396 <strncmp+0x5>
  if(n == 0)
801053c2:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801053c6:	75 07                	jne    801053cf <strncmp+0x3e>
    return 0;
801053c8:	b8 00 00 00 00       	mov    $0x0,%eax
801053cd:	eb 16                	jmp    801053e5 <strncmp+0x54>
  return (uchar)*p - (uchar)*q;
801053cf:	8b 45 08             	mov    0x8(%ebp),%eax
801053d2:	0f b6 00             	movzbl (%eax),%eax
801053d5:	0f b6 d0             	movzbl %al,%edx
801053d8:	8b 45 0c             	mov    0xc(%ebp),%eax
801053db:	0f b6 00             	movzbl (%eax),%eax
801053de:	0f b6 c0             	movzbl %al,%eax
801053e1:	29 c2                	sub    %eax,%edx
...
801053ff:	7e 1e                	jle    8010541f <strncpy+0x38>
80105401:	8b 45 08             	mov    0x8(%ebp),%eax
80105404:	8d 50 01             	lea    0x1(%eax),%edx
80105407:	89 55 08             	mov    %edx,0x8(%ebp)
8010540a:	8b 55 0c             	mov    0xc(%ebp),%edx
8010540d:	8d 4a 01             	lea    0x1(%edx),%ecx
80105410:	89 4d 0c             	mov    %ecx,0xc(%ebp)
80105413:	0f b6 12             	movzbl (%edx),%edx
80105416:	88 10                	mov    %dl,(%eax)
80105418:	0f b6 00             	movzbl (%eax),%eax
8010541b:	84 c0                	test   %al,%al
8010541d:	75 d5                	jne    801053f4 <strncpy+0xd>
    ;
  while(n-- > 0)
8010541f:	eb 0c                	jmp    8010542d <strncpy+0x46>
    *s++ = 0;
80105421:	8b 45 08             	mov    0x8(%ebp),%eax
80105424:	8d 50 01             	lea    0x1(%eax),%edx
80105427:	89 55 08             	mov    %edx,0x8(%ebp)
8010542a:	c6 00 00             	movb   $0x0,(%eax)
  while(n-- > 0)
8010542d:	8b 45 10             	mov    0x10(%ebp),%eax
80105430:	8d 50 ff             	lea    -0x1(%eax),%edx
80105433:	89 55 10             	mov    %edx,0x10(%ebp)
80105436:	85 c0                	test   %eax,%eax
80105438:	7f e7                	jg     80105421 <strncpy+0x3a>
  return os;
...
8010544f:	7f 05                	jg     80105456 <safestrcpy+0x17>
    return os;
80105451:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105454:	eb 31                	jmp    80105487 <safestrcpy+0x48>
  while(--n > 0 && (*s++ = *t++) != 0)
80105456:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010545a:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010545e:	7e 1e                	jle    8010547e <safestrcpy+0x3f>
80105460:	8b 45 08             	mov    0x8(%ebp),%eax
80105463:	8d 50 01             	lea    0x1(%eax),%edx
80105466:	89 55 08             	mov    %edx,0x8(%ebp)
80105469:	8b 55 0c             	mov    0xc(%ebp),%edx
8010546c:	8d 4a 01             	lea    0x1(%edx),%ecx
8010546f:	89 4d 0c             	mov    %ecx,0xc(%ebp)
80105472:	0f b6 12             	movzbl (%edx),%edx
80105475:	88 10                	mov    %dl,(%eax)
80105477:	0f b6 00             	movzbl (%eax),%eax
8010547a:	84 c0                	test   %al,%al
8010547c:	75 d8                	jne    80105456 <safestrcpy+0x17>
    ;
  *s = 0;
8010547e:	8b 45 08             	mov    0x8(%ebp),%eax
80105481:	c6 00 00             	movb   $0x0,(%eax)
  return os;
...
8010548c:	83 ec 10             	sub    $0x10,%esp
  int n;

  for(n = 0; s[n]; n++)
8010548f:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105496:	eb 04                	jmp    8010549c <strlen+0x13>
...
801054a7:	84 c0                	test   %al,%al
801054a9:	75 ed                	jne    80105498 <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
801054b0:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
801054b4:	8b 54 24 08          	mov    0x8(%esp),%edx
...
801054b9:	53                   	push   %ebx
  pushl %esi
801054ba:	56                   	push   %esi
  pushl %edi
801054bb:	57                   	push   %edi

  # Switch stacks
  movl %esp, (%eax)
801054bc:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
801054be:	89 d4                	mov    %edx,%esp
...
8010556b:	83 ec 18             	sub    $0x18,%esp
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
8010556e:	e8 ee eb ff ff       	call   80104161 <myproc>
80105573:	8b 40 18             	mov    0x18(%eax),%eax
80105576:	8b 50 44             	mov    0x44(%eax),%edx
80105579:	8b 45 08             	mov    0x8(%ebp),%eax
8010557c:	c1 e0 02             	shl    $0x2,%eax
8010557f:	01 d0                	add    %edx,%eax
80105581:	8d 50 04             	lea    0x4(%eax),%edx
80105584:	8b 45 0c             	mov    0xc(%ebp),%eax
80105587:	89 44 24 04          	mov    %eax,0x4(%esp)
8010558b:	89 14 24             	mov    %edx,(%esp)
8010558e:	e8 32 ff ff ff       	call   801054c5 <fetchint>
}
80105593:	c9                   	leave  
80105594:	c3                   	ret    
...
80105598:	83 ec 28             	sub    $0x28,%esp
  int i;
  struct proc *curproc = myproc();
8010559b:	e8 c1 eb ff ff       	call   80104161 <myproc>
...
801055b0:	e8 b3 ff ff ff       	call   80105568 <argint>
801055b5:	85 c0                	test   %eax,%eax
801055b7:	79 07                	jns    801055c0 <argptr+0x2b>
    return -1;
801055b9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055be:	eb 3d                	jmp    801055fd <argptr+0x68>
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
801055c0:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801055c4:	78 21                	js     801055e7 <argptr+0x52>
801055c6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055c9:	89 c2                	mov    %eax,%edx
801055cb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055ce:	8b 00                	mov    (%eax),%eax
801055d0:	39 c2                	cmp    %eax,%edx
801055d2:	73 13                	jae    801055e7 <argptr+0x52>
801055d4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055d7:	89 c2                	mov    %eax,%edx
801055d9:	8b 45 10             	mov    0x10(%ebp),%eax
801055dc:	01 c2                	add    %eax,%edx
801055de:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055e1:	8b 00                	mov    (%eax),%eax
801055e3:	39 c2                	cmp    %eax,%edx
801055e5:	76 07                	jbe    801055ee <argptr+0x59>
    return -1;
801055e7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055ec:	eb 0f                	jmp    801055fd <argptr+0x68>
  *pp = (char*)i;
...
80105602:	83 ec 28             	sub    $0x28,%esp
  int addr;
  if(argint(n, &addr) < 0)
...
80105612:	e8 51 ff ff ff       	call   80105568 <argint>
80105617:	85 c0                	test   %eax,%eax
80105619:	79 07                	jns    80105622 <argstr+0x23>
    return -1;
8010561b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105620:	eb 12                	jmp    80105634 <argstr+0x35>
...
8010562f:	e8 d0 fe ff ff       	call   80105504 <fetchstr>
}
80105634:	c9                   	leave  
80105635:	c3                   	ret    
...
8010563a:	83 ec 24             	sub    $0x24,%esp
  int num;
  struct proc *curproc = myproc();
8010563d:	e8 1f eb ff ff       	call   80104161 <myproc>
80105642:	89 45 f4             	mov    %eax,-0xc(%ebp)

  num = curproc->tf->eax;
80105645:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105648:	8b 40 18             	mov    0x18(%eax),%eax
8010564b:	8b 40 1c             	mov    0x1c(%eax),%eax
8010564e:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80105651:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105655:	7e 2d                	jle    80105684 <syscall+0x4e>
80105657:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010565a:	83 f8 16             	cmp    $0x16,%eax
8010565d:	77 25                	ja     80105684 <syscall+0x4e>
8010565f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105662:	8b 04 85 20 b0 10 80 	mov    -0x7fef4fe0(,%eax,4),%eax
80105669:	85 c0                	test   %eax,%eax
8010566b:	74 17                	je     80105684 <syscall+0x4e>
    curproc->tf->eax = syscalls[num]();
8010566d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105670:	8b 58 18             	mov    0x18(%eax),%ebx
80105673:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105676:	8b 04 85 20 b0 10 80 	mov    -0x7fef4fe0(,%eax,4),%eax
8010567d:	ff d0                	call   *%eax
8010567f:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105682:	eb 34                	jmp    801056b8 <syscall+0x82>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            curproc->pid, curproc->name, num);
80105684:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105687:	8d 48 6c             	lea    0x6c(%eax),%ecx
    cprintf("%d %s: unknown sys call %d\n",
8010568a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010568d:	8b 40 10             	mov    0x10(%eax),%eax
80105690:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105693:	89 54 24 0c          	mov    %edx,0xc(%esp)
80105697:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010569b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010569f:	c7 04 24 c3 88 10 80 	movl   $0x801088c3,(%esp)
801056a6:	e8 1d ad ff ff       	call   801003c8 <cprintf>
    curproc->tf->eax = -1;
801056ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801056ae:	8b 40 18             	mov    0x18(%eax),%eax
801056b1:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
801056b8:	83 c4 24             	add    $0x24,%esp
801056bb:	5b                   	pop    %ebx
801056bc:	5d                   	pop    %ebp
801056bd:	c3                   	ret    
...
801056c7:	89 44 24 04          	mov    %eax,0x4(%esp)
801056cb:	8b 45 08             	mov    0x8(%ebp),%eax
801056ce:	89 04 24             	mov    %eax,(%esp)
801056d1:	e8 92 fe ff ff       	call   80105568 <argint>
801056d6:	85 c0                	test   %eax,%eax
801056d8:	79 07                	jns    801056e1 <argfd+0x23>
    return -1;
801056da:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056df:	eb 4f                	jmp    80105730 <argfd+0x72>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
801056e1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801056e4:	85 c0                	test   %eax,%eax
801056e6:	78 20                	js     80105708 <argfd+0x4a>
801056e8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801056eb:	83 f8 0f             	cmp    $0xf,%eax
801056ee:	7f 18                	jg     80105708 <argfd+0x4a>
801056f0:	e8 6c ea ff ff       	call   80104161 <myproc>
801056f5:	8b 55 f0             	mov    -0x10(%ebp),%edx
801056f8:	83 c2 08             	add    $0x8,%edx
801056fb:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801056ff:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105702:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105706:	75 07                	jne    8010570f <argfd+0x51>
    return -1;
80105708:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010570d:	eb 21                	jmp    80105730 <argfd+0x72>
  if(pfd)
8010570f:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105713:	74 08                	je     8010571d <argfd+0x5f>
    *pfd = fd;
80105715:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105718:	8b 45 0c             	mov    0xc(%ebp),%eax
8010571b:	89 10                	mov    %edx,(%eax)
  if(pf)
8010571d:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105721:	74 08                	je     8010572b <argfd+0x6d>
    *pf = f;
80105723:	8b 45 10             	mov    0x10(%ebp),%eax
80105726:	8b 55 f4             	mov    -0xc(%ebp),%edx
...
80105735:	83 ec 18             	sub    $0x18,%esp
  int fd;
  struct proc *curproc = myproc();
80105738:	e8 24 ea ff ff       	call   80104161 <myproc>
8010573d:	89 45 f0             	mov    %eax,-0x10(%ebp)

  for(fd = 0; fd < NOFILE; fd++){
80105740:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80105747:	eb 2a                	jmp    80105773 <fdalloc+0x41>
...
80105758:	75 15                	jne    8010576f <fdalloc+0x3d>
      curproc->ofile[fd] = f;
8010575a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010575d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105760:	8d 4a 08             	lea    0x8(%edx),%ecx
80105763:	8b 55 08             	mov    0x8(%ebp),%edx
80105766:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
8010576a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010576d:	eb 0f                	jmp    8010577e <fdalloc+0x4c>
  for(fd = 0; fd < NOFILE; fd++){
8010576f:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80105773:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80105777:	7e d0                	jle    80105749 <fdalloc+0x17>
    }
  }
  return -1;
...
801057e4:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801057eb:	00 
801057ec:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801057f3:	e8 c6 fe ff ff       	call   801056be <argfd>
801057f8:	85 c0                	test   %eax,%eax
801057fa:	78 35                	js     80105831 <sys_read+0x5a>
801057fc:	8d 45 f0             	lea    -0x10(%ebp),%eax
801057ff:	89 44 24 04          	mov    %eax,0x4(%esp)
80105803:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010580a:	e8 59 fd ff ff       	call   80105568 <argint>
8010580f:	85 c0                	test   %eax,%eax
80105811:	78 1e                	js     80105831 <sys_read+0x5a>
80105813:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105816:	89 44 24 08          	mov    %eax,0x8(%esp)
8010581a:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010581d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105821:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105828:	e8 68 fd ff ff       	call   80105595 <argptr>
8010582d:	85 c0                	test   %eax,%eax
8010582f:	79 07                	jns    80105838 <sys_read+0x61>
    return -1;
80105831:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105836:	eb 19                	jmp    80105851 <sys_read+0x7a>
  return fileread(f, p, n);
80105838:	8b 4d f0             	mov    -0x10(%ebp),%ecx
8010583b:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010583e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105841:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105845:	89 54 24 04          	mov    %edx,0x4(%esp)
80105849:	89 04 24             	mov    %eax,(%esp)
8010584c:	e8 01 b9 ff ff       	call   80101152 <fileread>
}
80105851:	c9                   	leave  
80105852:	c3                   	ret    
...
80105856:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int n;
  char *p;
...
80105867:	00 
80105868:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010586f:	e8 4a fe ff ff       	call   801056be <argfd>
80105874:	85 c0                	test   %eax,%eax
80105876:	78 35                	js     801058ad <sys_write+0x5a>
80105878:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010587b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010587f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105886:	e8 dd fc ff ff       	call   80105568 <argint>
8010588b:	85 c0                	test   %eax,%eax
8010588d:	78 1e                	js     801058ad <sys_write+0x5a>
...
8010589d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801058a4:	e8 ec fc ff ff       	call   80105595 <argptr>
801058a9:	85 c0                	test   %eax,%eax
801058ab:	79 07                	jns    801058b4 <sys_write+0x61>
    return -1;
801058ad:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058b2:	eb 19                	jmp    801058cd <sys_write+0x7a>
  return filewrite(f, p, n);
801058b4:	8b 4d f0             	mov    -0x10(%ebp),%ecx
801058b7:	8b 55 ec             	mov    -0x14(%ebp),%edx
801058ba:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058bd:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801058c1:	89 54 24 04          	mov    %edx,0x4(%esp)
801058c5:	89 04 24             	mov    %eax,(%esp)
801058c8:	e8 41 b9 ff ff       	call   8010120e <filewrite>
}
801058cd:	c9                   	leave  
801058ce:	c3                   	ret    
...
801058d2:	83 ec 28             	sub    $0x28,%esp
  int fd;
  struct file *f;
...
801058ea:	e8 cf fd ff ff       	call   801056be <argfd>
801058ef:	85 c0                	test   %eax,%eax
801058f1:	79 07                	jns    801058fa <sys_close+0x2b>
    return -1;
801058f3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058f8:	eb 23                	jmp    8010591d <sys_close+0x4e>
  myproc()->ofile[fd] = 0;
801058fa:	e8 62 e8 ff ff       	call   80104161 <myproc>
801058ff:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105902:	83 c2 08             	add    $0x8,%edx
80105905:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
8010590c:	00 
  fileclose(f);
8010590d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105910:	89 04 24             	mov    %eax,(%esp)
80105913:	e8 15 b7 ff ff       	call   8010102d <fileclose>
  return 0;
...
8010593b:	e8 7e fd ff ff       	call   801056be <argfd>
80105940:	85 c0                	test   %eax,%eax
80105942:	78 1f                	js     80105963 <sys_fstat+0x44>
80105944:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
8010594b:	00 
8010594c:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010594f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105953:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010595a:	e8 36 fc ff ff       	call   80105595 <argptr>
8010595f:	85 c0                	test   %eax,%eax
80105961:	79 07                	jns    8010596a <sys_fstat+0x4b>
    return -1;
80105963:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105968:	eb 12                	jmp    8010597c <sys_fstat+0x5d>
...
80105977:	e8 87 b7 ff ff       	call   80101103 <filestat>
}
8010597c:	c9                   	leave  
8010597d:	c3                   	ret    
...
80105981:	83 ec 38             	sub    $0x38,%esp
...
80105992:	e8 68 fc ff ff       	call   801055ff <argstr>
80105997:	85 c0                	test   %eax,%eax
80105999:	78 17                	js     801059b2 <sys_link+0x34>
8010599b:	8d 45 dc             	lea    -0x24(%ebp),%eax
8010599e:	89 44 24 04          	mov    %eax,0x4(%esp)
801059a2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801059a9:	e8 51 fc ff ff       	call   801055ff <argstr>
801059ae:	85 c0                	test   %eax,%eax
801059b0:	79 0a                	jns    801059bc <sys_link+0x3e>
    return -1;
801059b2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801059b7:	e9 42 01 00 00       	jmp    80105afe <sys_link+0x180>

  begin_op();
801059bc:	e8 c6 da ff ff       	call   80103487 <begin_op>
  if((ip = namei(old)) == 0){
801059c1:	8b 45 d8             	mov    -0x28(%ebp),%eax
801059c4:	89 04 24             	mov    %eax,(%esp)
801059c7:	e8 cb ca ff ff       	call   80102497 <namei>
801059cc:	89 45 f4             	mov    %eax,-0xc(%ebp)
801059cf:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801059d3:	75 0f                	jne    801059e4 <sys_link+0x66>
    end_op();
801059d5:	e8 31 db ff ff       	call   8010350b <end_op>
    return -1;
801059da:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801059df:	e9 1a 01 00 00       	jmp    80105afe <sys_link+0x180>
  }

  ilock(ip);
801059e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059e7:	89 04 24             	mov    %eax,(%esp)
801059ea:	e8 6e bf ff ff       	call   8010195d <ilock>
  if(ip->type == T_DIR){
801059ef:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059f2:	0f b7 40 50          	movzwl 0x50(%eax),%eax
801059f6:	66 83 f8 01          	cmp    $0x1,%ax
801059fa:	75 1a                	jne    80105a16 <sys_link+0x98>
    iunlockput(ip);
801059fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059ff:	89 04 24             	mov    %eax,(%esp)
80105a02:	e8 58 c1 ff ff       	call   80101b5f <iunlockput>
    end_op();
80105a07:	e8 ff da ff ff       	call   8010350b <end_op>
    return -1;
80105a0c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a11:	e9 e8 00 00 00       	jmp    80105afe <sys_link+0x180>
  }

  ip->nlink++;
80105a16:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a19:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105a1d:	8d 50 01             	lea    0x1(%eax),%edx
...
80105a2d:	e8 66 bd ff ff       	call   80101798 <iupdate>
  iunlock(ip);
80105a32:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a35:	89 04 24             	mov    %eax,(%esp)
80105a38:	e8 2d c0 ff ff       	call   80101a6a <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80105a3d:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105a40:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105a43:	89 54 24 04          	mov    %edx,0x4(%esp)
80105a47:	89 04 24             	mov    %eax,(%esp)
80105a4a:	e8 6a ca ff ff       	call   801024b9 <nameiparent>
80105a4f:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105a52:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105a56:	75 02                	jne    80105a5a <sys_link+0xdc>
    goto bad;
80105a58:	eb 68                	jmp    80105ac2 <sys_link+0x144>
  ilock(dp);
80105a5a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a5d:	89 04 24             	mov    %eax,(%esp)
80105a60:	e8 f8 be ff ff       	call   8010195d <ilock>
...
80105a71:	75 20                	jne    80105a93 <sys_link+0x115>
...
80105a8a:	e8 49 c7 ff ff       	call   801021d8 <dirlink>
80105a8f:	85 c0                	test   %eax,%eax
80105a91:	79 0d                	jns    80105aa0 <sys_link+0x122>
    iunlockput(dp);
80105a93:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a96:	89 04 24             	mov    %eax,(%esp)
80105a99:	e8 c1 c0 ff ff       	call   80101b5f <iunlockput>
    goto bad;
80105a9e:	eb 22                	jmp    80105ac2 <sys_link+0x144>
  }
  iunlockput(dp);
80105aa0:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105aa3:	89 04 24             	mov    %eax,(%esp)
80105aa6:	e8 b4 c0 ff ff       	call   80101b5f <iunlockput>
  iput(ip);
80105aab:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105aae:	89 04 24             	mov    %eax,(%esp)
80105ab1:	e8 f8 bf ff ff       	call   80101aae <iput>

  end_op();
80105ab6:	e8 50 da ff ff       	call   8010350b <end_op>

  return 0;
80105abb:	b8 00 00 00 00       	mov    $0x0,%eax
80105ac0:	eb 3c                	jmp    80105afe <sys_link+0x180>

bad:
  ilock(ip);
80105ac2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ac5:	89 04 24             	mov    %eax,(%esp)
80105ac8:	e8 90 be ff ff       	call   8010195d <ilock>
  ip->nlink--;
...
80105aef:	e8 6b c0 ff ff       	call   80101b5f <iunlockput>
  end_op();
80105af4:	e8 12 da ff ff       	call   8010350b <end_op>
  return -1;
...
80105b0d:	eb 4b                	jmp    80105b5a <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105b0f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b12:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105b19:	00 
80105b1a:	89 44 24 08          	mov    %eax,0x8(%esp)
80105b1e:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105b21:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b25:	8b 45 08             	mov    0x8(%ebp),%eax
80105b28:	89 04 24             	mov    %eax,(%esp)
80105b2b:	e8 ca c2 ff ff       	call   80101dfa <readi>
80105b30:	83 f8 10             	cmp    $0x10,%eax
80105b33:	74 0c                	je     80105b41 <isdirempty+0x41>
      panic("isdirempty: readi");
80105b35:	c7 04 24 df 88 10 80 	movl   $0x801088df,(%esp)
80105b3c:	e8 21 aa ff ff       	call   80100562 <panic>
    if(de.inum != 0)
80105b41:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105b45:	66 85 c0             	test   %ax,%ax
80105b48:	74 07                	je     80105b51 <isdirempty+0x51>
      return 0;
80105b4a:	b8 00 00 00 00       	mov    $0x0,%eax
80105b4f:	eb 1b                	jmp    80105b6c <isdirempty+0x6c>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80105b51:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b54:	83 c0 10             	add    $0x10,%eax
80105b57:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105b5a:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105b5d:	8b 45 08             	mov    0x8(%ebp),%eax
80105b60:	8b 40 58             	mov    0x58(%eax),%eax
80105b63:	39 c2                	cmp    %eax,%edx
80105b65:	72 a8                	jb     80105b0f <isdirempty+0xf>
  }
  return 1;
...
80105b71:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
80105b74:	8d 45 cc             	lea    -0x34(%ebp),%eax
80105b77:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b7b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105b82:	e8 78 fa ff ff       	call   801055ff <argstr>
80105b87:	85 c0                	test   %eax,%eax
80105b89:	79 0a                	jns    80105b95 <sys_unlink+0x27>
    return -1;
80105b8b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b90:	e9 af 01 00 00       	jmp    80105d44 <sys_unlink+0x1d6>

  begin_op();
80105b95:	e8 ed d8 ff ff       	call   80103487 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105b9a:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105b9d:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105ba0:	89 54 24 04          	mov    %edx,0x4(%esp)
80105ba4:	89 04 24             	mov    %eax,(%esp)
80105ba7:	e8 0d c9 ff ff       	call   801024b9 <nameiparent>
80105bac:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105baf:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105bb3:	75 0f                	jne    80105bc4 <sys_unlink+0x56>
    end_op();
80105bb5:	e8 51 d9 ff ff       	call   8010350b <end_op>
    return -1;
80105bba:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105bbf:	e9 80 01 00 00       	jmp    80105d44 <sys_unlink+0x1d6>
  }

  ilock(dp);
80105bc4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bc7:	89 04 24             	mov    %eax,(%esp)
80105bca:	e8 8e bd ff ff       	call   8010195d <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105bcf:	c7 44 24 04 f1 88 10 	movl   $0x801088f1,0x4(%esp)
80105bd6:	80 
80105bd7:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105bda:	89 04 24             	mov    %eax,(%esp)
80105bdd:	e8 0b c5 ff ff       	call   801020ed <namecmp>
80105be2:	85 c0                	test   %eax,%eax
80105be4:	0f 84 45 01 00 00    	je     80105d2f <sys_unlink+0x1c1>
80105bea:	c7 44 24 04 f3 88 10 	movl   $0x801088f3,0x4(%esp)
80105bf1:	80 
80105bf2:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105bf5:	89 04 24             	mov    %eax,(%esp)
80105bf8:	e8 f0 c4 ff ff       	call   801020ed <namecmp>
80105bfd:	85 c0                	test   %eax,%eax
80105bff:	0f 84 2a 01 00 00    	je     80105d2f <sys_unlink+0x1c1>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80105c05:	8d 45 c8             	lea    -0x38(%ebp),%eax
80105c08:	89 44 24 08          	mov    %eax,0x8(%esp)
80105c0c:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105c0f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c13:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c16:	89 04 24             	mov    %eax,(%esp)
80105c19:	e8 f1 c4 ff ff       	call   8010210f <dirlookup>
80105c1e:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105c21:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105c25:	75 05                	jne    80105c2c <sys_unlink+0xbe>
    goto bad;
80105c27:	e9 03 01 00 00       	jmp    80105d2f <sys_unlink+0x1c1>
  ilock(ip);
80105c2c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c2f:	89 04 24             	mov    %eax,(%esp)
80105c32:	e8 26 bd ff ff       	call   8010195d <ilock>

  if(ip->nlink < 1)
80105c37:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c3a:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105c3e:	66 85 c0             	test   %ax,%ax
80105c41:	7f 0c                	jg     80105c4f <sys_unlink+0xe1>
    panic("unlink: nlink < 1");
80105c43:	c7 04 24 f6 88 10 80 	movl   $0x801088f6,(%esp)
80105c4a:	e8 13 a9 ff ff       	call   80100562 <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105c4f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c52:	0f b7 40 50          	movzwl 0x50(%eax),%eax
80105c56:	66 83 f8 01          	cmp    $0x1,%ax
80105c5a:	75 1f                	jne    80105c7b <sys_unlink+0x10d>
80105c5c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c5f:	89 04 24             	mov    %eax,(%esp)
80105c62:	e8 99 fe ff ff       	call   80105b00 <isdirempty>
80105c67:	85 c0                	test   %eax,%eax
80105c69:	75 10                	jne    80105c7b <sys_unlink+0x10d>
    iunlockput(ip);
80105c6b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c6e:	89 04 24             	mov    %eax,(%esp)
80105c71:	e8 e9 be ff ff       	call   80101b5f <iunlockput>
    goto bad;
80105c76:	e9 b4 00 00 00       	jmp    80105d2f <sys_unlink+0x1c1>
  }

  memset(&de, 0, sizeof(de));
80105c7b:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105c82:	00 
80105c83:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105c8a:	00 
80105c8b:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105c8e:	89 04 24             	mov    %eax,(%esp)
80105c91:	e8 89 f5 ff ff       	call   8010521f <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105c96:	8b 45 c8             	mov    -0x38(%ebp),%eax
80105c99:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105ca0:	00 
80105ca1:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80105cb2:	e8 a7 c2 ff ff       	call   80101f5e <writei>
80105cb7:	83 f8 10             	cmp    $0x10,%eax
80105cba:	74 0c                	je     80105cc8 <sys_unlink+0x15a>
    panic("unlink: writei");
80105cbc:	c7 04 24 08 89 10 80 	movl   $0x80108908,(%esp)
80105cc3:	e8 9a a8 ff ff       	call   80100562 <panic>
  if(ip->type == T_DIR){
80105cc8:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ccb:	0f b7 40 50          	movzwl 0x50(%eax),%eax
80105ccf:	66 83 f8 01          	cmp    $0x1,%ax
80105cd3:	75 1c                	jne    80105cf1 <sys_unlink+0x183>
    dp->nlink--;
80105cd5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cd8:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105cdc:	8d 50 ff             	lea    -0x1(%eax),%edx
80105cdf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ce2:	66 89 50 56          	mov    %dx,0x56(%eax)
    iupdate(dp);
80105ce6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ce9:	89 04 24             	mov    %eax,(%esp)
80105cec:	e8 a7 ba ff ff       	call   80101798 <iupdate>
  }
  iunlockput(dp);
80105cf1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cf4:	89 04 24             	mov    %eax,(%esp)
80105cf7:	e8 63 be ff ff       	call   80101b5f <iunlockput>

  ip->nlink--;
80105cfc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cff:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105d03:	8d 50 ff             	lea    -0x1(%eax),%edx
80105d06:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d09:	66 89 50 56          	mov    %dx,0x56(%eax)
  iupdate(ip);
80105d0d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d10:	89 04 24             	mov    %eax,(%esp)
80105d13:	e8 80 ba ff ff       	call   80101798 <iupdate>
  iunlockput(ip);
80105d18:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d1b:	89 04 24             	mov    %eax,(%esp)
80105d1e:	e8 3c be ff ff       	call   80101b5f <iunlockput>

  end_op();
80105d23:	e8 e3 d7 ff ff       	call   8010350b <end_op>

  return 0;
80105d28:	b8 00 00 00 00       	mov    $0x0,%eax
80105d2d:	eb 15                	jmp    80105d44 <sys_unlink+0x1d6>

bad:
  iunlockput(dp);
80105d2f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d32:	89 04 24             	mov    %eax,(%esp)
80105d35:	e8 25 be ff ff       	call   80101b5f <iunlockput>
  end_op();
80105d3a:	e8 cc d7 ff ff       	call   8010350b <end_op>
  return -1;
...
80105d49:	83 ec 48             	sub    $0x48,%esp
...
80105d68:	8b 45 08             	mov    0x8(%ebp),%eax
80105d6b:	89 04 24             	mov    %eax,(%esp)
80105d6e:	e8 46 c7 ff ff       	call   801024b9 <nameiparent>
...
80105d81:	e9 7e 01 00 00       	jmp    80105f04 <create+0x1be>
  ilock(dp);
80105d86:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d89:	89 04 24             	mov    %eax,(%esp)
80105d8c:	e8 cc bb ff ff       	call   8010195d <ilock>
...
80105da5:	e8 65 c3 ff ff       	call   8010210f <dirlookup>
80105daa:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105dad:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105db1:	74 47                	je     80105dfa <create+0xb4>
    iunlockput(dp);
80105db3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105db6:	89 04 24             	mov    %eax,(%esp)
80105db9:	e8 a1 bd ff ff       	call   80101b5f <iunlockput>
    ilock(ip);
80105dbe:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105dc1:	89 04 24             	mov    %eax,(%esp)
80105dc4:	e8 94 bb ff ff       	call   8010195d <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80105dc9:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80105dce:	75 15                	jne    80105de5 <create+0x9f>
80105dd0:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105dd3:	0f b7 40 50          	movzwl 0x50(%eax),%eax
80105dd7:	66 83 f8 02          	cmp    $0x2,%ax
80105ddb:	75 08                	jne    80105de5 <create+0x9f>
      return ip;
80105ddd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105de0:	e9 1f 01 00 00       	jmp    80105f04 <create+0x1be>
    iunlockput(ip);
80105de5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105de8:	89 04 24             	mov    %eax,(%esp)
80105deb:	e8 6f bd ff ff       	call   80101b5f <iunlockput>
    return 0;
80105df0:	b8 00 00 00 00       	mov    $0x0,%eax
80105df5:	e9 0a 01 00 00       	jmp    80105f04 <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80105dfa:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
80105dfe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e01:	8b 00                	mov    (%eax),%eax
80105e03:	89 54 24 04          	mov    %edx,0x4(%esp)
80105e07:	89 04 24             	mov    %eax,(%esp)
80105e0a:	e8 b4 b8 ff ff       	call   801016c3 <ialloc>
80105e0f:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105e12:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105e16:	75 0c                	jne    80105e24 <create+0xde>
    panic("create: ialloc");
80105e18:	c7 04 24 17 89 10 80 	movl   $0x80108917,(%esp)
80105e1f:	e8 3e a7 ff ff       	call   80100562 <panic>

  ilock(ip);
80105e24:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e27:	89 04 24             	mov    %eax,(%esp)
80105e2a:	e8 2e bb ff ff       	call   8010195d <ilock>
  ip->major = major;
80105e2f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e32:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80105e36:	66 89 50 52          	mov    %dx,0x52(%eax)
  ip->minor = minor;
80105e3a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e3d:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80105e41:	66 89 50 54          	mov    %dx,0x54(%eax)
  ip->nlink = 1;
80105e45:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e48:	66 c7 40 56 01 00    	movw   $0x1,0x56(%eax)
  iupdate(ip);
80105e4e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e51:	89 04 24             	mov    %eax,(%esp)
80105e54:	e8 3f b9 ff ff       	call   80101798 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80105e59:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80105e5e:	75 6a                	jne    80105eca <create+0x184>
    dp->nlink++;  // for ".."
80105e60:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e63:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105e67:	8d 50 01             	lea    0x1(%eax),%edx
80105e6a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e6d:	66 89 50 56          	mov    %dx,0x56(%eax)
    iupdate(dp);
...
80105ebc:	79 0c                	jns    80105eca <create+0x184>
      panic("create dots");
80105ebe:	c7 04 24 26 89 10 80 	movl   $0x80108926,(%esp)
80105ec5:	e8 98 a6 ff ff       	call   80100562 <panic>
  }
...
80105ee1:	e8 f2 c2 ff ff       	call   801021d8 <dirlink>
80105ee6:	85 c0                	test   %eax,%eax
80105ee8:	79 0c                	jns    80105ef6 <create+0x1b0>
    panic("create: dirlink");
80105eea:	c7 04 24 32 89 10 80 	movl   $0x80108932,(%esp)
80105ef1:	e8 6c a6 ff ff       	call   80100562 <panic>

  iunlockput(dp);
80105ef6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ef9:	89 04 24             	mov    %eax,(%esp)
80105efc:	e8 5e bc ff ff       	call   80101b5f <iunlockput>
...
80105f1a:	e8 e0 f6 ff ff       	call   801055ff <argstr>
...
80105f31:	e8 32 f6 ff ff       	call   80105568 <argint>
80105f36:	85 c0                	test   %eax,%eax
80105f38:	79 0a                	jns    80105f44 <sys_open+0x3e>
    return -1;
80105f3a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f3f:	e9 5c 01 00 00       	jmp    801060a0 <sys_open+0x19a>

  begin_op();
80105f44:	e8 3e d5 ff ff       	call   80103487 <begin_op>
...
80105f73:	e8 ce fd ff ff       	call   80105d46 <create>
80105f78:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(ip == 0){
80105f7b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105f7f:	75 6b                	jne    80105fec <sys_open+0xe6>
      end_op();
80105f81:	e8 85 d5 ff ff       	call   8010350b <end_op>
      return -1;
80105f86:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f8b:	e9 10 01 00 00       	jmp    801060a0 <sys_open+0x19a>
    }
  } else {
    if((ip = namei(path)) == 0){
80105f90:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105f93:	89 04 24             	mov    %eax,(%esp)
80105f96:	e8 fc c4 ff ff       	call   80102497 <namei>
...
80105fae:	e9 ed 00 00 00       	jmp    801060a0 <sys_open+0x19a>
    }
    ilock(ip);
80105fb3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fb6:	89 04 24             	mov    %eax,(%esp)
80105fb9:	e8 9f b9 ff ff       	call   8010195d <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105fbe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fc1:	0f b7 40 50          	movzwl 0x50(%eax),%eax
80105fc5:	66 83 f8 01          	cmp    $0x1,%ax
80105fc9:	75 21                	jne    80105fec <sys_open+0xe6>
80105fcb:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105fce:	85 c0                	test   %eax,%eax
80105fd0:	74 1a                	je     80105fec <sys_open+0xe6>
      iunlockput(ip);
80105fd2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fd5:	89 04 24             	mov    %eax,(%esp)
80105fd8:	e8 82 bb ff ff       	call   80101b5f <iunlockput>
      end_op();
80105fdd:	e8 29 d5 ff ff       	call   8010350b <end_op>
      return -1;
80105fe2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105fe7:	e9 b4 00 00 00       	jmp    801060a0 <sys_open+0x19a>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80105fec:	e8 94 af ff ff       	call   80100f85 <filealloc>
80105ff1:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105ff4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105ff8:	74 14                	je     8010600e <sys_open+0x108>
80105ffa:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ffd:	89 04 24             	mov    %eax,(%esp)
80106000:	e8 2d f7 ff ff       	call   80105732 <fdalloc>
80106005:	89 45 ec             	mov    %eax,-0x14(%ebp)
80106008:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010600c:	79 28                	jns    80106036 <sys_open+0x130>
    if(f)
8010600e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106012:	74 0b                	je     8010601f <sys_open+0x119>
      fileclose(f);
80106014:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106017:	89 04 24             	mov    %eax,(%esp)
8010601a:	e8 0e b0 ff ff       	call   8010102d <fileclose>
    iunlockput(ip);
8010601f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106022:	89 04 24             	mov    %eax,(%esp)
80106025:	e8 35 bb ff ff       	call   80101b5f <iunlockput>
    end_op();
8010602a:	e8 dc d4 ff ff       	call   8010350b <end_op>
    return -1;
8010602f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106034:	eb 6a                	jmp    801060a0 <sys_open+0x19a>
  }
  iunlock(ip);
80106036:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106039:	89 04 24             	mov    %eax,(%esp)
8010603c:	e8 29 ba ff ff       	call   80101a6a <iunlock>
  end_op();
80106041:	e8 c5 d4 ff ff       	call   8010350b <end_op>

  f->type = FD_INODE;
80106046:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106049:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
8010604f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106052:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106055:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80106058:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010605b:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80106062:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106065:	83 e0 01             	and    $0x1,%eax
80106068:	85 c0                	test   %eax,%eax
8010606a:	0f 94 c0             	sete   %al
8010606d:	89 c2                	mov    %eax,%edx
8010606f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106072:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80106075:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106078:	83 e0 01             	and    $0x1,%eax
8010607b:	85 c0                	test   %eax,%eax
8010607d:	75 0a                	jne    80106089 <sys_open+0x183>
8010607f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106082:	83 e0 02             	and    $0x2,%eax
80106085:	85 c0                	test   %eax,%eax
80106087:	74 07                	je     80106090 <sys_open+0x18a>
80106089:	b8 01 00 00 00       	mov    $0x1,%eax
8010608e:	eb 05                	jmp    80106095 <sys_open+0x18f>
80106090:	b8 00 00 00 00       	mov    $0x0,%eax
80106095:	89 c2                	mov    %eax,%edx
80106097:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010609a:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
...
801060a5:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
801060a8:	e8 da d3 ff ff       	call   80103487 <begin_op>
...
801060bb:	e8 3f f5 ff ff       	call   801055ff <argstr>
801060c0:	85 c0                	test   %eax,%eax
801060c2:	78 2c                	js     801060f0 <sys_mkdir+0x4e>
801060c4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060c7:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
801060ce:	00 
801060cf:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801060d6:	00 
801060d7:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801060de:	00 
801060df:	89 04 24             	mov    %eax,(%esp)
801060e2:	e8 5f fc ff ff       	call   80105d46 <create>
801060e7:	89 45 f4             	mov    %eax,-0xc(%ebp)
801060ea:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801060ee:	75 0c                	jne    801060fc <sys_mkdir+0x5a>
    end_op();
801060f0:	e8 16 d4 ff ff       	call   8010350b <end_op>
    return -1;
801060f5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060fa:	eb 15                	jmp    80106111 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
801060fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060ff:	89 04 24             	mov    %eax,(%esp)
80106102:	e8 58 ba ff ff       	call   80101b5f <iunlockput>
  end_op();
80106107:	e8 ff d3 ff ff       	call   8010350b <end_op>
  return 0;
...
80106116:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80106119:	e8 69 d3 ff ff       	call   80103487 <begin_op>
  if((argstr(0, &path)) < 0 ||
8010611e:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106121:	89 44 24 04          	mov    %eax,0x4(%esp)
80106125:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010612c:	e8 ce f4 ff ff       	call   801055ff <argstr>
80106131:	85 c0                	test   %eax,%eax
80106133:	78 5e                	js     80106193 <sys_mknod+0x80>
     argint(1, &major) < 0 ||
80106135:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106138:	89 44 24 04          	mov    %eax,0x4(%esp)
8010613c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106143:	e8 20 f4 ff ff       	call   80105568 <argint>
  if((argstr(0, &path)) < 0 ||
80106148:	85 c0                	test   %eax,%eax
8010614a:	78 47                	js     80106193 <sys_mknod+0x80>
     argint(2, &minor) < 0 ||
8010614c:	8d 45 e8             	lea    -0x18(%ebp),%eax
8010614f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106153:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010615a:	e8 09 f4 ff ff       	call   80105568 <argint>
     argint(1, &major) < 0 ||
8010615f:	85 c0                	test   %eax,%eax
80106161:	78 30                	js     80106193 <sys_mknod+0x80>
     (ip = create(path, T_DEV, major, minor)) == 0){
80106163:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106166:	0f bf c8             	movswl %ax,%ecx
80106169:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010616c:	0f bf d0             	movswl %ax,%edx
8010616f:	8b 45 f0             	mov    -0x10(%ebp),%eax
     argint(2, &minor) < 0 ||
80106172:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106176:	89 54 24 08          	mov    %edx,0x8(%esp)
8010617a:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106181:	00 
80106182:	89 04 24             	mov    %eax,(%esp)
80106185:	e8 bc fb ff ff       	call   80105d46 <create>
8010618a:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010618d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106191:	75 0c                	jne    8010619f <sys_mknod+0x8c>
    end_op();
80106193:	e8 73 d3 ff ff       	call   8010350b <end_op>
    return -1;
80106198:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010619d:	eb 15                	jmp    801061b4 <sys_mknod+0xa1>
  }
  iunlockput(ip);
8010619f:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061a2:	89 04 24             	mov    %eax,(%esp)
801061a5:	e8 b5 b9 ff ff       	call   80101b5f <iunlockput>
  end_op();
801061aa:	e8 5c d3 ff ff       	call   8010350b <end_op>
  return 0;
...
801061b9:	83 ec 28             	sub    $0x28,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801061bc:	e8 a0 df ff ff       	call   80104161 <myproc>
801061c1:	89 45 f4             	mov    %eax,-0xc(%ebp)
  
  begin_op();
801061c4:	e8 be d2 ff ff       	call   80103487 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
801061c9:	8d 45 ec             	lea    -0x14(%ebp),%eax
801061cc:	89 44 24 04          	mov    %eax,0x4(%esp)
801061d0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801061d7:	e8 23 f4 ff ff       	call   801055ff <argstr>
801061dc:	85 c0                	test   %eax,%eax
801061de:	78 14                	js     801061f4 <sys_chdir+0x3e>
801061e0:	8b 45 ec             	mov    -0x14(%ebp),%eax
801061e3:	89 04 24             	mov    %eax,(%esp)
801061e6:	e8 ac c2 ff ff       	call   80102497 <namei>
801061eb:	89 45 f0             	mov    %eax,-0x10(%ebp)
801061ee:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801061f2:	75 0c                	jne    80106200 <sys_chdir+0x4a>
    end_op();
801061f4:	e8 12 d3 ff ff       	call   8010350b <end_op>
    return -1;
801061f9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061fe:	eb 5b                	jmp    8010625b <sys_chdir+0xa5>
  }
  ilock(ip);
80106200:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106203:	89 04 24             	mov    %eax,(%esp)
80106206:	e8 52 b7 ff ff       	call   8010195d <ilock>
  if(ip->type != T_DIR){
8010620b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010620e:	0f b7 40 50          	movzwl 0x50(%eax),%eax
80106212:	66 83 f8 01          	cmp    $0x1,%ax
80106216:	74 17                	je     8010622f <sys_chdir+0x79>
    iunlockput(ip);
80106218:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010621b:	89 04 24             	mov    %eax,(%esp)
8010621e:	e8 3c b9 ff ff       	call   80101b5f <iunlockput>
    end_op();
80106223:	e8 e3 d2 ff ff       	call   8010350b <end_op>
    return -1;
80106228:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010622d:	eb 2c                	jmp    8010625b <sys_chdir+0xa5>
  }
  iunlock(ip);
8010622f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106232:	89 04 24             	mov    %eax,(%esp)
80106235:	e8 30 b8 ff ff       	call   80101a6a <iunlock>
  iput(curproc->cwd);
8010623a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010623d:	8b 40 68             	mov    0x68(%eax),%eax
80106240:	89 04 24             	mov    %eax,(%esp)
80106243:	e8 66 b8 ff ff       	call   80101aae <iput>
  end_op();
...
80106260:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
80106274:	e8 86 f3 ff ff       	call   801055ff <argstr>
80106279:	85 c0                	test   %eax,%eax
8010627b:	78 1a                	js     80106297 <sys_exec+0x3a>
8010627d:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80106283:	89 44 24 04          	mov    %eax,0x4(%esp)
80106287:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010628e:	e8 d5 f2 ff ff       	call   80105568 <argint>
80106293:	85 c0                	test   %eax,%eax
80106295:	79 0a                	jns    801062a1 <sys_exec+0x44>
    return -1;
80106297:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010629c:	e9 c8 00 00 00       	jmp    80106369 <sys_exec+0x10c>
  }
  memset(argv, 0, sizeof(argv));
801062a1:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
801062a8:	00 
801062a9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801062b0:	00 
801062b1:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801062b7:	89 04 24             	mov    %eax,(%esp)
801062ba:	e8 60 ef ff ff       	call   8010521f <memset>
  for(i=0;; i++){
801062bf:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
801062c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062c9:	83 f8 1f             	cmp    $0x1f,%eax
801062cc:	76 0a                	jbe    801062d8 <sys_exec+0x7b>
      return -1;
801062ce:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062d3:	e9 91 00 00 00       	jmp    80106369 <sys_exec+0x10c>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
801062d8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062db:	c1 e0 02             	shl    $0x2,%eax
801062de:	89 c2                	mov    %eax,%edx
801062e0:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
801062e6:	01 c2                	add    %eax,%edx
801062e8:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
801062ee:	89 44 24 04          	mov    %eax,0x4(%esp)
801062f2:	89 14 24             	mov    %edx,(%esp)
801062f5:	e8 cb f1 ff ff       	call   801054c5 <fetchint>
801062fa:	85 c0                	test   %eax,%eax
801062fc:	79 07                	jns    80106305 <sys_exec+0xa8>
      return -1;
801062fe:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106303:	eb 64                	jmp    80106369 <sys_exec+0x10c>
    if(uarg == 0){
80106305:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
8010630b:	85 c0                	test   %eax,%eax
8010630d:	75 26                	jne    80106335 <sys_exec+0xd8>
      argv[i] = 0;
8010630f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106312:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
80106319:	00 00 00 00 
      break;
8010631d:	90                   	nop
    }
...
80106321:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
80106327:	89 54 24 04          	mov    %edx,0x4(%esp)
8010632b:	89 04 24             	mov    %eax,(%esp)
8010632e:	e8 eb a7 ff ff       	call   80100b1e <exec>
80106333:	eb 34                	jmp    80106369 <sys_exec+0x10c>
    if(fetchstr(uarg, &argv[i]) < 0)
80106335:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
8010633b:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010633e:	c1 e2 02             	shl    $0x2,%edx
80106341:	01 c2                	add    %eax,%edx
80106343:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106349:	89 54 24 04          	mov    %edx,0x4(%esp)
8010634d:	89 04 24             	mov    %eax,(%esp)
80106350:	e8 af f1 ff ff       	call   80105504 <fetchstr>
80106355:	85 c0                	test   %eax,%eax
80106357:	79 07                	jns    80106360 <sys_exec+0x103>
      return -1;
80106359:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010635e:	eb 09                	jmp    80106369 <sys_exec+0x10c>
  for(i=0;; i++){
80106360:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  }
80106364:	e9 5d ff ff ff       	jmp    801062c6 <sys_exec+0x69>
}
80106369:	c9                   	leave  
8010636a:	c3                   	ret    
...
8010636e:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
80106371:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80106378:	00 
80106379:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010637c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106380:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106387:	e8 09 f2 ff ff       	call   80105595 <argptr>
8010638c:	85 c0                	test   %eax,%eax
8010638e:	79 0a                	jns    8010639a <sys_pipe+0x2f>
    return -1;
80106390:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106395:	e9 9a 00 00 00       	jmp    80106434 <sys_pipe+0xc9>
  if(pipealloc(&rf, &wf) < 0)
8010639a:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010639d:	89 44 24 04          	mov    %eax,0x4(%esp)
801063a1:	8d 45 e8             	lea    -0x18(%ebp),%eax
801063a4:	89 04 24             	mov    %eax,(%esp)
801063a7:	e8 39 d9 ff ff       	call   80103ce5 <pipealloc>
801063ac:	85 c0                	test   %eax,%eax
801063ae:	79 07                	jns    801063b7 <sys_pipe+0x4c>
    return -1;
801063b0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063b5:	eb 7d                	jmp    80106434 <sys_pipe+0xc9>
  fd0 = -1;
801063b7:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
801063be:	8b 45 e8             	mov    -0x18(%ebp),%eax
801063c1:	89 04 24             	mov    %eax,(%esp)
801063c4:	e8 69 f3 ff ff       	call   80105732 <fdalloc>
801063c9:	89 45 f4             	mov    %eax,-0xc(%ebp)
801063cc:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801063d0:	78 14                	js     801063e6 <sys_pipe+0x7b>
801063d2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801063d5:	89 04 24             	mov    %eax,(%esp)
801063d8:	e8 55 f3 ff ff       	call   80105732 <fdalloc>
801063dd:	89 45 f0             	mov    %eax,-0x10(%ebp)
801063e0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801063e4:	79 36                	jns    8010641c <sys_pipe+0xb1>
    if(fd0 >= 0)
801063e6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801063ea:	78 13                	js     801063ff <sys_pipe+0x94>
      myproc()->ofile[fd0] = 0;
801063ec:	e8 70 dd ff ff       	call   80104161 <myproc>
801063f1:	8b 55 f4             	mov    -0xc(%ebp),%edx
801063f4:	83 c2 08             	add    $0x8,%edx
801063f7:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
801063fe:	00 
    fileclose(rf);
801063ff:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106402:	89 04 24             	mov    %eax,(%esp)
80106405:	e8 23 ac ff ff       	call   8010102d <fileclose>
    fileclose(wf);
8010640a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010640d:	89 04 24             	mov    %eax,(%esp)
80106410:	e8 18 ac ff ff       	call   8010102d <fileclose>
    return -1;
80106415:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010641a:	eb 18                	jmp    80106434 <sys_pipe+0xc9>
  }
  fd[0] = fd0;
8010641c:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010641f:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106422:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
80106424:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106427:	8d 50 04             	lea    0x4(%eax),%edx
8010642a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010642d:	89 02                	mov    %eax,(%edx)
  return 0;
...
80106439:	83 ec 08             	sub    $0x8,%esp
  return fork();
8010643c:	e8 38 e0 ff ff       	call   80104479 <fork>
}
80106441:	c9                   	leave  
80106442:	c3                   	ret    
...
80106446:	83 ec 08             	sub    $0x8,%esp
  exit();
80106449:	e8 cb e1 ff ff       	call   80104619 <exit>
...
80106458:	83 ec 08             	sub    $0x8,%esp
  return wait();
8010645b:	e8 c6 e2 ff ff       	call   80104726 <wait>
}
80106460:	c9                   	leave  
80106461:	c3                   	ret    
...
80106476:	e8 ed f0 ff ff       	call   80105568 <argint>
8010647b:	85 c0                	test   %eax,%eax
8010647d:	79 07                	jns    80106486 <sys_kill+0x24>
    return -1;
8010647f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106484:	eb 0b                	jmp    80106491 <sys_kill+0x2f>
  return kill(pid);
80106486:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106489:	89 04 24             	mov    %eax,(%esp)
8010648c:	e8 73 e6 ff ff       	call   80104b04 <kill>
}
80106491:	c9                   	leave  
80106492:	c3                   	ret    
...
80106496:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80106499:	e8 c3 dc ff ff       	call   80104161 <myproc>
...
801064b7:	e8 ac f0 ff ff       	call   80105568 <argint>
801064bc:	85 c0                	test   %eax,%eax
801064be:	79 07                	jns    801064c7 <sys_sbrk+0x24>
    return -1;
801064c0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064c5:	eb 23                	jmp    801064ea <sys_sbrk+0x47>
  addr = myproc()->sz;
801064c7:	e8 95 dc ff ff       	call   80104161 <myproc>
801064cc:	8b 00                	mov    (%eax),%eax
801064ce:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(growproc(n) < 0)
801064d1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064d4:	89 04 24             	mov    %eax,(%esp)
801064d7:	e8 ff de ff ff       	call   801043db <growproc>
801064dc:	85 c0                	test   %eax,%eax
801064de:	79 07                	jns    801064e7 <sys_sbrk+0x44>
    return -1;
801064e0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064e5:	eb 03                	jmp    801064ea <sys_sbrk+0x47>
  return addr;
...
80106500:	e8 63 f0 ff ff       	call   80105568 <argint>
80106505:	85 c0                	test   %eax,%eax
80106507:	79 07                	jns    80106510 <sys_sleep+0x24>
    return -1;
80106509:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010650e:	eb 6b                	jmp    8010657b <sys_sleep+0x8f>
  acquire(&tickslock);
80106510:	c7 04 24 e0 5e 11 80 	movl   $0x80115ee0,(%esp)
80106517:	e8 91 ea ff ff       	call   80104fad <acquire>
  ticks0 = ticks;
8010651c:	a1 20 67 11 80       	mov    0x80116720,%eax
80106521:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80106524:	eb 33                	jmp    80106559 <sys_sleep+0x6d>
    if(myproc()->killed){
80106526:	e8 36 dc ff ff       	call   80104161 <myproc>
8010652b:	8b 40 24             	mov    0x24(%eax),%eax
8010652e:	85 c0                	test   %eax,%eax
80106530:	74 13                	je     80106545 <sys_sleep+0x59>
      release(&tickslock);
80106532:	c7 04 24 e0 5e 11 80 	movl   $0x80115ee0,(%esp)
80106539:	e8 d7 ea ff ff       	call   80105015 <release>
      return -1;
8010653e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106543:	eb 36                	jmp    8010657b <sys_sleep+0x8f>
    }
    sleep(&ticks, &tickslock);
80106545:	c7 44 24 04 e0 5e 11 	movl   $0x80115ee0,0x4(%esp)
8010654c:	80 
8010654d:	c7 04 24 20 67 11 80 	movl   $0x80116720,(%esp)
80106554:	e8 a9 e4 ff ff       	call   80104a02 <sleep>
  while(ticks - ticks0 < n){
80106559:	a1 20 67 11 80       	mov    0x80116720,%eax
8010655e:	2b 45 f4             	sub    -0xc(%ebp),%eax
80106561:	89 c2                	mov    %eax,%edx
80106563:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106566:	39 c2                	cmp    %eax,%edx
80106568:	72 bc                	jb     80106526 <sys_sleep+0x3a>
  }
  release(&tickslock);
8010656a:	c7 04 24 e0 5e 11 80 	movl   $0x80115ee0,(%esp)
80106571:	e8 9f ea ff ff       	call   80105015 <release>
  return 0;
...
80106580:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
80106583:	c7 04 24 e0 5e 11 80 	movl   $0x80115ee0,(%esp)
8010658a:	e8 1e ea ff ff       	call   80104fad <acquire>
  xticks = ticks;
8010658f:	a1 20 67 11 80       	mov    0x80116720,%eax
80106594:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106597:	c7 04 24 e0 5e 11 80 	movl   $0x80115ee0,(%esp)
8010659e:	e8 72 ea ff ff       	call   80105015 <release>
  return xticks;
...
801065e7:	06                   	push   %es
  pushl %fs
801065e8:	0f a0                	push   %fs
  pushl %gs
801065ea:	0f a8                	push   %gs
  pushal
801065ec:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801065ed:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801065f1:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801065f3:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801065f5:	54                   	push   %esp
  call trap
801065f6:	e8 d8 01 00 00       	call   801067d3 <trap>
  addl $4, %esp
801065fb:	83 c4 04             	add    $0x4,%esp
...
801065fe:	61                   	popa   
  popl %gs
801065ff:	0f a9                	pop    %gs
  popl %fs
80106601:	0f a1                	pop    %fs
  popl %es
80106603:	07                   	pop    %es
  popl %ds
80106604:	1f                   	pop    %ds
...
8010660c:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
8010660f:	8b 45 0c             	mov    0xc(%ebp),%eax
80106612:	83 e8 01             	sub    $0x1,%eax
80106615:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106619:	8b 45 08             	mov    0x8(%ebp),%eax
8010661c:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106620:	8b 45 08             	mov    0x8(%ebp),%eax
80106623:	c1 e8 10             	shr    $0x10,%eax
80106626:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
8010662a:	8d 45 fa             	lea    -0x6(%ebp),%eax
8010662d:	0f 01 18             	lidtl  (%eax)
}
80106630:	c9                   	leave  
80106631:	c3                   	ret    
...
80106638:	0f 20 d0             	mov    %cr2,%eax
8010663b:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return val;
8010663e:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
80106641:	c9                   	leave  
80106642:	c3                   	ret    
...
80106646:	83 ec 28             	sub    $0x28,%esp
  int i;

  for(i = 0; i < 256; i++)
80106649:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106650:	e9 c3 00 00 00       	jmp    80106718 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106655:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106658:	8b 04 85 7c b0 10 80 	mov    -0x7fef4f84(,%eax,4),%eax
8010665f:	89 c2                	mov    %eax,%edx
80106661:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106664:	66 89 14 c5 20 5f 11 	mov    %dx,-0x7feea0e0(,%eax,8)
8010666b:	80 
8010666c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010666f:	66 c7 04 c5 22 5f 11 	movw   $0x8,-0x7feea0de(,%eax,8)
80106676:	80 08 00 
80106679:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010667c:	0f b6 14 c5 24 5f 11 	movzbl -0x7feea0dc(,%eax,8),%edx
80106683:	80 
80106684:	83 e2 e0             	and    $0xffffffe0,%edx
80106687:	88 14 c5 24 5f 11 80 	mov    %dl,-0x7feea0dc(,%eax,8)
8010668e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106691:	0f b6 14 c5 24 5f 11 	movzbl -0x7feea0dc(,%eax,8),%edx
80106698:	80 
80106699:	83 e2 1f             	and    $0x1f,%edx
8010669c:	88 14 c5 24 5f 11 80 	mov    %dl,-0x7feea0dc(,%eax,8)
801066a3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066a6:	0f b6 14 c5 25 5f 11 	movzbl -0x7feea0db(,%eax,8),%edx
801066ad:	80 
801066ae:	83 e2 f0             	and    $0xfffffff0,%edx
801066b1:	83 ca 0e             	or     $0xe,%edx
801066b4:	88 14 c5 25 5f 11 80 	mov    %dl,-0x7feea0db(,%eax,8)
801066bb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066be:	0f b6 14 c5 25 5f 11 	movzbl -0x7feea0db(,%eax,8),%edx
801066c5:	80 
801066c6:	83 e2 ef             	and    $0xffffffef,%edx
801066c9:	88 14 c5 25 5f 11 80 	mov    %dl,-0x7feea0db(,%eax,8)
801066d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066d3:	0f b6 14 c5 25 5f 11 	movzbl -0x7feea0db(,%eax,8),%edx
801066da:	80 
801066db:	83 e2 9f             	and    $0xffffff9f,%edx
801066de:	88 14 c5 25 5f 11 80 	mov    %dl,-0x7feea0db(,%eax,8)
801066e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066e8:	0f b6 14 c5 25 5f 11 	movzbl -0x7feea0db(,%eax,8),%edx
801066ef:	80 
801066f0:	83 ca 80             	or     $0xffffff80,%edx
801066f3:	88 14 c5 25 5f 11 80 	mov    %dl,-0x7feea0db(,%eax,8)
801066fa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066fd:	8b 04 85 7c b0 10 80 	mov    -0x7fef4f84(,%eax,4),%eax
80106704:	c1 e8 10             	shr    $0x10,%eax
80106707:	89 c2                	mov    %eax,%edx
80106709:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010670c:	66 89 14 c5 26 5f 11 	mov    %dx,-0x7feea0da(,%eax,8)
80106713:	80 
  for(i = 0; i < 256; i++)
80106714:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106718:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
8010671f:	0f 8e 30 ff ff ff    	jle    80106655 <tvinit+0x12>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106725:	a1 7c b1 10 80       	mov    0x8010b17c,%eax
8010672a:	66 a3 20 61 11 80    	mov    %ax,0x80116120
80106730:	66 c7 05 22 61 11 80 	movw   $0x8,0x80116122
80106737:	08 00 
80106739:	0f b6 05 24 61 11 80 	movzbl 0x80116124,%eax
80106740:	83 e0 e0             	and    $0xffffffe0,%eax
80106743:	a2 24 61 11 80       	mov    %al,0x80116124
80106748:	0f b6 05 24 61 11 80 	movzbl 0x80116124,%eax
8010674f:	83 e0 1f             	and    $0x1f,%eax
80106752:	a2 24 61 11 80       	mov    %al,0x80116124
80106757:	0f b6 05 25 61 11 80 	movzbl 0x80116125,%eax
8010675e:	83 c8 0f             	or     $0xf,%eax
80106761:	a2 25 61 11 80       	mov    %al,0x80116125
80106766:	0f b6 05 25 61 11 80 	movzbl 0x80116125,%eax
8010676d:	83 e0 ef             	and    $0xffffffef,%eax
80106770:	a2 25 61 11 80       	mov    %al,0x80116125
80106775:	0f b6 05 25 61 11 80 	movzbl 0x80116125,%eax
8010677c:	83 c8 60             	or     $0x60,%eax
8010677f:	a2 25 61 11 80       	mov    %al,0x80116125
80106784:	0f b6 05 25 61 11 80 	movzbl 0x80116125,%eax
8010678b:	83 c8 80             	or     $0xffffff80,%eax
8010678e:	a2 25 61 11 80       	mov    %al,0x80116125
80106793:	a1 7c b1 10 80       	mov    0x8010b17c,%eax
80106798:	c1 e8 10             	shr    $0x10,%eax
8010679b:	66 a3 26 61 11 80    	mov    %ax,0x80116126

  initlock(&tickslock, "time");
801067a1:	c7 44 24 04 44 89 10 	movl   $0x80108944,0x4(%esp)
801067a8:	80 
801067a9:	c7 04 24 e0 5e 11 80 	movl   $0x80115ee0,(%esp)
801067b0:	e8 d7 e7 ff ff       	call   80104f8c <initlock>
}
801067b5:	c9                   	leave  
801067b6:	c3                   	ret    
...
801067ba:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
801067bd:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
801067c4:	00 
801067c5:	c7 04 24 20 5f 11 80 	movl   $0x80115f20,(%esp)
801067cc:	e8 38 fe ff ff       	call   80106609 <lidt>
}
801067d1:	c9                   	leave  
801067d2:	c3                   	ret    
...
801067d6:	57                   	push   %edi
801067d7:	56                   	push   %esi
801067d8:	53                   	push   %ebx
801067d9:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
801067dc:	8b 45 08             	mov    0x8(%ebp),%eax
801067df:	8b 40 30             	mov    0x30(%eax),%eax
801067e2:	83 f8 40             	cmp    $0x40,%eax
801067e5:	75 3c                	jne    80106823 <trap+0x50>
    if(myproc()->killed)
801067e7:	e8 75 d9 ff ff       	call   80104161 <myproc>
801067ec:	8b 40 24             	mov    0x24(%eax),%eax
801067ef:	85 c0                	test   %eax,%eax
801067f1:	74 05                	je     801067f8 <trap+0x25>
      exit();
801067f3:	e8 21 de ff ff       	call   80104619 <exit>
    myproc()->tf = tf;
801067f8:	e8 64 d9 ff ff       	call   80104161 <myproc>
801067fd:	8b 55 08             	mov    0x8(%ebp),%edx
80106800:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
80106803:	e8 2e ee ff ff       	call   80105636 <syscall>
    if(myproc()->killed)
80106808:	e8 54 d9 ff ff       	call   80104161 <myproc>
8010680d:	8b 40 24             	mov    0x24(%eax),%eax
80106810:	85 c0                	test   %eax,%eax
80106812:	74 0a                	je     8010681e <trap+0x4b>
      exit();
80106814:	e8 00 de ff ff       	call   80104619 <exit>
    return;
80106819:	e9 19 02 00 00       	jmp    80106a37 <trap+0x264>
8010681e:	e9 14 02 00 00       	jmp    80106a37 <trap+0x264>
  }

  switch(tf->trapno){
80106823:	8b 45 08             	mov    0x8(%ebp),%eax
80106826:	8b 40 30             	mov    0x30(%eax),%eax
80106829:	83 e8 20             	sub    $0x20,%eax
8010682c:	83 f8 1f             	cmp    $0x1f,%eax
8010682f:	0f 87 b1 00 00 00    	ja     801068e6 <trap+0x113>
80106835:	8b 04 85 ec 89 10 80 	mov    -0x7fef7614(,%eax,4),%eax
8010683c:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
8010683e:	e8 87 d8 ff ff       	call   801040ca <cpuid>
80106843:	85 c0                	test   %eax,%eax
80106845:	75 31                	jne    80106878 <trap+0xa5>
      acquire(&tickslock);
80106847:	c7 04 24 e0 5e 11 80 	movl   $0x80115ee0,(%esp)
8010684e:	e8 5a e7 ff ff       	call   80104fad <acquire>
      ticks++;
80106853:	a1 20 67 11 80       	mov    0x80116720,%eax
80106858:	83 c0 01             	add    $0x1,%eax
8010685b:	a3 20 67 11 80       	mov    %eax,0x80116720
      wakeup(&ticks);
80106860:	c7 04 24 20 67 11 80 	movl   $0x80116720,(%esp)
80106867:	e8 6d e2 ff ff       	call   80104ad9 <wakeup>
      release(&tickslock);
8010686c:	c7 04 24 e0 5e 11 80 	movl   $0x80115ee0,(%esp)
80106873:	e8 9d e7 ff ff       	call   80105015 <release>
    }
    lapiceoi();
80106878:	e8 d4 c6 ff ff       	call   80102f51 <lapiceoi>
    break;
8010687d:	e9 37 01 00 00       	jmp    801069b9 <trap+0x1e6>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106882:	e8 41 bf ff ff       	call   801027c8 <ideintr>
    lapiceoi();
80106887:	e8 c5 c6 ff ff       	call   80102f51 <lapiceoi>
    break;
8010688c:	e9 28 01 00 00       	jmp    801069b9 <trap+0x1e6>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106891:	e8 d0 c4 ff ff       	call   80102d66 <kbdintr>
    lapiceoi();
80106896:	e8 b6 c6 ff ff       	call   80102f51 <lapiceoi>
    break;
8010689b:	e9 19 01 00 00       	jmp    801069b9 <trap+0x1e6>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
801068a0:	e8 7b 03 00 00       	call   80106c20 <uartintr>
    lapiceoi();
801068a5:	e8 a7 c6 ff ff       	call   80102f51 <lapiceoi>
    break;
801068aa:	e9 0a 01 00 00       	jmp    801069b9 <trap+0x1e6>
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801068af:	8b 45 08             	mov    0x8(%ebp),%eax
801068b2:	8b 70 38             	mov    0x38(%eax),%esi
            cpuid(), tf->cs, tf->eip);
801068b5:	8b 45 08             	mov    0x8(%ebp),%eax
801068b8:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801068bc:	0f b7 d8             	movzwl %ax,%ebx
801068bf:	e8 06 d8 ff ff       	call   801040ca <cpuid>
801068c4:	89 74 24 0c          	mov    %esi,0xc(%esp)
801068c8:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801068cc:	89 44 24 04          	mov    %eax,0x4(%esp)
801068d0:	c7 04 24 4c 89 10 80 	movl   $0x8010894c,(%esp)
801068d7:	e8 ec 9a ff ff       	call   801003c8 <cprintf>
    lapiceoi();
801068dc:	e8 70 c6 ff ff       	call   80102f51 <lapiceoi>
    break;
801068e1:	e9 d3 00 00 00       	jmp    801069b9 <trap+0x1e6>

  //PAGEBREAK: 13
  default:
    if(myproc() == 0 || (tf->cs&3) == 0){
801068e6:	e8 76 d8 ff ff       	call   80104161 <myproc>
801068eb:	85 c0                	test   %eax,%eax
801068ed:	74 11                	je     80106900 <trap+0x12d>
...
801068fe:	75 40                	jne    80106940 <trap+0x16d>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106900:	e8 2d fd ff ff       	call   80106632 <rcr2>
80106905:	89 c3                	mov    %eax,%ebx
80106907:	8b 45 08             	mov    0x8(%ebp),%eax
8010690a:	8b 70 38             	mov    0x38(%eax),%esi
8010690d:	e8 b8 d7 ff ff       	call   801040ca <cpuid>
80106912:	8b 55 08             	mov    0x8(%ebp),%edx
80106915:	8b 52 30             	mov    0x30(%edx),%edx
80106918:	89 5c 24 10          	mov    %ebx,0x10(%esp)
8010691c:	89 74 24 0c          	mov    %esi,0xc(%esp)
80106920:	89 44 24 08          	mov    %eax,0x8(%esp)
80106924:	89 54 24 04          	mov    %edx,0x4(%esp)
80106928:	c7 04 24 70 89 10 80 	movl   $0x80108970,(%esp)
8010692f:	e8 94 9a ff ff       	call   801003c8 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80106934:	c7 04 24 a2 89 10 80 	movl   $0x801089a2,(%esp)
8010693b:	e8 22 9c ff ff       	call   80100562 <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106940:	e8 ed fc ff ff       	call   80106632 <rcr2>
80106945:	89 c6                	mov    %eax,%esi
80106947:	8b 45 08             	mov    0x8(%ebp),%eax
8010694a:	8b 40 38             	mov    0x38(%eax),%eax
8010694d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106950:	e8 75 d7 ff ff       	call   801040ca <cpuid>
80106955:	89 c3                	mov    %eax,%ebx
80106957:	8b 45 08             	mov    0x8(%ebp),%eax
8010695a:	8b 78 34             	mov    0x34(%eax),%edi
8010695d:	89 7d e0             	mov    %edi,-0x20(%ebp)
80106960:	8b 45 08             	mov    0x8(%ebp),%eax
80106963:	8b 78 30             	mov    0x30(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80106966:	e8 f6 d7 ff ff       	call   80104161 <myproc>
8010696b:	8d 50 6c             	lea    0x6c(%eax),%edx
8010696e:	89 55 dc             	mov    %edx,-0x24(%ebp)
80106971:	e8 eb d7 ff ff       	call   80104161 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106976:	8b 40 10             	mov    0x10(%eax),%eax
80106979:	89 74 24 1c          	mov    %esi,0x1c(%esp)
8010697d:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106980:	89 4c 24 18          	mov    %ecx,0x18(%esp)
80106984:	89 5c 24 14          	mov    %ebx,0x14(%esp)
80106988:	8b 4d e0             	mov    -0x20(%ebp),%ecx
8010698b:	89 4c 24 10          	mov    %ecx,0x10(%esp)
8010698f:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80106993:	8b 55 dc             	mov    -0x24(%ebp),%edx
80106996:	89 54 24 08          	mov    %edx,0x8(%esp)
8010699a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010699e:	c7 04 24 a8 89 10 80 	movl   $0x801089a8,(%esp)
801069a5:	e8 1e 9a ff ff       	call   801003c8 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801069aa:	e8 b2 d7 ff ff       	call   80104161 <myproc>
801069af:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
801069b6:	eb 01                	jmp    801069b9 <trap+0x1e6>
    break;
801069b8:	90                   	nop
  }
...
801069b9:	e8 a3 d7 ff ff       	call   80104161 <myproc>
801069be:	85 c0                	test   %eax,%eax
801069c0:	74 23                	je     801069e5 <trap+0x212>
801069c2:	e8 9a d7 ff ff       	call   80104161 <myproc>
801069c7:	8b 40 24             	mov    0x24(%eax),%eax
801069ca:	85 c0                	test   %eax,%eax
801069cc:	74 17                	je     801069e5 <trap+0x212>
801069ce:	8b 45 08             	mov    0x8(%ebp),%eax
801069d1:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
801069d5:	0f b7 c0             	movzwl %ax,%eax
801069d8:	83 e0 03             	and    $0x3,%eax
801069db:	83 f8 03             	cmp    $0x3,%eax
801069de:	75 05                	jne    801069e5 <trap+0x212>
    exit();
801069e0:	e8 34 dc ff ff       	call   80104619 <exit>

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
801069e5:	e8 77 d7 ff ff       	call   80104161 <myproc>
801069ea:	85 c0                	test   %eax,%eax
801069ec:	74 1d                	je     80106a0b <trap+0x238>
801069ee:	e8 6e d7 ff ff       	call   80104161 <myproc>
801069f3:	8b 40 0c             	mov    0xc(%eax),%eax
801069f6:	83 f8 04             	cmp    $0x4,%eax
801069f9:	75 10                	jne    80106a0b <trap+0x238>
     tf->trapno == T_IRQ0+IRQ_TIMER)
801069fb:	8b 45 08             	mov    0x8(%ebp),%eax
801069fe:	8b 40 30             	mov    0x30(%eax),%eax
  if(myproc() && myproc()->state == RUNNING &&
80106a01:	83 f8 20             	cmp    $0x20,%eax
80106a04:	75 05                	jne    80106a0b <trap+0x238>
    yield();
80106a06:	e8 87 df ff ff       	call   80104992 <yield>

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106a0b:	e8 51 d7 ff ff       	call   80104161 <myproc>
80106a10:	85 c0                	test   %eax,%eax
80106a12:	74 23                	je     80106a37 <trap+0x264>
80106a14:	e8 48 d7 ff ff       	call   80104161 <myproc>
80106a19:	8b 40 24             	mov    0x24(%eax),%eax
80106a1c:	85 c0                	test   %eax,%eax
80106a1e:	74 17                	je     80106a37 <trap+0x264>
...
80106a30:	75 05                	jne    80106a37 <trap+0x264>
    exit();
80106a32:	e8 e2 db ff ff       	call   80104619 <exit>
}
80106a37:	83 c4 3c             	add    $0x3c,%esp
80106a3a:	5b                   	pop    %ebx
80106a3b:	5e                   	pop    %esi
80106a3c:	5f                   	pop    %edi
80106a3d:	5d                   	pop    %ebp
...
80106a42:	83 ec 14             	sub    $0x14,%esp
80106a45:	8b 45 08             	mov    0x8(%ebp),%eax
80106a48:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106a4c:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
80106a50:	89 c2                	mov    %eax,%edx
80106a52:	ec                   	in     (%dx),%al
80106a53:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
80106a56:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
80106a5a:	c9                   	leave  
80106a5b:	c3                   	ret    
...
80106a94:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106a9b:	00 
80106a9c:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106aa3:	e8 b4 ff ff ff       	call   80106a5c <outb>
  outb(COM1+0, 115200/9600);
80106aa8:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106aaf:	00 
...
80106ac3:	00 
80106ac4:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106acb:	e8 8c ff ff ff       	call   80106a5c <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106ad0:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106ad7:	00 
80106ad8:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106adf:	e8 78 ff ff ff       	call   80106a5c <outb>
  outb(COM1+4, 0);
80106ae4:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106aeb:	00 
80106aec:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106af3:	e8 64 ff ff ff       	call   80106a5c <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106af8:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106aff:	00 
80106b00:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106b07:	e8 50 ff ff ff       	call   80106a5c <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80106b0c:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106b13:	e8 27 ff ff ff       	call   80106a3f <inb>
80106b18:	3c ff                	cmp    $0xff,%al
80106b1a:	75 02                	jne    80106b1e <uartinit+0xa4>
    return;
80106b1c:	eb 5e                	jmp    80106b7c <uartinit+0x102>
  uart = 1;
80106b1e:	c7 05 24 b6 10 80 01 	movl   $0x1,0x8010b624
80106b25:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80106b28:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106b2f:	e8 0b ff ff ff       	call   80106a3f <inb>
  inb(COM1+0);
80106b34:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106b3b:	e8 ff fe ff ff       	call   80106a3f <inb>
  ioapicenable(IRQ_COM1, 0);
80106b40:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106b47:	00 
80106b48:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106b4f:	e8 eb be ff ff       	call   80102a3f <ioapicenable>

  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106b54:	c7 45 f4 6c 8a 10 80 	movl   $0x80108a6c,-0xc(%ebp)
80106b5b:	eb 15                	jmp    80106b72 <uartinit+0xf8>
    uartputc(*p);
...
80106b69:	e8 10 00 00 00       	call   80106b7e <uartputc>
  for(p="xv6...\n"; *p; p++)
80106b6e:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106b72:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b75:	0f b6 00             	movzbl (%eax),%eax
80106b78:	84 c0                	test   %al,%al
80106b7a:	75 e1                	jne    80106b5d <uartinit+0xe3>
}
80106b7c:	c9                   	leave  
80106b7d:	c3                   	ret    
...
80106b81:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
80106b84:	a1 24 b6 10 80       	mov    0x8010b624,%eax
80106b89:	85 c0                	test   %eax,%eax
80106b8b:	75 02                	jne    80106b8f <uartputc+0x11>
    return;
80106b8d:	eb 4b                	jmp    80106bda <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106b8f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106b96:	eb 10                	jmp    80106ba8 <uartputc+0x2a>
    microdelay(10);
80106b98:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80106b9f:	e8 d2 c3 ff ff       	call   80102f76 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106ba4:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106ba8:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
80106bac:	7f 16                	jg     80106bc4 <uartputc+0x46>
80106bae:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106bb5:	e8 85 fe ff ff       	call   80106a3f <inb>
80106bba:	0f b6 c0             	movzbl %al,%eax
80106bbd:	83 e0 20             	and    $0x20,%eax
80106bc0:	85 c0                	test   %eax,%eax
80106bc2:	74 d4                	je     80106b98 <uartputc+0x1a>
  outb(COM1+0, c);
80106bc4:	8b 45 08             	mov    0x8(%ebp),%eax
80106bc7:	0f b6 c0             	movzbl %al,%eax
80106bca:	89 44 24 04          	mov    %eax,0x4(%esp)
80106bce:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106bd5:	e8 82 fe ff ff       	call   80106a5c <outb>
}
80106bda:	c9                   	leave  
80106bdb:	c3                   	ret    
...
80106bdf:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80106be2:	a1 24 b6 10 80       	mov    0x8010b624,%eax
80106be7:	85 c0                	test   %eax,%eax
80106be9:	75 07                	jne    80106bf2 <uartgetc+0x16>
    return -1;
80106beb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106bf0:	eb 2c                	jmp    80106c1e <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80106bf2:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106bf9:	e8 41 fe ff ff       	call   80106a3f <inb>
80106bfe:	0f b6 c0             	movzbl %al,%eax
80106c01:	83 e0 01             	and    $0x1,%eax
80106c04:	85 c0                	test   %eax,%eax
80106c06:	75 07                	jne    80106c0f <uartgetc+0x33>
    return -1;
80106c08:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c0d:	eb 0f                	jmp    80106c1e <uartgetc+0x42>
  return inb(COM1+0);
80106c0f:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106c16:	e8 24 fe ff ff       	call   80106a3f <inb>
...
80106c26:	c7 04 24 dc 6b 10 80 	movl   $0x80106bdc,(%esp)
80106c2d:	e8 b7 9b ff ff       	call   801007e9 <consoleintr>
}
80106c32:	c9                   	leave  
80106c33:	c3                   	ret    
...
80106c36:	6a 00                	push   $0x0
  jmp alltraps
80106c38:	e9 a9 f9 ff ff       	jmp    801065e6 <alltraps>
...
80106c3d:	6a 00                	push   $0x0
  pushl $1
80106c3f:	6a 01                	push   $0x1
  jmp alltraps
80106c41:	e9 a0 f9 ff ff       	jmp    801065e6 <alltraps>
...
80106c46:	6a 00                	push   $0x0
  pushl $2
80106c48:	6a 02                	push   $0x2
  jmp alltraps
80106c4a:	e9 97 f9 ff ff       	jmp    801065e6 <alltraps>
...
80106c4f:	6a 00                	push   $0x0
  pushl $3
80106c51:	6a 03                	push   $0x3
  jmp alltraps
80106c53:	e9 8e f9 ff ff       	jmp    801065e6 <alltraps>
...
80106c5a:	6a 04                	push   $0x4
  jmp alltraps
80106c5c:	e9 85 f9 ff ff       	jmp    801065e6 <alltraps>
...
80106c61:	6a 00                	push   $0x0
  pushl $5
80106c63:	6a 05                	push   $0x5
  jmp alltraps
80106c65:	e9 7c f9 ff ff       	jmp    801065e6 <alltraps>
...
80106c6c:	6a 06                	push   $0x6
  jmp alltraps
80106c6e:	e9 73 f9 ff ff       	jmp    801065e6 <alltraps>
...
80106c73:	6a 00                	push   $0x0
  pushl $7
80106c75:	6a 07                	push   $0x7
  jmp alltraps
80106c77:	e9 6a f9 ff ff       	jmp    801065e6 <alltraps>

80106c7c <vector8>:
.globl vector8
vector8:
  pushl $8
80106c7c:	6a 08                	push   $0x8
  jmp alltraps
80106c7e:	e9 63 f9 ff ff       	jmp    801065e6 <alltraps>
...
80106c83:	6a 00                	push   $0x0
  pushl $9
80106c85:	6a 09                	push   $0x9
  jmp alltraps
80106c87:	e9 5a f9 ff ff       	jmp    801065e6 <alltraps>

80106c8c <vector10>:
.globl vector10
vector10:
  pushl $10
80106c8c:	6a 0a                	push   $0xa
  jmp alltraps
80106c8e:	e9 53 f9 ff ff       	jmp    801065e6 <alltraps>

80106c93 <vector11>:
.globl vector11
vector11:
  pushl $11
80106c93:	6a 0b                	push   $0xb
  jmp alltraps
80106c95:	e9 4c f9 ff ff       	jmp    801065e6 <alltraps>

80106c9a <vector12>:
.globl vector12
vector12:
  pushl $12
80106c9a:	6a 0c                	push   $0xc
  jmp alltraps
80106c9c:	e9 45 f9 ff ff       	jmp    801065e6 <alltraps>

80106ca1 <vector13>:
.globl vector13
vector13:
  pushl $13
80106ca1:	6a 0d                	push   $0xd
  jmp alltraps
80106ca3:	e9 3e f9 ff ff       	jmp    801065e6 <alltraps>

80106ca8 <vector14>:
.globl vector14
vector14:
  pushl $14
80106ca8:	6a 0e                	push   $0xe
  jmp alltraps
80106caa:	e9 37 f9 ff ff       	jmp    801065e6 <alltraps>
...
80106caf:	6a 00                	push   $0x0
  pushl $15
80106cb1:	6a 0f                	push   $0xf
  jmp alltraps
80106cb3:	e9 2e f9 ff ff       	jmp    801065e6 <alltraps>
...
80106cb8:	6a 00                	push   $0x0
  pushl $16
80106cba:	6a 10                	push   $0x10
  jmp alltraps
80106cbc:	e9 25 f9 ff ff       	jmp    801065e6 <alltraps>

80106cc1 <vector17>:
.globl vector17
vector17:
  pushl $17
80106cc1:	6a 11                	push   $0x11
  jmp alltraps
80106cc3:	e9 1e f9 ff ff       	jmp    801065e6 <alltraps>
...
80106cc8:	6a 00                	push   $0x0
  pushl $18
80106cca:	6a 12                	push   $0x12
  jmp alltraps
80106ccc:	e9 15 f9 ff ff       	jmp    801065e6 <alltraps>
...
80106cd1:	6a 00                	push   $0x0
  pushl $19
80106cd3:	6a 13                	push   $0x13
  jmp alltraps
80106cd5:	e9 0c f9 ff ff       	jmp    801065e6 <alltraps>
...
80106cda:	6a 00                	push   $0x0
  pushl $20
80106cdc:	6a 14                	push   $0x14
  jmp alltraps
80106cde:	e9 03 f9 ff ff       	jmp    801065e6 <alltraps>
...
80106ce3:	6a 00                	push   $0x0
  pushl $21
80106ce5:	6a 15                	push   $0x15
  jmp alltraps
80106ce7:	e9 fa f8 ff ff       	jmp    801065e6 <alltraps>
...
80106cec:	6a 00                	push   $0x0
  pushl $22
80106cee:	6a 16                	push   $0x16
  jmp alltraps
80106cf0:	e9 f1 f8 ff ff       	jmp    801065e6 <alltraps>
...
80106cf5:	6a 00                	push   $0x0
  pushl $23
80106cf7:	6a 17                	push   $0x17
  jmp alltraps
80106cf9:	e9 e8 f8 ff ff       	jmp    801065e6 <alltraps>
...
80106cfe:	6a 00                	push   $0x0
  pushl $24
80106d00:	6a 18                	push   $0x18
  jmp alltraps
80106d02:	e9 df f8 ff ff       	jmp    801065e6 <alltraps>
...
80106d07:	6a 00                	push   $0x0
  pushl $25
80106d09:	6a 19                	push   $0x19
  jmp alltraps
80106d0b:	e9 d6 f8 ff ff       	jmp    801065e6 <alltraps>
...
80106d10:	6a 00                	push   $0x0
  pushl $26
80106d12:	6a 1a                	push   $0x1a
  jmp alltraps
80106d14:	e9 cd f8 ff ff       	jmp    801065e6 <alltraps>
...
80106d19:	6a 00                	push   $0x0
  pushl $27
80106d1b:	6a 1b                	push   $0x1b
  jmp alltraps
80106d1d:	e9 c4 f8 ff ff       	jmp    801065e6 <alltraps>
...
80106d22:	6a 00                	push   $0x0
  pushl $28
80106d24:	6a 1c                	push   $0x1c
  jmp alltraps
80106d26:	e9 bb f8 ff ff       	jmp    801065e6 <alltraps>
...
80106d2b:	6a 00                	push   $0x0
  pushl $29
80106d2d:	6a 1d                	push   $0x1d
  jmp alltraps
80106d2f:	e9 b2 f8 ff ff       	jmp    801065e6 <alltraps>
...
80106d34:	6a 00                	push   $0x0
  pushl $30
80106d36:	6a 1e                	push   $0x1e
  jmp alltraps
80106d38:	e9 a9 f8 ff ff       	jmp    801065e6 <alltraps>
...
80106d3d:	6a 00                	push   $0x0
  pushl $31
80106d3f:	6a 1f                	push   $0x1f
  jmp alltraps
80106d41:	e9 a0 f8 ff ff       	jmp    801065e6 <alltraps>
...
80106d46:	6a 00                	push   $0x0
  pushl $32
80106d48:	6a 20                	push   $0x20
  jmp alltraps
80106d4a:	e9 97 f8 ff ff       	jmp    801065e6 <alltraps>
...
80106d4f:	6a 00                	push   $0x0
  pushl $33
80106d51:	6a 21                	push   $0x21
  jmp alltraps
80106d53:	e9 8e f8 ff ff       	jmp    801065e6 <alltraps>
...
80106d58:	6a 00                	push   $0x0
  pushl $34
80106d5a:	6a 22                	push   $0x22
  jmp alltraps
80106d5c:	e9 85 f8 ff ff       	jmp    801065e6 <alltraps>
...
80106d61:	6a 00                	push   $0x0
  pushl $35
80106d63:	6a 23                	push   $0x23
  jmp alltraps
80106d65:	e9 7c f8 ff ff       	jmp    801065e6 <alltraps>
...
80106d6a:	6a 00                	push   $0x0
  pushl $36
80106d6c:	6a 24                	push   $0x24
  jmp alltraps
80106d6e:	e9 73 f8 ff ff       	jmp    801065e6 <alltraps>
...
80106d73:	6a 00                	push   $0x0
  pushl $37
80106d75:	6a 25                	push   $0x25
  jmp alltraps
80106d77:	e9 6a f8 ff ff       	jmp    801065e6 <alltraps>
...
80106d7c:	6a 00                	push   $0x0
  pushl $38
80106d7e:	6a 26                	push   $0x26
  jmp alltraps
80106d80:	e9 61 f8 ff ff       	jmp    801065e6 <alltraps>
...
80106d85:	6a 00                	push   $0x0
  pushl $39
80106d87:	6a 27                	push   $0x27
  jmp alltraps
80106d89:	e9 58 f8 ff ff       	jmp    801065e6 <alltraps>
...
80106d8e:	6a 00                	push   $0x0
  pushl $40
80106d90:	6a 28                	push   $0x28
  jmp alltraps
80106d92:	e9 4f f8 ff ff       	jmp    801065e6 <alltraps>
...
80106d97:	6a 00                	push   $0x0
  pushl $41
80106d99:	6a 29                	push   $0x29
  jmp alltraps
80106d9b:	e9 46 f8 ff ff       	jmp    801065e6 <alltraps>
...
80106da0:	6a 00                	push   $0x0
  pushl $42
80106da2:	6a 2a                	push   $0x2a
  jmp alltraps
80106da4:	e9 3d f8 ff ff       	jmp    801065e6 <alltraps>
...
80106da9:	6a 00                	push   $0x0
  pushl $43
80106dab:	6a 2b                	push   $0x2b
  jmp alltraps
80106dad:	e9 34 f8 ff ff       	jmp    801065e6 <alltraps>
...
80106db2:	6a 00                	push   $0x0
  pushl $44
80106db4:	6a 2c                	push   $0x2c
  jmp alltraps
80106db6:	e9 2b f8 ff ff       	jmp    801065e6 <alltraps>
...
80106dbb:	6a 00                	push   $0x0
  pushl $45
80106dbd:	6a 2d                	push   $0x2d
  jmp alltraps
80106dbf:	e9 22 f8 ff ff       	jmp    801065e6 <alltraps>
...
80106dc4:	6a 00                	push   $0x0
  pushl $46
80106dc6:	6a 2e                	push   $0x2e
  jmp alltraps
80106dc8:	e9 19 f8 ff ff       	jmp    801065e6 <alltraps>
...
80106dcd:	6a 00                	push   $0x0
  pushl $47
80106dcf:	6a 2f                	push   $0x2f
  jmp alltraps
80106dd1:	e9 10 f8 ff ff       	jmp    801065e6 <alltraps>
...
80106dd6:	6a 00                	push   $0x0
  pushl $48
80106dd8:	6a 30                	push   $0x30
  jmp alltraps
80106dda:	e9 07 f8 ff ff       	jmp    801065e6 <alltraps>
...
80106ddf:	6a 00                	push   $0x0
  pushl $49
80106de1:	6a 31                	push   $0x31
  jmp alltraps
80106de3:	e9 fe f7 ff ff       	jmp    801065e6 <alltraps>
...
80106de8:	6a 00                	push   $0x0
  pushl $50
80106dea:	6a 32                	push   $0x32
  jmp alltraps
80106dec:	e9 f5 f7 ff ff       	jmp    801065e6 <alltraps>
...
80106df1:	6a 00                	push   $0x0
  pushl $51
80106df3:	6a 33                	push   $0x33
  jmp alltraps
80106df5:	e9 ec f7 ff ff       	jmp    801065e6 <alltraps>
...
80106dfa:	6a 00                	push   $0x0
  pushl $52
80106dfc:	6a 34                	push   $0x34
  jmp alltraps
80106dfe:	e9 e3 f7 ff ff       	jmp    801065e6 <alltraps>
...
80106e03:	6a 00                	push   $0x0
  pushl $53
80106e05:	6a 35                	push   $0x35
  jmp alltraps
80106e07:	e9 da f7 ff ff       	jmp    801065e6 <alltraps>
...
80106e0c:	6a 00                	push   $0x0
  pushl $54
80106e0e:	6a 36                	push   $0x36
  jmp alltraps
80106e10:	e9 d1 f7 ff ff       	jmp    801065e6 <alltraps>
...
80106e15:	6a 00                	push   $0x0
  pushl $55
80106e17:	6a 37                	push   $0x37
  jmp alltraps
80106e19:	e9 c8 f7 ff ff       	jmp    801065e6 <alltraps>
...
80106e1e:	6a 00                	push   $0x0
  pushl $56
80106e20:	6a 38                	push   $0x38
  jmp alltraps
80106e22:	e9 bf f7 ff ff       	jmp    801065e6 <alltraps>
...
80106e27:	6a 00                	push   $0x0
  pushl $57
80106e29:	6a 39                	push   $0x39
  jmp alltraps
80106e2b:	e9 b6 f7 ff ff       	jmp    801065e6 <alltraps>
...
80106e30:	6a 00                	push   $0x0
  pushl $58
80106e32:	6a 3a                	push   $0x3a
  jmp alltraps
80106e34:	e9 ad f7 ff ff       	jmp    801065e6 <alltraps>
...
80106e39:	6a 00                	push   $0x0
  pushl $59
80106e3b:	6a 3b                	push   $0x3b
  jmp alltraps
80106e3d:	e9 a4 f7 ff ff       	jmp    801065e6 <alltraps>
...
80106e42:	6a 00                	push   $0x0
  pushl $60
80106e44:	6a 3c                	push   $0x3c
  jmp alltraps
80106e46:	e9 9b f7 ff ff       	jmp    801065e6 <alltraps>
...
80106e4b:	6a 00                	push   $0x0
  pushl $61
80106e4d:	6a 3d                	push   $0x3d
  jmp alltraps
80106e4f:	e9 92 f7 ff ff       	jmp    801065e6 <alltraps>
...
80106e54:	6a 00                	push   $0x0
  pushl $62
80106e56:	6a 3e                	push   $0x3e
  jmp alltraps
80106e58:	e9 89 f7 ff ff       	jmp    801065e6 <alltraps>
...
80106e5d:	6a 00                	push   $0x0
  pushl $63
80106e5f:	6a 3f                	push   $0x3f
  jmp alltraps
80106e61:	e9 80 f7 ff ff       	jmp    801065e6 <alltraps>
...
80106e66:	6a 00                	push   $0x0
  pushl $64
80106e68:	6a 40                	push   $0x40
  jmp alltraps
80106e6a:	e9 77 f7 ff ff       	jmp    801065e6 <alltraps>
...
80106e6f:	6a 00                	push   $0x0
  pushl $65
80106e71:	6a 41                	push   $0x41
  jmp alltraps
80106e73:	e9 6e f7 ff ff       	jmp    801065e6 <alltraps>
...
80106e78:	6a 00                	push   $0x0
  pushl $66
80106e7a:	6a 42                	push   $0x42
  jmp alltraps
80106e7c:	e9 65 f7 ff ff       	jmp    801065e6 <alltraps>
...
80106e81:	6a 00                	push   $0x0
  pushl $67
80106e83:	6a 43                	push   $0x43
  jmp alltraps
80106e85:	e9 5c f7 ff ff       	jmp    801065e6 <alltraps>
...
80106e8a:	6a 00                	push   $0x0
  pushl $68
80106e8c:	6a 44                	push   $0x44
  jmp alltraps
80106e8e:	e9 53 f7 ff ff       	jmp    801065e6 <alltraps>
...
80106e93:	6a 00                	push   $0x0
  pushl $69
80106e95:	6a 45                	push   $0x45
  jmp alltraps
80106e97:	e9 4a f7 ff ff       	jmp    801065e6 <alltraps>
...
80106e9c:	6a 00                	push   $0x0
  pushl $70
80106e9e:	6a 46                	push   $0x46
  jmp alltraps
80106ea0:	e9 41 f7 ff ff       	jmp    801065e6 <alltraps>
...
80106ea5:	6a 00                	push   $0x0
  pushl $71
80106ea7:	6a 47                	push   $0x47
  jmp alltraps
80106ea9:	e9 38 f7 ff ff       	jmp    801065e6 <alltraps>
...
80106eae:	6a 00                	push   $0x0
  pushl $72
80106eb0:	6a 48                	push   $0x48
  jmp alltraps
80106eb2:	e9 2f f7 ff ff       	jmp    801065e6 <alltraps>
...
80106eb7:	6a 00                	push   $0x0
  pushl $73
80106eb9:	6a 49                	push   $0x49
  jmp alltraps
80106ebb:	e9 26 f7 ff ff       	jmp    801065e6 <alltraps>
...
80106ec0:	6a 00                	push   $0x0
  pushl $74
80106ec2:	6a 4a                	push   $0x4a
  jmp alltraps
80106ec4:	e9 1d f7 ff ff       	jmp    801065e6 <alltraps>
...
80106ec9:	6a 00                	push   $0x0
  pushl $75
80106ecb:	6a 4b                	push   $0x4b
  jmp alltraps
80106ecd:	e9 14 f7 ff ff       	jmp    801065e6 <alltraps>
...
80106ed2:	6a 00                	push   $0x0
  pushl $76
80106ed4:	6a 4c                	push   $0x4c
  jmp alltraps
80106ed6:	e9 0b f7 ff ff       	jmp    801065e6 <alltraps>
...
80106edb:	6a 00                	push   $0x0
  pushl $77
80106edd:	6a 4d                	push   $0x4d
  jmp alltraps
80106edf:	e9 02 f7 ff ff       	jmp    801065e6 <alltraps>
...
80106ee4:	6a 00                	push   $0x0
  pushl $78
80106ee6:	6a 4e                	push   $0x4e
  jmp alltraps
80106ee8:	e9 f9 f6 ff ff       	jmp    801065e6 <alltraps>
...
80106eed:	6a 00                	push   $0x0
  pushl $79
80106eef:	6a 4f                	push   $0x4f
  jmp alltraps
80106ef1:	e9 f0 f6 ff ff       	jmp    801065e6 <alltraps>
...
80106ef6:	6a 00                	push   $0x0
  pushl $80
80106ef8:	6a 50                	push   $0x50
  jmp alltraps
80106efa:	e9 e7 f6 ff ff       	jmp    801065e6 <alltraps>
...
80106eff:	6a 00                	push   $0x0
  pushl $81
80106f01:	6a 51                	push   $0x51
  jmp alltraps
80106f03:	e9 de f6 ff ff       	jmp    801065e6 <alltraps>
...
80106f08:	6a 00                	push   $0x0
  pushl $82
80106f0a:	6a 52                	push   $0x52
  jmp alltraps
80106f0c:	e9 d5 f6 ff ff       	jmp    801065e6 <alltraps>
...
80106f11:	6a 00                	push   $0x0
  pushl $83
80106f13:	6a 53                	push   $0x53
  jmp alltraps
80106f15:	e9 cc f6 ff ff       	jmp    801065e6 <alltraps>
...
80106f1a:	6a 00                	push   $0x0
  pushl $84
80106f1c:	6a 54                	push   $0x54
  jmp alltraps
80106f1e:	e9 c3 f6 ff ff       	jmp    801065e6 <alltraps>
...
80106f23:	6a 00                	push   $0x0
  pushl $85
80106f25:	6a 55                	push   $0x55
  jmp alltraps
80106f27:	e9 ba f6 ff ff       	jmp    801065e6 <alltraps>
...
80106f2c:	6a 00                	push   $0x0
  pushl $86
80106f2e:	6a 56                	push   $0x56
  jmp alltraps
80106f30:	e9 b1 f6 ff ff       	jmp    801065e6 <alltraps>
...
80106f35:	6a 00                	push   $0x0
  pushl $87
80106f37:	6a 57                	push   $0x57
  jmp alltraps
80106f39:	e9 a8 f6 ff ff       	jmp    801065e6 <alltraps>
...
80106f3e:	6a 00                	push   $0x0
  pushl $88
80106f40:	6a 58                	push   $0x58
  jmp alltraps
80106f42:	e9 9f f6 ff ff       	jmp    801065e6 <alltraps>
...
80106f47:	6a 00                	push   $0x0
  pushl $89
80106f49:	6a 59                	push   $0x59
  jmp alltraps
80106f4b:	e9 96 f6 ff ff       	jmp    801065e6 <alltraps>
...
80106f50:	6a 00                	push   $0x0
  pushl $90
80106f52:	6a 5a                	push   $0x5a
  jmp alltraps
80106f54:	e9 8d f6 ff ff       	jmp    801065e6 <alltraps>
...
80106f59:	6a 00                	push   $0x0
  pushl $91
80106f5b:	6a 5b                	push   $0x5b
  jmp alltraps
80106f5d:	e9 84 f6 ff ff       	jmp    801065e6 <alltraps>
...
80106f62:	6a 00                	push   $0x0
  pushl $92
80106f64:	6a 5c                	push   $0x5c
  jmp alltraps
80106f66:	e9 7b f6 ff ff       	jmp    801065e6 <alltraps>
...
80106f6b:	6a 00                	push   $0x0
  pushl $93
80106f6d:	6a 5d                	push   $0x5d
  jmp alltraps
80106f6f:	e9 72 f6 ff ff       	jmp    801065e6 <alltraps>
...
80106f74:	6a 00                	push   $0x0
  pushl $94
80106f76:	6a 5e                	push   $0x5e
  jmp alltraps
80106f78:	e9 69 f6 ff ff       	jmp    801065e6 <alltraps>
...
80106f7d:	6a 00                	push   $0x0
  pushl $95
80106f7f:	6a 5f                	push   $0x5f
  jmp alltraps
80106f81:	e9 60 f6 ff ff       	jmp    801065e6 <alltraps>
...
80106f86:	6a 00                	push   $0x0
  pushl $96
80106f88:	6a 60                	push   $0x60
  jmp alltraps
80106f8a:	e9 57 f6 ff ff       	jmp    801065e6 <alltraps>
...
80106f8f:	6a 00                	push   $0x0
  pushl $97
80106f91:	6a 61                	push   $0x61
  jmp alltraps
80106f93:	e9 4e f6 ff ff       	jmp    801065e6 <alltraps>
...
80106f98:	6a 00                	push   $0x0
  pushl $98
80106f9a:	6a 62                	push   $0x62
  jmp alltraps
80106f9c:	e9 45 f6 ff ff       	jmp    801065e6 <alltraps>
...
80106fa1:	6a 00                	push   $0x0
  pushl $99
80106fa3:	6a 63                	push   $0x63
  jmp alltraps
80106fa5:	e9 3c f6 ff ff       	jmp    801065e6 <alltraps>
...
80106faa:	6a 00                	push   $0x0
  pushl $100
80106fac:	6a 64                	push   $0x64
  jmp alltraps
80106fae:	e9 33 f6 ff ff       	jmp    801065e6 <alltraps>
...
80106fb3:	6a 00                	push   $0x0
  pushl $101
80106fb5:	6a 65                	push   $0x65
  jmp alltraps
80106fb7:	e9 2a f6 ff ff       	jmp    801065e6 <alltraps>
...
80106fbc:	6a 00                	push   $0x0
  pushl $102
80106fbe:	6a 66                	push   $0x66
  jmp alltraps
80106fc0:	e9 21 f6 ff ff       	jmp    801065e6 <alltraps>
...
80106fc5:	6a 00                	push   $0x0
  pushl $103
80106fc7:	6a 67                	push   $0x67
  jmp alltraps
80106fc9:	e9 18 f6 ff ff       	jmp    801065e6 <alltraps>
...
80106fce:	6a 00                	push   $0x0
  pushl $104
80106fd0:	6a 68                	push   $0x68
  jmp alltraps
80106fd2:	e9 0f f6 ff ff       	jmp    801065e6 <alltraps>
...
80106fd7:	6a 00                	push   $0x0
  pushl $105
80106fd9:	6a 69                	push   $0x69
  jmp alltraps
80106fdb:	e9 06 f6 ff ff       	jmp    801065e6 <alltraps>
...
80106fe0:	6a 00                	push   $0x0
  pushl $106
80106fe2:	6a 6a                	push   $0x6a
  jmp alltraps
80106fe4:	e9 fd f5 ff ff       	jmp    801065e6 <alltraps>
...
80106fe9:	6a 00                	push   $0x0
  pushl $107
80106feb:	6a 6b                	push   $0x6b
  jmp alltraps
80106fed:	e9 f4 f5 ff ff       	jmp    801065e6 <alltraps>
...
80106ff2:	6a 00                	push   $0x0
  pushl $108
80106ff4:	6a 6c                	push   $0x6c
  jmp alltraps
80106ff6:	e9 eb f5 ff ff       	jmp    801065e6 <alltraps>
...
80106ffb:	6a 00                	push   $0x0
  pushl $109
80106ffd:	6a 6d                	push   $0x6d
  jmp alltraps
80106fff:	e9 e2 f5 ff ff       	jmp    801065e6 <alltraps>
...
80107004:	6a 00                	push   $0x0
  pushl $110
80107006:	6a 6e                	push   $0x6e
  jmp alltraps
80107008:	e9 d9 f5 ff ff       	jmp    801065e6 <alltraps>
...
8010700d:	6a 00                	push   $0x0
  pushl $111
8010700f:	6a 6f                	push   $0x6f
  jmp alltraps
80107011:	e9 d0 f5 ff ff       	jmp    801065e6 <alltraps>
...
80107016:	6a 00                	push   $0x0
  pushl $112
80107018:	6a 70                	push   $0x70
  jmp alltraps
8010701a:	e9 c7 f5 ff ff       	jmp    801065e6 <alltraps>
...
8010701f:	6a 00                	push   $0x0
  pushl $113
80107021:	6a 71                	push   $0x71
  jmp alltraps
80107023:	e9 be f5 ff ff       	jmp    801065e6 <alltraps>
...
80107028:	6a 00                	push   $0x0
  pushl $114
8010702a:	6a 72                	push   $0x72
  jmp alltraps
8010702c:	e9 b5 f5 ff ff       	jmp    801065e6 <alltraps>
...
80107031:	6a 00                	push   $0x0
  pushl $115
80107033:	6a 73                	push   $0x73
  jmp alltraps
80107035:	e9 ac f5 ff ff       	jmp    801065e6 <alltraps>
...
8010703a:	6a 00                	push   $0x0
  pushl $116
8010703c:	6a 74                	push   $0x74
  jmp alltraps
8010703e:	e9 a3 f5 ff ff       	jmp    801065e6 <alltraps>
...
80107043:	6a 00                	push   $0x0
  pushl $117
80107045:	6a 75                	push   $0x75
  jmp alltraps
80107047:	e9 9a f5 ff ff       	jmp    801065e6 <alltraps>
...
8010704c:	6a 00                	push   $0x0
  pushl $118
8010704e:	6a 76                	push   $0x76
  jmp alltraps
80107050:	e9 91 f5 ff ff       	jmp    801065e6 <alltraps>
...
80107055:	6a 00                	push   $0x0
  pushl $119
80107057:	6a 77                	push   $0x77
  jmp alltraps
80107059:	e9 88 f5 ff ff       	jmp    801065e6 <alltraps>
...
8010705e:	6a 00                	push   $0x0
  pushl $120
80107060:	6a 78                	push   $0x78
  jmp alltraps
80107062:	e9 7f f5 ff ff       	jmp    801065e6 <alltraps>
...
80107067:	6a 00                	push   $0x0
  pushl $121
80107069:	6a 79                	push   $0x79
  jmp alltraps
8010706b:	e9 76 f5 ff ff       	jmp    801065e6 <alltraps>
...
80107070:	6a 00                	push   $0x0
  pushl $122
80107072:	6a 7a                	push   $0x7a
  jmp alltraps
80107074:	e9 6d f5 ff ff       	jmp    801065e6 <alltraps>
...
80107079:	6a 00                	push   $0x0
  pushl $123
8010707b:	6a 7b                	push   $0x7b
  jmp alltraps
8010707d:	e9 64 f5 ff ff       	jmp    801065e6 <alltraps>
...
80107082:	6a 00                	push   $0x0
  pushl $124
80107084:	6a 7c                	push   $0x7c
  jmp alltraps
80107086:	e9 5b f5 ff ff       	jmp    801065e6 <alltraps>
...
8010708b:	6a 00                	push   $0x0
  pushl $125
8010708d:	6a 7d                	push   $0x7d
  jmp alltraps
8010708f:	e9 52 f5 ff ff       	jmp    801065e6 <alltraps>
...
80107094:	6a 00                	push   $0x0
  pushl $126
80107096:	6a 7e                	push   $0x7e
  jmp alltraps
80107098:	e9 49 f5 ff ff       	jmp    801065e6 <alltraps>
...
8010709d:	6a 00                	push   $0x0
  pushl $127
8010709f:	6a 7f                	push   $0x7f
  jmp alltraps
801070a1:	e9 40 f5 ff ff       	jmp    801065e6 <alltraps>
...
801070a6:	6a 00                	push   $0x0
  pushl $128
801070a8:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801070ad:	e9 34 f5 ff ff       	jmp    801065e6 <alltraps>
...
801070b2:	6a 00                	push   $0x0
  pushl $129
801070b4:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801070b9:	e9 28 f5 ff ff       	jmp    801065e6 <alltraps>
...
801070be:	6a 00                	push   $0x0
  pushl $130
801070c0:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801070c5:	e9 1c f5 ff ff       	jmp    801065e6 <alltraps>
...
801070ca:	6a 00                	push   $0x0
  pushl $131
801070cc:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801070d1:	e9 10 f5 ff ff       	jmp    801065e6 <alltraps>
...
801070d6:	6a 00                	push   $0x0
  pushl $132
801070d8:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801070dd:	e9 04 f5 ff ff       	jmp    801065e6 <alltraps>
...
801070e2:	6a 00                	push   $0x0
  pushl $133
801070e4:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801070e9:	e9 f8 f4 ff ff       	jmp    801065e6 <alltraps>
...
801070ee:	6a 00                	push   $0x0
  pushl $134
801070f0:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801070f5:	e9 ec f4 ff ff       	jmp    801065e6 <alltraps>
...
801070fa:	6a 00                	push   $0x0
  pushl $135
801070fc:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80107101:	e9 e0 f4 ff ff       	jmp    801065e6 <alltraps>
...
80107106:	6a 00                	push   $0x0
  pushl $136
80107108:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010710d:	e9 d4 f4 ff ff       	jmp    801065e6 <alltraps>
...
80107112:	6a 00                	push   $0x0
  pushl $137
80107114:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80107119:	e9 c8 f4 ff ff       	jmp    801065e6 <alltraps>
...
8010711e:	6a 00                	push   $0x0
  pushl $138
80107120:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80107125:	e9 bc f4 ff ff       	jmp    801065e6 <alltraps>
...
8010712a:	6a 00                	push   $0x0
  pushl $139
8010712c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80107131:	e9 b0 f4 ff ff       	jmp    801065e6 <alltraps>
...
80107136:	6a 00                	push   $0x0
  pushl $140
80107138:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010713d:	e9 a4 f4 ff ff       	jmp    801065e6 <alltraps>
...
80107142:	6a 00                	push   $0x0
  pushl $141
80107144:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80107149:	e9 98 f4 ff ff       	jmp    801065e6 <alltraps>
...
8010714e:	6a 00                	push   $0x0
  pushl $142
80107150:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80107155:	e9 8c f4 ff ff       	jmp    801065e6 <alltraps>
...
8010715a:	6a 00                	push   $0x0
  pushl $143
8010715c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80107161:	e9 80 f4 ff ff       	jmp    801065e6 <alltraps>
...
80107166:	6a 00                	push   $0x0
  pushl $144
80107168:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010716d:	e9 74 f4 ff ff       	jmp    801065e6 <alltraps>
...
80107172:	6a 00                	push   $0x0
  pushl $145
80107174:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80107179:	e9 68 f4 ff ff       	jmp    801065e6 <alltraps>
...
8010717e:	6a 00                	push   $0x0
  pushl $146
80107180:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80107185:	e9 5c f4 ff ff       	jmp    801065e6 <alltraps>
...
8010718a:	6a 00                	push   $0x0
  pushl $147
8010718c:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80107191:	e9 50 f4 ff ff       	jmp    801065e6 <alltraps>
...
80107196:	6a 00                	push   $0x0
  pushl $148
80107198:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010719d:	e9 44 f4 ff ff       	jmp    801065e6 <alltraps>
...
801071a2:	6a 00                	push   $0x0
  pushl $149
801071a4:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801071a9:	e9 38 f4 ff ff       	jmp    801065e6 <alltraps>
...
801071ae:	6a 00                	push   $0x0
  pushl $150
801071b0:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801071b5:	e9 2c f4 ff ff       	jmp    801065e6 <alltraps>
...
801071ba:	6a 00                	push   $0x0
  pushl $151
801071bc:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801071c1:	e9 20 f4 ff ff       	jmp    801065e6 <alltraps>
...
801071c6:	6a 00                	push   $0x0
  pushl $152
801071c8:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801071cd:	e9 14 f4 ff ff       	jmp    801065e6 <alltraps>
...
801071d2:	6a 00                	push   $0x0
  pushl $153
801071d4:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801071d9:	e9 08 f4 ff ff       	jmp    801065e6 <alltraps>
...
801071de:	6a 00                	push   $0x0
  pushl $154
801071e0:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801071e5:	e9 fc f3 ff ff       	jmp    801065e6 <alltraps>
...
801071ea:	6a 00                	push   $0x0
  pushl $155
801071ec:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801071f1:	e9 f0 f3 ff ff       	jmp    801065e6 <alltraps>
...
801071f6:	6a 00                	push   $0x0
  pushl $156
801071f8:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801071fd:	e9 e4 f3 ff ff       	jmp    801065e6 <alltraps>
...
80107202:	6a 00                	push   $0x0
  pushl $157
80107204:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107209:	e9 d8 f3 ff ff       	jmp    801065e6 <alltraps>
...
8010720e:	6a 00                	push   $0x0
  pushl $158
80107210:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80107215:	e9 cc f3 ff ff       	jmp    801065e6 <alltraps>
...
8010721a:	6a 00                	push   $0x0
  pushl $159
8010721c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107221:	e9 c0 f3 ff ff       	jmp    801065e6 <alltraps>
...
80107226:	6a 00                	push   $0x0
  pushl $160
80107228:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010722d:	e9 b4 f3 ff ff       	jmp    801065e6 <alltraps>
...
80107232:	6a 00                	push   $0x0
  pushl $161
80107234:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107239:	e9 a8 f3 ff ff       	jmp    801065e6 <alltraps>
...
8010723e:	6a 00                	push   $0x0
  pushl $162
80107240:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107245:	e9 9c f3 ff ff       	jmp    801065e6 <alltraps>
...
8010724a:	6a 00                	push   $0x0
  pushl $163
8010724c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107251:	e9 90 f3 ff ff       	jmp    801065e6 <alltraps>
...
80107256:	6a 00                	push   $0x0
  pushl $164
80107258:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010725d:	e9 84 f3 ff ff       	jmp    801065e6 <alltraps>
...
80107262:	6a 00                	push   $0x0
  pushl $165
80107264:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80107269:	e9 78 f3 ff ff       	jmp    801065e6 <alltraps>
...
8010726e:	6a 00                	push   $0x0
  pushl $166
80107270:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80107275:	e9 6c f3 ff ff       	jmp    801065e6 <alltraps>
...
8010727a:	6a 00                	push   $0x0
  pushl $167
8010727c:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107281:	e9 60 f3 ff ff       	jmp    801065e6 <alltraps>
...
80107286:	6a 00                	push   $0x0
  pushl $168
80107288:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010728d:	e9 54 f3 ff ff       	jmp    801065e6 <alltraps>
...
80107292:	6a 00                	push   $0x0
  pushl $169
80107294:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80107299:	e9 48 f3 ff ff       	jmp    801065e6 <alltraps>
...
8010729e:	6a 00                	push   $0x0
  pushl $170
801072a0:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801072a5:	e9 3c f3 ff ff       	jmp    801065e6 <alltraps>
...
801072aa:	6a 00                	push   $0x0
  pushl $171
801072ac:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801072b1:	e9 30 f3 ff ff       	jmp    801065e6 <alltraps>
...
801072b6:	6a 00                	push   $0x0
  pushl $172
801072b8:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801072bd:	e9 24 f3 ff ff       	jmp    801065e6 <alltraps>
...
801072c2:	6a 00                	push   $0x0
  pushl $173
801072c4:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801072c9:	e9 18 f3 ff ff       	jmp    801065e6 <alltraps>
...
801072ce:	6a 00                	push   $0x0
  pushl $174
801072d0:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801072d5:	e9 0c f3 ff ff       	jmp    801065e6 <alltraps>
...
801072da:	6a 00                	push   $0x0
  pushl $175
801072dc:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801072e1:	e9 00 f3 ff ff       	jmp    801065e6 <alltraps>
...
801072e6:	6a 00                	push   $0x0
  pushl $176
801072e8:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801072ed:	e9 f4 f2 ff ff       	jmp    801065e6 <alltraps>
...
801072f2:	6a 00                	push   $0x0
  pushl $177
801072f4:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801072f9:	e9 e8 f2 ff ff       	jmp    801065e6 <alltraps>
...
801072fe:	6a 00                	push   $0x0
  pushl $178
80107300:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107305:	e9 dc f2 ff ff       	jmp    801065e6 <alltraps>
...
8010730a:	6a 00                	push   $0x0
  pushl $179
8010730c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107311:	e9 d0 f2 ff ff       	jmp    801065e6 <alltraps>
...
80107316:	6a 00                	push   $0x0
  pushl $180
80107318:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010731d:	e9 c4 f2 ff ff       	jmp    801065e6 <alltraps>
...
80107322:	6a 00                	push   $0x0
  pushl $181
80107324:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107329:	e9 b8 f2 ff ff       	jmp    801065e6 <alltraps>
...
8010732e:	6a 00                	push   $0x0
  pushl $182
80107330:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107335:	e9 ac f2 ff ff       	jmp    801065e6 <alltraps>
...
8010733a:	6a 00                	push   $0x0
  pushl $183
8010733c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107341:	e9 a0 f2 ff ff       	jmp    801065e6 <alltraps>
...
80107346:	6a 00                	push   $0x0
  pushl $184
80107348:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010734d:	e9 94 f2 ff ff       	jmp    801065e6 <alltraps>
...
80107352:	6a 00                	push   $0x0
  pushl $185
80107354:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107359:	e9 88 f2 ff ff       	jmp    801065e6 <alltraps>
...
8010735e:	6a 00                	push   $0x0
  pushl $186
80107360:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80107365:	e9 7c f2 ff ff       	jmp    801065e6 <alltraps>
...
8010736a:	6a 00                	push   $0x0
  pushl $187
8010736c:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107371:	e9 70 f2 ff ff       	jmp    801065e6 <alltraps>
...
80107376:	6a 00                	push   $0x0
  pushl $188
80107378:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010737d:	e9 64 f2 ff ff       	jmp    801065e6 <alltraps>
...
80107382:	6a 00                	push   $0x0
  pushl $189
80107384:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80107389:	e9 58 f2 ff ff       	jmp    801065e6 <alltraps>
...
8010738e:	6a 00                	push   $0x0
  pushl $190
80107390:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80107395:	e9 4c f2 ff ff       	jmp    801065e6 <alltraps>
...
8010739a:	6a 00                	push   $0x0
  pushl $191
8010739c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801073a1:	e9 40 f2 ff ff       	jmp    801065e6 <alltraps>
...
801073a6:	6a 00                	push   $0x0
  pushl $192
801073a8:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801073ad:	e9 34 f2 ff ff       	jmp    801065e6 <alltraps>
...
801073b2:	6a 00                	push   $0x0
  pushl $193
801073b4:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801073b9:	e9 28 f2 ff ff       	jmp    801065e6 <alltraps>
...
801073be:	6a 00                	push   $0x0
  pushl $194
801073c0:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801073c5:	e9 1c f2 ff ff       	jmp    801065e6 <alltraps>
...
801073ca:	6a 00                	push   $0x0
  pushl $195
801073cc:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801073d1:	e9 10 f2 ff ff       	jmp    801065e6 <alltraps>
...
801073d6:	6a 00                	push   $0x0
  pushl $196
801073d8:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801073dd:	e9 04 f2 ff ff       	jmp    801065e6 <alltraps>
...
801073e2:	6a 00                	push   $0x0
  pushl $197
801073e4:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801073e9:	e9 f8 f1 ff ff       	jmp    801065e6 <alltraps>
...
801073ee:	6a 00                	push   $0x0
  pushl $198
801073f0:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801073f5:	e9 ec f1 ff ff       	jmp    801065e6 <alltraps>
...
801073fa:	6a 00                	push   $0x0
  pushl $199
801073fc:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107401:	e9 e0 f1 ff ff       	jmp    801065e6 <alltraps>
...
80107406:	6a 00                	push   $0x0
  pushl $200
80107408:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010740d:	e9 d4 f1 ff ff       	jmp    801065e6 <alltraps>
...
80107412:	6a 00                	push   $0x0
  pushl $201
80107414:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107419:	e9 c8 f1 ff ff       	jmp    801065e6 <alltraps>
...
8010741e:	6a 00                	push   $0x0
  pushl $202
80107420:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107425:	e9 bc f1 ff ff       	jmp    801065e6 <alltraps>
...
8010742a:	6a 00                	push   $0x0
  pushl $203
8010742c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107431:	e9 b0 f1 ff ff       	jmp    801065e6 <alltraps>
...
80107436:	6a 00                	push   $0x0
  pushl $204
80107438:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010743d:	e9 a4 f1 ff ff       	jmp    801065e6 <alltraps>
...
80107442:	6a 00                	push   $0x0
  pushl $205
80107444:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107449:	e9 98 f1 ff ff       	jmp    801065e6 <alltraps>
...
8010744e:	6a 00                	push   $0x0
  pushl $206
80107450:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107455:	e9 8c f1 ff ff       	jmp    801065e6 <alltraps>
...
8010745a:	6a 00                	push   $0x0
  pushl $207
8010745c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107461:	e9 80 f1 ff ff       	jmp    801065e6 <alltraps>
...
80107466:	6a 00                	push   $0x0
  pushl $208
80107468:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010746d:	e9 74 f1 ff ff       	jmp    801065e6 <alltraps>
...
80107472:	6a 00                	push   $0x0
  pushl $209
80107474:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107479:	e9 68 f1 ff ff       	jmp    801065e6 <alltraps>
...
8010747e:	6a 00                	push   $0x0
  pushl $210
80107480:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107485:	e9 5c f1 ff ff       	jmp    801065e6 <alltraps>
...
8010748a:	6a 00                	push   $0x0
  pushl $211
8010748c:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107491:	e9 50 f1 ff ff       	jmp    801065e6 <alltraps>
...
80107496:	6a 00                	push   $0x0
  pushl $212
80107498:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010749d:	e9 44 f1 ff ff       	jmp    801065e6 <alltraps>
...
801074a2:	6a 00                	push   $0x0
  pushl $213
801074a4:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801074a9:	e9 38 f1 ff ff       	jmp    801065e6 <alltraps>
...
801074ae:	6a 00                	push   $0x0
  pushl $214
801074b0:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801074b5:	e9 2c f1 ff ff       	jmp    801065e6 <alltraps>
...
801074ba:	6a 00                	push   $0x0
  pushl $215
801074bc:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801074c1:	e9 20 f1 ff ff       	jmp    801065e6 <alltraps>
...
801074c6:	6a 00                	push   $0x0
  pushl $216
801074c8:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801074cd:	e9 14 f1 ff ff       	jmp    801065e6 <alltraps>
...
801074d2:	6a 00                	push   $0x0
  pushl $217
801074d4:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801074d9:	e9 08 f1 ff ff       	jmp    801065e6 <alltraps>
...
801074de:	6a 00                	push   $0x0
  pushl $218
801074e0:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801074e5:	e9 fc f0 ff ff       	jmp    801065e6 <alltraps>
...
801074ea:	6a 00                	push   $0x0
  pushl $219
801074ec:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801074f1:	e9 f0 f0 ff ff       	jmp    801065e6 <alltraps>
...
801074f6:	6a 00                	push   $0x0
  pushl $220
801074f8:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801074fd:	e9 e4 f0 ff ff       	jmp    801065e6 <alltraps>
...
80107502:	6a 00                	push   $0x0
  pushl $221
80107504:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107509:	e9 d8 f0 ff ff       	jmp    801065e6 <alltraps>
...
8010750e:	6a 00                	push   $0x0
  pushl $222
80107510:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107515:	e9 cc f0 ff ff       	jmp    801065e6 <alltraps>
...
8010751a:	6a 00                	push   $0x0
  pushl $223
8010751c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107521:	e9 c0 f0 ff ff       	jmp    801065e6 <alltraps>
...
80107526:	6a 00                	push   $0x0
  pushl $224
80107528:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010752d:	e9 b4 f0 ff ff       	jmp    801065e6 <alltraps>
...
80107532:	6a 00                	push   $0x0
  pushl $225
80107534:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107539:	e9 a8 f0 ff ff       	jmp    801065e6 <alltraps>
...
8010753e:	6a 00                	push   $0x0
  pushl $226
80107540:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107545:	e9 9c f0 ff ff       	jmp    801065e6 <alltraps>
...
8010754a:	6a 00                	push   $0x0
  pushl $227
8010754c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107551:	e9 90 f0 ff ff       	jmp    801065e6 <alltraps>
...
80107556:	6a 00                	push   $0x0
  pushl $228
80107558:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010755d:	e9 84 f0 ff ff       	jmp    801065e6 <alltraps>
...
80107562:	6a 00                	push   $0x0
  pushl $229
80107564:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107569:	e9 78 f0 ff ff       	jmp    801065e6 <alltraps>
...
8010756e:	6a 00                	push   $0x0
  pushl $230
80107570:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107575:	e9 6c f0 ff ff       	jmp    801065e6 <alltraps>
...
8010757a:	6a 00                	push   $0x0
  pushl $231
8010757c:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107581:	e9 60 f0 ff ff       	jmp    801065e6 <alltraps>
...
80107586:	6a 00                	push   $0x0
  pushl $232
80107588:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010758d:	e9 54 f0 ff ff       	jmp    801065e6 <alltraps>
...
80107592:	6a 00                	push   $0x0
  pushl $233
80107594:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107599:	e9 48 f0 ff ff       	jmp    801065e6 <alltraps>
...
8010759e:	6a 00                	push   $0x0
  pushl $234
801075a0:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801075a5:	e9 3c f0 ff ff       	jmp    801065e6 <alltraps>
...
801075aa:	6a 00                	push   $0x0
  pushl $235
801075ac:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801075b1:	e9 30 f0 ff ff       	jmp    801065e6 <alltraps>
...
801075b6:	6a 00                	push   $0x0
  pushl $236
801075b8:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801075bd:	e9 24 f0 ff ff       	jmp    801065e6 <alltraps>
...
801075c2:	6a 00                	push   $0x0
  pushl $237
801075c4:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801075c9:	e9 18 f0 ff ff       	jmp    801065e6 <alltraps>
...
801075ce:	6a 00                	push   $0x0
  pushl $238
801075d0:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801075d5:	e9 0c f0 ff ff       	jmp    801065e6 <alltraps>
...
801075da:	6a 00                	push   $0x0
  pushl $239
801075dc:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801075e1:	e9 00 f0 ff ff       	jmp    801065e6 <alltraps>
...
801075e6:	6a 00                	push   $0x0
  pushl $240
801075e8:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801075ed:	e9 f4 ef ff ff       	jmp    801065e6 <alltraps>
...
801075f2:	6a 00                	push   $0x0
  pushl $241
801075f4:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801075f9:	e9 e8 ef ff ff       	jmp    801065e6 <alltraps>
...
801075fe:	6a 00                	push   $0x0
  pushl $242
80107600:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107605:	e9 dc ef ff ff       	jmp    801065e6 <alltraps>
...
8010760a:	6a 00                	push   $0x0
  pushl $243
8010760c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107611:	e9 d0 ef ff ff       	jmp    801065e6 <alltraps>
...
80107616:	6a 00                	push   $0x0
  pushl $244
80107618:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010761d:	e9 c4 ef ff ff       	jmp    801065e6 <alltraps>
...
80107622:	6a 00                	push   $0x0
  pushl $245
80107624:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107629:	e9 b8 ef ff ff       	jmp    801065e6 <alltraps>
...
8010762e:	6a 00                	push   $0x0
  pushl $246
80107630:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107635:	e9 ac ef ff ff       	jmp    801065e6 <alltraps>
...
8010763a:	6a 00                	push   $0x0
  pushl $247
8010763c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107641:	e9 a0 ef ff ff       	jmp    801065e6 <alltraps>
...
80107646:	6a 00                	push   $0x0
  pushl $248
80107648:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010764d:	e9 94 ef ff ff       	jmp    801065e6 <alltraps>
...
80107652:	6a 00                	push   $0x0
  pushl $249
80107654:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107659:	e9 88 ef ff ff       	jmp    801065e6 <alltraps>
...
8010765e:	6a 00                	push   $0x0
  pushl $250
80107660:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107665:	e9 7c ef ff ff       	jmp    801065e6 <alltraps>
...
8010766a:	6a 00                	push   $0x0
  pushl $251
8010766c:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107671:	e9 70 ef ff ff       	jmp    801065e6 <alltraps>
...
80107676:	6a 00                	push   $0x0
  pushl $252
80107678:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010767d:	e9 64 ef ff ff       	jmp    801065e6 <alltraps>
...
80107682:	6a 00                	push   $0x0
  pushl $253
80107684:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107689:	e9 58 ef ff ff       	jmp    801065e6 <alltraps>
...
8010768e:	6a 00                	push   $0x0
  pushl $254
80107690:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107695:	e9 4c ef ff ff       	jmp    801065e6 <alltraps>
...
8010769a:	6a 00                	push   $0x0
  pushl $255
8010769c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801076a1:	e9 40 ef ff ff       	jmp    801065e6 <alltraps>
...
801076af:	83 e8 01             	sub    $0x1,%eax
801076b2:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801076b6:	8b 45 08             	mov    0x8(%ebp),%eax
801076b9:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
801076bd:	8b 45 08             	mov    0x8(%ebp),%eax
801076c0:	c1 e8 10             	shr    $0x10,%eax
801076c3:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
801076c7:	8d 45 fa             	lea    -0x6(%ebp),%eax
801076ca:	0f 01 10             	lgdtl  (%eax)
}
801076cd:	c9                   	leave  
801076ce:	c3                   	ret    
...
801076d2:	83 ec 04             	sub    $0x4,%esp
801076d5:	8b 45 08             	mov    0x8(%ebp),%eax
801076d8:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
801076dc:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
801076e0:	0f 00 d8             	ltr    %ax
}
801076e3:	c9                   	leave  
801076e4:	c3                   	ret    
...
801076f3:	83 ec 28             	sub    $0x28,%esp
  ...
  c = &cpus[cpuid()];
801076f6:	e8 cf c9 ff ff       	call   801040ca <cpuid>
801076fb:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80107701:	05 00 38 11 80       	add    $0x80113800,%eax
80107706:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80107709:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010770c:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80107712:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107715:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
8010771b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010771e:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80107722:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107725:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107729:	83 e2 f0             	and    $0xfffffff0,%edx
8010772c:	83 ca 0a             	or     $0xa,%edx
8010772f:	88 50 7d             	mov    %dl,0x7d(%eax)
80107732:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107735:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107739:	83 ca 10             	or     $0x10,%edx
8010773c:	88 50 7d             	mov    %dl,0x7d(%eax)
8010773f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107742:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107746:	83 e2 9f             	and    $0xffffff9f,%edx
80107749:	88 50 7d             	mov    %dl,0x7d(%eax)
8010774c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010774f:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107753:	83 ca 80             	or     $0xffffff80,%edx
80107756:	88 50 7d             	mov    %dl,0x7d(%eax)
80107759:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010775c:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107760:	83 ca 0f             	or     $0xf,%edx
80107763:	88 50 7e             	mov    %dl,0x7e(%eax)
80107766:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107769:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
8010776d:	83 e2 ef             	and    $0xffffffef,%edx
80107770:	88 50 7e             	mov    %dl,0x7e(%eax)
80107773:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107776:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
8010777a:	83 e2 df             	and    $0xffffffdf,%edx
8010777d:	88 50 7e             	mov    %dl,0x7e(%eax)
80107780:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107783:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107787:	83 ca 40             	or     $0x40,%edx
8010778a:	88 50 7e             	mov    %dl,0x7e(%eax)
...
8010779d:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801077a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077a4:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
801077ab:	ff ff 
801077ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077b0:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
801077b7:	00 00 
801077b9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077bc:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
801077c3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077c6:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
801077cd:	83 e2 f0             	and    $0xfffffff0,%edx
801077d0:	83 ca 02             	or     $0x2,%edx
801077d3:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
801077d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077dc:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
801077e3:	83 ca 10             	or     $0x10,%edx
...
80107815:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
8010781c:	83 ca 0f             	or     $0xf,%edx
8010781f:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107825:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107828:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
8010782f:	83 e2 ef             	and    $0xffffffef,%edx
...
80107842:	83 e2 df             	and    $0xffffffdf,%edx
...
80107874:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010787b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010787e:	66 c7 80 88 00 00 00 	movw   $0xffff,0x88(%eax)
80107885:	ff ff 
80107887:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010788a:	66 c7 80 8a 00 00 00 	movw   $0x0,0x8a(%eax)
80107891:	00 00 
80107893:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107896:	c6 80 8c 00 00 00 00 	movb   $0x0,0x8c(%eax)
8010789d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078a0:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801078a7:	83 e2 f0             	and    $0xfffffff0,%edx
801078aa:	83 ca 0a             	or     $0xa,%edx
801078ad:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
801078b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078b6:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801078bd:	83 ca 10             	or     $0x10,%edx
801078c0:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
801078c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078c9:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801078d0:	83 ca 60             	or     $0x60,%edx
801078d3:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
801078d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078dc:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801078e3:	83 ca 80             	or     $0xffffff80,%edx
801078e6:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
801078ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078ef:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
801078f6:	83 ca 0f             	or     $0xf,%edx
801078f9:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
801078ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107902:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
80107909:	83 e2 ef             	and    $0xffffffef,%edx
8010790c:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
80107912:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107915:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
8010791c:	83 e2 df             	and    $0xffffffdf,%edx
8010791f:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
80107925:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107928:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
8010792f:	83 ca 40             	or     $0x40,%edx
80107932:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
80107938:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010793b:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
80107942:	83 ca 80             	or     $0xffffff80,%edx
80107945:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
8010794b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010794e:	c6 80 8f 00 00 00 00 	movb   $0x0,0x8f(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80107955:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107958:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
8010795f:	ff ff 
80107961:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107964:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
8010796b:	00 00 
8010796d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107970:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
80107977:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010797a:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107981:	83 e2 f0             	and    $0xfffffff0,%edx
80107984:	83 ca 02             	or     $0x2,%edx
80107987:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
8010798d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107990:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107997:	83 ca 10             	or     $0x10,%edx
8010799a:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
801079a0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079a3:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
801079aa:	83 ca 60             	or     $0x60,%edx
801079ad:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
801079b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079b6:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
801079bd:	83 ca 80             	or     $0xffffff80,%edx
801079c0:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
801079c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079c9:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
801079d0:	83 ca 0f             	or     $0xf,%edx
801079d3:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
801079d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079dc:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
801079e3:	83 e2 ef             	and    $0xffffffef,%edx
801079e6:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
801079ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079ef:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
801079f6:	83 e2 df             	and    $0xffffffdf,%edx
801079f9:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
801079ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a02:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107a09:	83 ca 40             	or     $0x40,%edx
80107a0c:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107a12:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a15:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107a1c:	83 ca 80             	or     $0xffffff80,%edx
80107a1f:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107a25:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a28:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
80107a2f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a32:	83 c0 70             	add    $0x70,%eax
80107a35:	c7 44 24 04 30 00 00 	movl   $0x30,0x4(%esp)
80107a3c:	00 
80107a3d:	89 04 24             	mov    %eax,(%esp)
80107a40:	e8 61 fc ff ff       	call   801076a6 <lgdt>
}
80107a45:	c9                   	leave  
80107a46:	c3                   	ret    
...
80107a4a:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80107a4d:	8b 45 0c             	mov    0xc(%ebp),%eax
80107a50:	c1 e8 16             	shr    $0x16,%eax
80107a53:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80107a5a:	8b 45 08             	mov    0x8(%ebp),%eax
80107a5d:	01 d0                	add    %edx,%eax
80107a5f:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
80107a62:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107a65:	8b 00                	mov    (%eax),%eax
80107a67:	83 e0 01             	and    $0x1,%eax
80107a6a:	85 c0                	test   %eax,%eax
80107a6c:	74 14                	je     80107a82 <walkpgdir+0x3b>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107a6e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107a71:	8b 00                	mov    (%eax),%eax
80107a73:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107a78:	05 00 00 00 80       	add    $0x80000000,%eax
80107a7d:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107a80:	eb 48                	jmp    80107aca <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107a82:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80107a86:	74 0e                	je     80107a96 <walkpgdir+0x4f>
80107a88:	e8 1c b1 ff ff       	call   80102ba9 <kalloc>
80107a8d:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107a90:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107a94:	75 07                	jne    80107a9d <walkpgdir+0x56>
      return 0;
80107a96:	b8 00 00 00 00       	mov    $0x0,%eax
80107a9b:	eb 44                	jmp    80107ae1 <walkpgdir+0x9a>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80107a9d:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107aa4:	00 
80107aa5:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107aac:	00 
80107aad:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ab0:	89 04 24             	mov    %eax,(%esp)
80107ab3:	e8 67 d7 ff ff       	call   8010521f <memset>
...
80107ac0:	83 c8 07             	or     $0x7,%eax
80107ac3:	89 c2                	mov    %eax,%edx
80107ac5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107ac8:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80107aca:	8b 45 0c             	mov    0xc(%ebp),%eax
80107acd:	c1 e8 0c             	shr    $0xc,%eax
80107ad0:	25 ff 03 00 00       	and    $0x3ff,%eax
80107ad5:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
80107aec:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107af1:	89 45 f4             	mov    %eax,-0xc(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80107af4:	8b 55 0c             	mov    0xc(%ebp),%edx
80107af7:	8b 45 10             	mov    0x10(%ebp),%eax
80107afa:	01 d0                	add    %edx,%eax
80107afc:	83 e8 01             	sub    $0x1,%eax
80107aff:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107b04:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80107b07:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80107b0e:	00 
80107b0f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b12:	89 44 24 04          	mov    %eax,0x4(%esp)
80107b16:	8b 45 08             	mov    0x8(%ebp),%eax
80107b19:	89 04 24             	mov    %eax,(%esp)
80107b1c:	e8 26 ff ff ff       	call   80107a47 <walkpgdir>
80107b21:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107b24:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107b28:	75 07                	jne    80107b31 <mappages+0x4e>
      return -1;
80107b2a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107b2f:	eb 48                	jmp    80107b79 <mappages+0x96>
    if(*pte & PTE_P)
80107b31:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107b34:	8b 00                	mov    (%eax),%eax
80107b36:	83 e0 01             	and    $0x1,%eax
80107b39:	85 c0                	test   %eax,%eax
80107b3b:	74 0c                	je     80107b49 <mappages+0x66>
      panic("remap");
80107b3d:	c7 04 24 74 8a 10 80 	movl   $0x80108a74,(%esp)
80107b44:	e8 19 8a ff ff       	call   80100562 <panic>
    *pte = pa | perm | PTE_P;
80107b49:	8b 45 18             	mov    0x18(%ebp),%eax
80107b4c:	0b 45 14             	or     0x14(%ebp),%eax
80107b4f:	83 c8 01             	or     $0x1,%eax
80107b52:	89 c2                	mov    %eax,%edx
80107b54:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107b57:	89 10                	mov    %edx,(%eax)
    if(a == last)
80107b59:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b5c:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107b5f:	75 08                	jne    80107b69 <mappages+0x86>
      break;
80107b61:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
...
80107b7e:	53                   	push   %ebx
80107b7f:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107b82:	e8 22 b0 ff ff       	call   80102ba9 <kalloc>
80107b87:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107b8a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107b8e:	75 0a                	jne    80107b9a <setupkvm+0x1f>
    return 0;
80107b90:	b8 00 00 00 00       	mov    $0x0,%eax
80107b95:	e9 84 00 00 00       	jmp    80107c1e <setupkvm+0xa3>
...
80107bb0:	e8 6a d6 ff ff       	call   8010521f <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107bb5:	c7 45 f4 80 b4 10 80 	movl   $0x8010b480,-0xc(%ebp)
80107bbc:	eb 54                	jmp    80107c12 <setupkvm+0x97>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80107bbe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bc1:	8b 48 0c             	mov    0xc(%eax),%ecx
80107bc4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bc7:	8b 50 04             	mov    0x4(%eax),%edx
80107bca:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bcd:	8b 58 08             	mov    0x8(%eax),%ebx
80107bd0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bd3:	8b 40 04             	mov    0x4(%eax),%eax
80107bd6:	29 c3                	sub    %eax,%ebx
80107bd8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bdb:	8b 00                	mov    (%eax),%eax
80107bdd:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80107be1:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107be5:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107be9:	89 44 24 04          	mov    %eax,0x4(%esp)
80107bed:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107bf0:	89 04 24             	mov    %eax,(%esp)
80107bf3:	e8 eb fe ff ff       	call   80107ae3 <mappages>
80107bf8:	85 c0                	test   %eax,%eax
80107bfa:	79 12                	jns    80107c0e <setupkvm+0x93>
                (uint)k->phys_start, k->perm) < 0) {
      freevm(pgdir);
80107bfc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107bff:	89 04 24             	mov    %eax,(%esp)
80107c02:	e8 26 05 00 00       	call   8010812d <freevm>
      return 0;
80107c07:	b8 00 00 00 00       	mov    $0x0,%eax
80107c0c:	eb 10                	jmp    80107c1e <setupkvm+0xa3>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107c0e:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107c12:	81 7d f4 c0 b4 10 80 	cmpl   $0x8010b4c0,-0xc(%ebp)
80107c19:	72 a3                	jb     80107bbe <setupkvm+0x43>
    }
  return pgdir;
80107c1b:	8b 45 f0             	mov    -0x10(%ebp),%eax
}
80107c1e:	83 c4 34             	add    $0x34,%esp
80107c21:	5b                   	pop    %ebx
80107c22:	5d                   	pop    %ebp
80107c23:	c3                   	ret    
...
80107c27:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107c2a:	e8 4c ff ff ff       	call   80107b7b <setupkvm>
80107c2f:	a3 24 67 11 80       	mov    %eax,0x80116724
  switchkvm();
80107c34:	e8 02 00 00 00       	call   80107c3b <switchkvm>
}
80107c39:	c9                   	leave  
80107c3a:	c3                   	ret    
...
80107c41:	a1 24 67 11 80       	mov    0x80116724,%eax
80107c46:	05 00 00 00 80       	add    $0x80000000,%eax
80107c4b:	89 04 24             	mov    %eax,(%esp)
80107c4e:	e8 92 fa ff ff       	call   801076e5 <lcr3>
}
80107c53:	c9                   	leave  
80107c54:	c3                   	ret    
...
80107c5a:	53                   	push   %ebx
80107c5b:	83 ec 1c             	sub    $0x1c,%esp
  if(p == 0)
80107c5e:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80107c62:	75 0c                	jne    80107c70 <switchuvm+0x1b>
    panic("switchuvm: no process");
80107c64:	c7 04 24 7a 8a 10 80 	movl   $0x80108a7a,(%esp)
80107c6b:	e8 f2 88 ff ff       	call   80100562 <panic>
  if(p->kstack == 0)
80107c70:	8b 45 08             	mov    0x8(%ebp),%eax
80107c73:	8b 40 08             	mov    0x8(%eax),%eax
80107c76:	85 c0                	test   %eax,%eax
80107c78:	75 0c                	jne    80107c86 <switchuvm+0x31>
    panic("switchuvm: no kstack");
80107c7a:	c7 04 24 90 8a 10 80 	movl   $0x80108a90,(%esp)
80107c81:	e8 dc 88 ff ff       	call   80100562 <panic>
  if(p->pgdir == 0)
80107c86:	8b 45 08             	mov    0x8(%ebp),%eax
80107c89:	8b 40 04             	mov    0x4(%eax),%eax
80107c8c:	85 c0                	test   %eax,%eax
80107c8e:	75 0c                	jne    80107c9c <switchuvm+0x47>
    panic("switchuvm: no pgdir");
80107c90:	c7 04 24 a5 8a 10 80 	movl   $0x80108aa5,(%esp)
80107c97:	e8 c6 88 ff ff       	call   80100562 <panic>

  pushcli();
80107c9c:	e8 79 d4 ff ff       	call   8010511a <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80107ca1:	e8 45 c4 ff ff       	call   801040eb <mycpu>
80107ca6:	89 c3                	mov    %eax,%ebx
80107ca8:	e8 3e c4 ff ff       	call   801040eb <mycpu>
80107cad:	83 c0 08             	add    $0x8,%eax
80107cb0:	89 c7                	mov    %eax,%edi
80107cb2:	e8 34 c4 ff ff       	call   801040eb <mycpu>
80107cb7:	83 c0 08             	add    $0x8,%eax
80107cba:	c1 e8 10             	shr    $0x10,%eax
80107cbd:	89 c6                	mov    %eax,%esi
80107cbf:	e8 27 c4 ff ff       	call   801040eb <mycpu>
80107cc4:	83 c0 08             	add    $0x8,%eax
80107cc7:	c1 e8 18             	shr    $0x18,%eax
80107cca:	66 c7 83 98 00 00 00 	movw   $0x67,0x98(%ebx)
80107cd1:	67 00 
80107cd3:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80107cda:	89 f1                	mov    %esi,%ecx
80107cdc:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80107ce2:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107ce9:	83 e2 f0             	and    $0xfffffff0,%edx
80107cec:	83 ca 09             	or     $0x9,%edx
80107cef:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107cf5:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107cfc:	83 ca 10             	or     $0x10,%edx
80107cff:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107d05:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107d0c:	83 e2 9f             	and    $0xffffff9f,%edx
80107d0f:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107d15:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107d1c:	83 ca 80             	or     $0xffffff80,%edx
80107d1f:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107d25:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107d2c:	83 e2 f0             	and    $0xfffffff0,%edx
80107d2f:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107d35:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107d3c:	83 e2 ef             	and    $0xffffffef,%edx
80107d3f:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107d45:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107d4c:	83 e2 df             	and    $0xffffffdf,%edx
80107d4f:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107d55:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107d5c:	83 ca 40             	or     $0x40,%edx
80107d5f:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107d65:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107d6c:	83 e2 7f             	and    $0x7f,%edx
80107d6f:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107d75:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80107d7b:	e8 6b c3 ff ff       	call   801040eb <mycpu>
80107d80:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107d87:	83 e2 ef             	and    $0xffffffef,%edx
80107d8a:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80107d90:	e8 56 c3 ff ff       	call   801040eb <mycpu>
80107d95:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80107d9b:	e8 4b c3 ff ff       	call   801040eb <mycpu>
80107da0:	8b 55 08             	mov    0x8(%ebp),%edx
80107da3:	8b 52 08             	mov    0x8(%edx),%edx
80107da6:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107dac:	89 50 0c             	mov    %edx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80107daf:	e8 37 c3 ff ff       	call   801040eb <mycpu>
80107db4:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
  ltr(SEG_TSS << 3);
80107dba:	c7 04 24 28 00 00 00 	movl   $0x28,(%esp)
80107dc1:	e8 09 f9 ff ff       	call   801076cf <ltr>
...
80107dd4:	e8 0c f9 ff ff       	call   801076e5 <lcr3>
  popcli();
80107dd9:	e8 88 d3 ff ff       	call   80105166 <popcli>
}
80107dde:	83 c4 1c             	add    $0x1c,%esp
80107de1:	5b                   	pop    %ebx
80107de2:	5e                   	pop    %esi
80107de3:	5f                   	pop    %edi
80107de4:	5d                   	pop    %ebp
...
80107de9:	83 ec 38             	sub    $0x38,%esp
  char *mem;

  if(sz >= PGSIZE)
80107dec:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80107df3:	76 0c                	jbe    80107e01 <inituvm+0x1b>
    panic("inituvm: more than a page");
80107df5:	c7 04 24 b9 8a 10 80 	movl   $0x80108ab9,(%esp)
80107dfc:	e8 61 87 ff ff       	call   80100562 <panic>
  mem = kalloc();
80107e01:	e8 a3 ad ff ff       	call   80102ba9 <kalloc>
80107e06:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
80107e09:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107e10:	00 
80107e11:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107e18:	00 
80107e19:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e1c:	89 04 24             	mov    %eax,(%esp)
80107e1f:	e8 fb d3 ff ff       	call   8010521f <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80107e24:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e27:	05 00 00 00 80       	add    $0x80000000,%eax
80107e2c:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107e33:	00 
80107e34:	89 44 24 0c          	mov    %eax,0xc(%esp)
80107e38:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107e3f:	00 
80107e40:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107e47:	00 
80107e48:	8b 45 08             	mov    0x8(%ebp),%eax
80107e4b:	89 04 24             	mov    %eax,(%esp)
80107e4e:	e8 90 fc ff ff       	call   80107ae3 <mappages>
  memmove(mem, init, sz);
80107e53:	8b 45 10             	mov    0x10(%ebp),%eax
80107e56:	89 44 24 08          	mov    %eax,0x8(%esp)
80107e5a:	8b 45 0c             	mov    0xc(%ebp),%eax
80107e5d:	89 44 24 04          	mov    %eax,0x4(%esp)
80107e61:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e64:	89 04 24             	mov    %eax,(%esp)
80107e67:	e8 82 d4 ff ff       	call   801052ee <memmove>
}
80107e6c:	c9                   	leave  
80107e6d:	c3                   	ret    
...
80107e71:	83 ec 28             	sub    $0x28,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
80107e74:	8b 45 0c             	mov    0xc(%ebp),%eax
80107e77:	25 ff 0f 00 00       	and    $0xfff,%eax
80107e7c:	85 c0                	test   %eax,%eax
80107e7e:	74 0c                	je     80107e8c <loaduvm+0x1e>
    panic("loaduvm: addr must be page aligned");
80107e80:	c7 04 24 d4 8a 10 80 	movl   $0x80108ad4,(%esp)
80107e87:	e8 d6 86 ff ff       	call   80100562 <panic>
  for(i = 0; i < sz; i += PGSIZE){
80107e8c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107e93:	e9 a6 00 00 00       	jmp    80107f3e <loaduvm+0xd0>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107e98:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e9b:	8b 55 0c             	mov    0xc(%ebp),%edx
80107e9e:	01 d0                	add    %edx,%eax
80107ea0:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107ea7:	00 
80107ea8:	89 44 24 04          	mov    %eax,0x4(%esp)
80107eac:	8b 45 08             	mov    0x8(%ebp),%eax
80107eaf:	89 04 24             	mov    %eax,(%esp)
80107eb2:	e8 90 fb ff ff       	call   80107a47 <walkpgdir>
80107eb7:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107eba:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107ebe:	75 0c                	jne    80107ecc <loaduvm+0x5e>
      panic("loaduvm: address should exist");
80107ec0:	c7 04 24 f7 8a 10 80 	movl   $0x80108af7,(%esp)
80107ec7:	e8 96 86 ff ff       	call   80100562 <panic>
    pa = PTE_ADDR(*pte);
...
80107edc:	8b 55 18             	mov    0x18(%ebp),%edx
80107edf:	29 c2                	sub    %eax,%edx
80107ee1:	89 d0                	mov    %edx,%eax
80107ee3:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80107ee8:	77 0f                	ja     80107ef9 <loaduvm+0x8b>
      n = sz - i;
80107eea:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107eed:	8b 55 18             	mov    0x18(%ebp),%edx
80107ef0:	29 c2                	sub    %eax,%edx
80107ef2:	89 d0                	mov    %edx,%eax
80107ef4:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107ef7:	eb 07                	jmp    80107f00 <loaduvm+0x92>
    else
      n = PGSIZE;
80107ef9:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80107f00:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f03:	8b 55 14             	mov    0x14(%ebp),%edx
80107f06:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
80107f09:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107f0c:	05 00 00 00 80       	add    $0x80000000,%eax
80107f11:	8b 55 f0             	mov    -0x10(%ebp),%edx
80107f14:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107f18:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80107f1c:	89 44 24 04          	mov    %eax,0x4(%esp)
80107f20:	8b 45 10             	mov    0x10(%ebp),%eax
80107f23:	89 04 24             	mov    %eax,(%esp)
80107f26:	e8 cf 9e ff ff       	call   80101dfa <readi>
80107f2b:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107f2e:	74 07                	je     80107f37 <loaduvm+0xc9>
      return -1;
80107f30:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107f35:	eb 18                	jmp    80107f4f <loaduvm+0xe1>
  for(i = 0; i < sz; i += PGSIZE){
80107f37:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80107f3e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f41:	3b 45 18             	cmp    0x18(%ebp),%eax
80107f44:	0f 82 4e ff ff ff    	jb     80107e98 <loaduvm+0x2a>
  }
  return 0;
80107f4a:	b8 00 00 00 00       	mov    $0x0,%eax
}
80107f4f:	c9                   	leave  
80107f50:	c3                   	ret    
...
80107f5c:	79 0a                	jns    80107f68 <allocuvm+0x17>
    return 0;
80107f5e:	b8 00 00 00 00       	mov    $0x0,%eax
80107f63:	e9 fd 00 00 00       	jmp    80108065 <allocuvm+0x114>
  if(newsz < oldsz)
80107f68:	8b 45 10             	mov    0x10(%ebp),%eax
80107f6b:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107f6e:	73 08                	jae    80107f78 <allocuvm+0x27>
    return oldsz;
80107f70:	8b 45 0c             	mov    0xc(%ebp),%eax
80107f73:	e9 ed 00 00 00       	jmp    80108065 <allocuvm+0x114>

  a = PGROUNDUP(oldsz);
80107f78:	8b 45 0c             	mov    0xc(%ebp),%eax
80107f7b:	05 ff 0f 00 00       	add    $0xfff,%eax
80107f80:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107f85:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
80107f88:	e9 c9 00 00 00       	jmp    80108056 <allocuvm+0x105>
    mem = kalloc();
80107f8d:	e8 17 ac ff ff       	call   80102ba9 <kalloc>
80107f92:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80107f95:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107f99:	75 2f                	jne    80107fca <allocuvm+0x79>
      cprintf("allocuvm out of memory\n");
80107f9b:	c7 04 24 15 8b 10 80 	movl   $0x80108b15,(%esp)
80107fa2:	e8 21 84 ff ff       	call   801003c8 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80107fa7:	8b 45 0c             	mov    0xc(%ebp),%eax
80107faa:	89 44 24 08          	mov    %eax,0x8(%esp)
80107fae:	8b 45 10             	mov    0x10(%ebp),%eax
80107fb1:	89 44 24 04          	mov    %eax,0x4(%esp)
80107fb5:	8b 45 08             	mov    0x8(%ebp),%eax
80107fb8:	89 04 24             	mov    %eax,(%esp)
80107fbb:	e8 a7 00 00 00       	call   80108067 <deallocuvm>
      return 0;
80107fc0:	b8 00 00 00 00       	mov    $0x0,%eax
80107fc5:	e9 9b 00 00 00       	jmp    80108065 <allocuvm+0x114>
    }
    memset(mem, 0, PGSIZE);
...
80107fe0:	e8 3a d2 ff ff       	call   8010521f <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80107fe5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107fe8:	8d 90 00 00 00 80    	lea    -0x80000000(%eax),%edx
80107fee:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ff1:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107ff8:	00 
80107ff9:	89 54 24 0c          	mov    %edx,0xc(%esp)
...
8010800f:	e8 cf fa ff ff       	call   80107ae3 <mappages>
80108014:	85 c0                	test   %eax,%eax
80108016:	79 37                	jns    8010804f <allocuvm+0xfe>
      cprintf("allocuvm out of memory (2)\n");
80108018:	c7 04 24 2d 8b 10 80 	movl   $0x80108b2d,(%esp)
...
80108038:	e8 2a 00 00 00       	call   80108067 <deallocuvm>
      kfree(mem);
8010803d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108040:	89 04 24             	mov    %eax,(%esp)
80108043:	e8 cb aa ff ff       	call   80102b13 <kfree>
      return 0;
80108048:	b8 00 00 00 00       	mov    $0x0,%eax
8010804d:	eb 16                	jmp    80108065 <allocuvm+0x114>
  for(; a < newsz; a += PGSIZE){
8010804f:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108056:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108059:	3b 45 10             	cmp    0x10(%ebp),%eax
8010805c:	0f 82 2b ff ff ff    	jb     80107f8d <allocuvm+0x3c>
    }
  }
  return newsz;
...
8010806a:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
8010806d:	8b 45 10             	mov    0x10(%ebp),%eax
80108070:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108073:	72 08                	jb     8010807d <deallocuvm+0x16>
    return oldsz;
80108075:	8b 45 0c             	mov    0xc(%ebp),%eax
80108078:	e9 ae 00 00 00       	jmp    8010812b <deallocuvm+0xc4>

  a = PGROUNDUP(newsz);
8010807d:	8b 45 10             	mov    0x10(%ebp),%eax
80108080:	05 ff 0f 00 00       	add    $0xfff,%eax
80108085:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010808a:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
8010808d:	e9 8a 00 00 00       	jmp    8010811c <deallocuvm+0xb5>
    pte = walkpgdir(pgdir, (char*)a, 0);
80108092:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108095:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010809c:	00 
8010809d:	89 44 24 04          	mov    %eax,0x4(%esp)
801080a1:	8b 45 08             	mov    0x8(%ebp),%eax
801080a4:	89 04 24             	mov    %eax,(%esp)
801080a7:	e8 9b f9 ff ff       	call   80107a47 <walkpgdir>
801080ac:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
801080af:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801080b3:	75 16                	jne    801080cb <deallocuvm+0x64>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
801080b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080b8:	c1 e8 16             	shr    $0x16,%eax
801080bb:	83 c0 01             	add    $0x1,%eax
801080be:	c1 e0 16             	shl    $0x16,%eax
801080c1:	2d 00 10 00 00       	sub    $0x1000,%eax
801080c6:	89 45 f4             	mov    %eax,-0xc(%ebp)
801080c9:	eb 4a                	jmp    80108115 <deallocuvm+0xae>
    else if((*pte & PTE_P) != 0){
801080cb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801080ce:	8b 00                	mov    (%eax),%eax
801080d0:	83 e0 01             	and    $0x1,%eax
801080d3:	85 c0                	test   %eax,%eax
801080d5:	74 3e                	je     80108115 <deallocuvm+0xae>
      pa = PTE_ADDR(*pte);
...
801080e8:	75 0c                	jne    801080f6 <deallocuvm+0x8f>
        panic("kfree");
801080ea:	c7 04 24 49 8b 10 80 	movl   $0x80108b49,(%esp)
801080f1:	e8 6c 84 ff ff       	call   80100562 <panic>
      char *v = P2V(pa);
...
80108130:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
80108133:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80108137:	75 0c                	jne    80108145 <freevm+0x18>
    panic("freevm: no pgdir");
80108139:	c7 04 24 4f 8b 10 80 	movl   $0x80108b4f,(%esp)
80108140:	e8 1d 84 ff ff       	call   80100562 <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80108145:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010814c:	00 
8010814d:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80108154:	80 
80108155:	8b 45 08             	mov    0x8(%ebp),%eax
80108158:	89 04 24             	mov    %eax,(%esp)
8010815b:	e8 07 ff ff ff       	call   80108067 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80108160:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108167:	eb 45                	jmp    801081ae <freevm+0x81>
    if(pgdir[i] & PTE_P){
...
8010817f:	74 29                	je     801081aa <freevm+0x7d>
...
8010819c:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
8010819f:	8b 45 f0             	mov    -0x10(%ebp),%eax
801081a2:	89 04 24             	mov    %eax,(%esp)
801081a5:	e8 69 a9 ff ff       	call   80102b13 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
801081aa:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801081ae:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
801081b5:	76 b2                	jbe    80108169 <freevm+0x3c>
    }
  }
  kfree((char*)pgdir);
801081b7:	8b 45 08             	mov    0x8(%ebp),%eax
801081ba:	89 04 24             	mov    %eax,(%esp)
801081bd:	e8 51 a9 ff ff       	call   80102b13 <kfree>
}
801081c2:	c9                   	leave  
801081c3:	c3                   	ret    
...
801081c7:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
801081ca:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801081d1:	00 
...
801081df:	e8 63 f8 ff ff       	call   80107a47 <walkpgdir>
801081e4:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
801081e7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801081eb:	75 0c                	jne    801081f9 <clearpteu+0x35>
    panic("clearpteu");
801081ed:	c7 04 24 60 8b 10 80 	movl   $0x80108b60,(%esp)
801081f4:	e8 69 83 ff ff       	call   80100562 <panic>
  *pte &= ~PTE_U;
801081f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081fc:	8b 00                	mov    (%eax),%eax
801081fe:	83 e0 fb             	and    $0xfffffffb,%eax
80108201:	89 c2                	mov    %eax,%edx
80108203:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108206:	89 10                	mov    %edx,(%eax)
}
80108208:	c9                   	leave  
80108209:	c3                   	ret    
...
8010820d:	83 ec 48             	sub    $0x48,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108210:	e8 66 f9 ff ff       	call   80107b7b <setupkvm>
...
80108223:	e9 03 01 00 00       	jmp    8010832b <copyuvm+0x121>
  for(i = 0; i < sz; i += PGSIZE){
80108228:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010822f:	e9 d6 00 00 00       	jmp    8010830a <copyuvm+0x100>
...
80108249:	e8 f9 f7 ff ff       	call   80107a47 <walkpgdir>
8010824e:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108251:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108255:	75 0c                	jne    80108263 <copyuvm+0x59>
      panic("copyuvm: pte should exist");
80108257:	c7 04 24 6a 8b 10 80 	movl   $0x80108b6a,(%esp)
8010825e:	e8 ff 82 ff ff       	call   80100562 <panic>
    if(!(*pte & PTE_P))
80108263:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108266:	8b 00                	mov    (%eax),%eax
80108268:	83 e0 01             	and    $0x1,%eax
8010826b:	85 c0                	test   %eax,%eax
8010826d:	75 0c                	jne    8010827b <copyuvm+0x71>
      panic("copyuvm: page not present");
8010826f:	c7 04 24 84 8b 10 80 	movl   $0x80108b84,(%esp)
80108276:	e8 e7 82 ff ff       	call   80100562 <panic>
    pa = PTE_ADDR(*pte);
8010827b:	8b 45 ec             	mov    -0x14(%ebp),%eax
...
8010828d:	25 ff 0f 00 00       	and    $0xfff,%eax
80108292:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80108295:	e8 0f a9 ff ff       	call   80102ba9 <kalloc>
8010829a:	89 45 e0             	mov    %eax,-0x20(%ebp)
8010829d:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801082a1:	75 02                	jne    801082a5 <copyuvm+0x9b>
      goto bad;
801082a3:	eb 76                	jmp    8010831b <copyuvm+0x111>
    memmove(mem, (char*)P2V(pa), PGSIZE);
801082a5:	8b 45 e8             	mov    -0x18(%ebp),%eax
801082a8:	05 00 00 00 80       	add    $0x80000000,%eax
801082ad:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801082b4:	00 
801082b5:	89 44 24 04          	mov    %eax,0x4(%esp)
801082b9:	8b 45 e0             	mov    -0x20(%ebp),%eax
801082bc:	89 04 24             	mov    %eax,(%esp)
801082bf:	e8 2a d0 ff ff       	call   801052ee <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
801082c4:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801082c7:	8b 45 e0             	mov    -0x20(%ebp),%eax
801082ca:	8d 88 00 00 00 80    	lea    -0x80000000(%eax),%ecx
801082d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082d3:	89 54 24 10          	mov    %edx,0x10(%esp)
801082d7:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
...
801082ed:	e8 f1 f7 ff ff       	call   80107ae3 <mappages>
801082f2:	85 c0                	test   %eax,%eax
801082f4:	79 0d                	jns    80108303 <copyuvm+0xf9>
      kfree(mem);
801082f6:	8b 45 e0             	mov    -0x20(%ebp),%eax
801082f9:	89 04 24             	mov    %eax,(%esp)
801082fc:	e8 12 a8 ff ff       	call   80102b13 <kfree>
      goto bad;
80108301:	eb 18                	jmp    8010831b <copyuvm+0x111>
  for(i = 0; i < sz; i += PGSIZE){
80108303:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
8010830a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010830d:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108310:	0f 82 1e ff ff ff    	jb     80108234 <copyuvm+0x2a>
    }
  }
  return d;
80108316:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108319:	eb 10                	jmp    8010832b <copyuvm+0x121>

bad:
  freevm(d);
8010831b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010831e:	89 04 24             	mov    %eax,(%esp)
80108321:	e8 07 fe ff ff       	call   8010812d <freevm>
  return 0;
...
80108330:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80108333:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010833a:	00 
...
80108348:	e8 fa f6 ff ff       	call   80107a47 <walkpgdir>
...
8010835a:	75 07                	jne    80108363 <uva2ka+0x36>
    return 0;
8010835c:	b8 00 00 00 00       	mov    $0x0,%eax
80108361:	eb 22                	jmp    80108385 <uva2ka+0x58>
  if((*pte & PTE_U) == 0)
80108363:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108366:	8b 00                	mov    (%eax),%eax
80108368:	83 e0 04             	and    $0x4,%eax
8010836b:	85 c0                	test   %eax,%eax
8010836d:	75 07                	jne    80108376 <uva2ka+0x49>
    return 0;
8010836f:	b8 00 00 00 00       	mov    $0x0,%eax
80108374:	eb 0f                	jmp    80108385 <uva2ka+0x58>
...
8010838a:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;
...
80108390:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108393:	e9 87 00 00 00       	jmp    8010841f <copyout+0x98>
...
801083b0:	e8 78 ff ff ff       	call   8010832d <uva2ka>
801083b5:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
801083b8:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
801083bc:	75 07                	jne    801083c5 <copyout+0x3e>
      return -1;
801083be:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801083c3:	eb 69                	jmp    8010842e <copyout+0xa7>
    n = PGSIZE - (va - va0);
801083c5:	8b 45 0c             	mov    0xc(%ebp),%eax
801083c8:	8b 55 ec             	mov    -0x14(%ebp),%edx
801083cb:	29 c2                	sub    %eax,%edx
801083cd:	89 d0                	mov    %edx,%eax
801083cf:	05 00 10 00 00       	add    $0x1000,%eax
801083d4:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
801083d7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801083da:	3b 45 14             	cmp    0x14(%ebp),%eax
801083dd:	76 06                	jbe    801083e5 <copyout+0x5e>
      n = len;
801083df:	8b 45 14             	mov    0x14(%ebp),%eax
801083e2:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
801083e5:	8b 45 ec             	mov    -0x14(%ebp),%eax
801083e8:	8b 55 0c             	mov    0xc(%ebp),%edx
801083eb:	29 c2                	sub    %eax,%edx
801083ed:	8b 45 e8             	mov    -0x18(%ebp),%eax
801083f0:	01 c2                	add    %eax,%edx
801083f2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801083f5:	89 44 24 08          	mov    %eax,0x8(%esp)
801083f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083fc:	89 44 24 04          	mov    %eax,0x4(%esp)
80108400:	89 14 24             	mov    %edx,(%esp)
80108403:	e8 e6 ce ff ff       	call   801052ee <memmove>
    len -= n;
80108408:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010840b:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
8010840e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108411:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108414:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108417:	05 00 10 00 00       	add    $0x1000,%eax
8010841c:	89 45 0c             	mov    %eax,0xc(%ebp)
  while(len > 0){
8010841f:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108423:	0f 85 6f ff ff ff    	jne    80108398 <copyout+0x11>
  }
  return 0;
