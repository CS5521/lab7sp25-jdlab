...
ps(void)
{
  ...
  printf(1, "PID\tTKTS\tTCKS\tSTAT\tNAME\n");
    3fee:	c7 44 24 04 86 5e 00 	movl   $0x5e86,0x4(%esp)
    3ff5:	00 
    3ff6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3ffd:	e8 8d 02 00 00       	call   428f <printf>
  getpinfo(&pinfo);
    4002:	8d 85 e4 f6 ff ff    	lea    -0x91c(%ebp),%eax
    4008:	89 04 24             	mov    %eax,(%esp)
    400b:	e8 97 01 00 00       	call   41a7 <getpinfo>
  int i;
  for (i = 0; i < NPROC; i++) {
