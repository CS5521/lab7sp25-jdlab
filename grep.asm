...
ps(void)
{
 ...
 5cc:	c7 44 24 04 72 0c 00 	movl   $0xc72,0x4(%esp)
 5d3:	00 
 5d4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 5db:	e8 8d 02 00 00       	call   86d <printf>
  getpinfo(&pinfo);
 5e0:	8d 85 e4 f6 ff ff    	lea    -0x91c(%ebp),%eax
 5e6:	89 04 24             	mov    %eax,(%esp)
 5e9:	e8 97 01 00 00       	call   785 <getpinfo>
  int i;
  for (i = 0; i < NPROC; i++) {
