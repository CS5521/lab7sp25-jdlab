...
ps(void)
{
 ...
 381:	c7 44 24 04 a4 05 00 	movl   $0x5a4,0x4(%esp)
 388:	00 
 389:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 390:	e8 6b fc ff ff       	call   0 <printf>
  getpinfo(&pinfo);
 395:	8d 85 e4 f6 ff ff    	lea    -0x91c(%ebp),%eax
 39b:	89 04 24             	mov    %eax,(%esp)
 39e:	e8 97 01 00 00       	call   53a <getpinfo>
  int i;
  for (i = 0; i < NPROC; i++) {
