...
ps(void)
{
 ...
 41f:	c7 44 24 04 af 0a 00 	movl   $0xaaf,0x4(%esp)
 426:	00 
 427:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 42e:	e8 8d 02 00 00       	call   6c0 <printf>
  getpinfo(&pinfo);
 433:	8d 85 e4 f6 ff ff    	lea    -0x91c(%ebp),%eax
 439:	89 04 24             	mov    %eax,(%esp)
 43c:	e8 97 01 00 00       	call   5d8 <getpinfo>
  int i;
  for (i = 0; i < NPROC; i++) {
